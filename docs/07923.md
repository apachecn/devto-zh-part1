...
> 原文:[https://dev . to/the code boy/getting-started-with-Linux kit-and-Moby-project](https://dev.to/thecodeboy/getting-started-with-linuxkit-and-moby-project)

[![alt text](../Images/1b26a0a8817b23bf75bcc59db758a93e.png "Branding")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cM_1owfU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/x1de1f01ohxtejhx88ge.png)
...
### [](#1-install-the-moby-build-tool)1。安装莫比构建工具。

`$ go get -u github.com/moby/tool/cmd/moby`

### [](#2-install-the-linuxkit-tool)2。安装 LinuxKit 工具。

`$ go get -u github.com/linuxkit/linuxkit/src/cmd/linuxkit`

### [](#3-change-directory-to-the-linuxkit-repository-this-will-be-inside-your-golang-installation-directory)3。将目录切换到 LinuxKit 存储库。这将在您的 Golang 安装目录中。
...
### [](#4-build-the-example-configuration-file-linuxkityml-)4。构建示例配置文件“linuxkit.yml”。
...
### [](#5-run-the-linux-image-created-in-the-previous-step)5。运行在上一步中创建的 Linux 映像。

`$ linuxkit run linuxkit`

这个命令引导到莫比创建的 Linux 映像。这是输出。这是一个最小的 Linux 发行版。您可以键入命令并进行尝试。使用`halt`命令终止控制台。

[![alt text](../Images/17e55dfb89783321595699d62e17c82f.png "Docker Whale")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j6pxnUYY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jn3wof6mplm07nwvq2f4.png)
