...
### [](#breaking-down-the-problem)分解问题
...
### [](#1-getting-the-date-ranges)1)获取日期范围
...
### [](#2-make-a-twitter-api-request)2)发出 Twitter API 请求
...
[![An example of getting a wallpaper sent to my email through Node.](../Images/ef8b30cdcc619feb8d2d5e80d00ab197.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i2a8JI7q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5tztd3i6or0x9p0ofmym.png)
...
### [](#send-the-email-each-morning)每天早上发送邮件
