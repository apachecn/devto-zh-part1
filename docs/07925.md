...
> 原文:[https://dev . to/gaijinity/a-b-split-testing-with-nginx-craft-CMS-429 o](https://dev.to/gaijinity/a-b-split-testing-with-nginx-craft-cms-429o)

# [](#ab-split-testing-with-nginx-amp-craft-cms)使用 Nginx & Craft CMS 进行 A/B 分割测试

### 做 A/B 分割测试对衡量你的网页的有效性非常有用；以下是如何用 Nginx & Craft CMS 实现的

安德鲁·韦尔奇

[![Ab Split Testing First Image](../Images/312732c758624e026767ee0225439874.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--El8xlJEz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x675_crop_center-center_82_line/ab-split-testing-first-image.jpg)
...
[![Ab Split Testing Second Image Deux](../Images/c07ea71d56f8081f2dcd54fec6c7642a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---PXRe1u8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_992x558_crop_center-center_82_line/ab-split-testing-second-image-deux.jpg)
...
[![Ab Split Test Cookie](../Images/77b80e2cd7ea7b156fbdee165a959d32.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Nck5fepE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_576x313_crop_center-center_100_line/ab-split-test-cookie.png)

你可以删除这个 cook ie，并重新加载页面，你会得到一个不同的图像(可能需要尝试几次，因为无论哪种方式都有 50%的机会)。

[![Side By Side Split Test Deux](../Images/c23be8e28a982f94f793f4dc42e8d000.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wy0dP3Na--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x553_crop_center-center_100_line/side-by-side-split-test-deux.jpg)

浏览器缓存食物的方式有时很有趣，所以最简单的测试方法是通过一个新的私人/匿名浏览器窗口。

这太酷了。我们怎么做呢？

## [](#nginx-amp-craft-cms-to-the-rescue)Nginx &飞船 CMS 来救援了！
...
[![Ab Split Test Forge](../Images/090e525ce2068ce1f3afefe5cf7b55a3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4WtfVnxS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_576x347_crop_center-center_100_line/ab-split-test-forge.png)

这只是添加了一个名为`abtest`的 cook ie，其 comp`$abtest`的值是可变的，路径`/`持续 24 小时(即 86，400 秒)。

太好了。

## [](#cook%C2%ADies-amp-craft-cms)厨师 ies &工艺 CMS
...
[![Yummy Cookies](../Images/39e1931fd02c41216311338cad7f020a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RW0c2H3H--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x675_crop_center-center_82_line/yummy-cookies.jpg)
...
## [](#ab-split-test%C2%ADing-entries)A/B 拆分测试分录
...
[![A B Split Test Entry](../Images/a12f7ef876605d0e45346d692745dfe0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cpxin24u--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_546x346_crop_center-center_line/a-b-split-test-entry.png)
...
[![Google Custom Dimension](../Images/e5ec21443be9130ca4e2ccda854c080a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xo9kFPU5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_576x152_crop_center-center_100_line/google-custom-dimension.png)
...
[![Google Custom Dimension Secondary Dimension](../Images/eef61cfe362917d6be1f2cac9ae42bcf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cmAZxZe7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_394x338_crop_center-center_line/google-custom-dimension-secondary-dimension.png)
