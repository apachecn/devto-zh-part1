...
## [](#autoscaling-group-asg)自动缩放组(ASG)
...
[![Auto Scaling Groups](../Images/0ecc68d4f0e0039a8accdfe07797e1d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RzS5gl4v--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ABEjp9Pgf9SmaIGL_JjMDEg.png)

## [](#elastic-load-balancer)弹性负载平衡器

为了拥有一个公共端点，您可以在自动伸缩组之前放置一个弹性负载平衡器。它还会执行健康检查，以帮助您的 ASG 替换不健康的实例。完成:您拥有了一个公共端点！

[![ELB and ASG](../Images/10edef5085a9b28ee06c24e8b38adaa7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--012Fr_tl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://cdn.blog.celingest.com/wp-content/uploads/2013/12/AWS_Auto_Scaling_using_EC2_Management_Console.png)
