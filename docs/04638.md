...
[![The SQL Queries I Loved <3\. Chapter One](../Images/0514ce80f992c94dc97857d4f16fd04d.png "The SQL Queries I Loved <3\. Chapter One")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gYm9D7kT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9bxt8z38ti40ft78j0l5.jpg)
...
## [](#scanning-a-large-table)扫描一张大桌子
...
> #### [](#wow-it-is-significantly-faster-than-the-previous-approach-more-than-in-1000-times)Wow, it's obviously faster than before. More than 1000 times.

注意，`user_id`的值不是连续的，可以有间隙，比如 25 348 紧接在 25 345 之后。如果删除了未来页面中的任何记录，该解决方案也可以工作——即使在这种情况下，query 也不会跳过记录。很可爱，对吧？

## [](#explaining-performance)讲解表演
