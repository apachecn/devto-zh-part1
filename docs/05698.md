...
> 原文:[https://dev . to/Roger Jin 12/options-for-add-a-blog-to-a-PHP-app](https://dev.to/rogerjin12/options-for-adding-a-blog-to-a-php-app)
...
*   博客必须符合他们当前网站的外观和感觉
*   他们当前的网站是使用 PHP 构建的，他们也想使用相同的技术
...
### [](#use-an-open-source-project)使用开源项目
...
*此文原帖[此处](https://buttercms.com/blog/options-for-adding-a-blog-to-php-app)。*