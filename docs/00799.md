...
# [](#recipe%E2%80%8A%E2%80%8Abuilding-an-amber-authentication-system)配方——构建琥珀认证系统

[https://amberframework.org](https://amberframework.org)

[![amber framework example](../Images/f80f0eb833c4c3a07447dc934587dc27.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tB4bd7Dm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AiCbPqtqO3aW7vpobL9pMog.png)
...
## [](#using-amber-authentication-generator)使用琥珀色认证生成器

开始之前，请确保您具备所有先决条件。让我们首先生成一个应用程序，对于我们的例子，我们将调用我们的应用程序 Blogsy。

#### [](#1-generate-the-blogsy%C2%A0app)1。生成 Blogsy 应用程序
...
#### [](#2-go-to-your-project-directory)2。转到您的项目目录

琥珀色命令在我们项目的根目录下执行。

`cd blogsy`

#### [](#3-scaffold-the-user-authentication)3。脚手架用户认证
...
#### [](#4-sign-up-and-sign-in%C2%A0pages)4。注册并登录页面
