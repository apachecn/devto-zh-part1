...
> 原文:[https://dev . to/moreonfew/how-to-disable-selection-of-text-in-html-using-CSS-1l6l](https://dev.to/moreonfew/how-to-disable-selection-of-text-in-html-using-css--1l6l)
...
## [](#disable-selection-is-css-using-userselect-property)禁用选择是 CSS 使用用户选择属性
