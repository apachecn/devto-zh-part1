...
### [](#rebase-featuremybranch-onto-master)**将“特征/我的分支”重置到主**

#### [](#if-you-work-solo-on-the-branch)*如果你在分公司单干...*
...
#### [](#if-you-work-with-someone-else-on-a-branch)*如果你和别人一起在一个分公司工作...*
...
### [](#rebase-featuremybranch-onto-master-squashing-all-commits)**将“特征/我的分支”重置到主文件上，取消所有提交**
