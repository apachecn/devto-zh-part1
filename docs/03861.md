...
> 原文:[https://dev . to/faradayg/understanding-JavaScript-callbacks-58i](https://dev.to/faradayyg/understanding-javascript-callbacks-58i)
...
## [](#introducing-javascript-callbacks)介绍 JavaScript 回调。
...
## [](#enter-callback-chaining)回车:回调链接。
