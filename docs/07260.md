...
> 原文:[https://dev . to/charlyn/the-easy-way-connect-a-neo pixel-ring-to-the-particle-electron](https://dev.to/charlyn/the-easiest-way-to-connect-a-neopixel-ring-to-the-particle-electron)
...
[![Pretty Lights](../Images/629e3482d135ca1d51b69148e4ae677c.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--OAfrijMT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://chardane.github.io/codelove/images/posts/neopixel-electron/pretty-lights.gif) *好漂亮。*
...
## [](#step-1-go-to-particleiostart)第一步:去 particle.io/start

选择大的电子图像。你会看到这一页，但你实际上想去的是“简介”页，而不是这本“入门”指南。

[![Don't Get Started here.](../Images/7566f4f6e60905986f2ba66dc6ce3428.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1SeSVgr9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/getting-started-nah.png) 
...
[![Pull out the Electron](../Images/45b2637c8b3e6ef5a4c4fb9d38d0d9b2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--XfDagzQu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/electron-sim.png) 
*假装你是亚瑟，这是插在岩石上的剑。*

你还需要连接天线。

[![Antenna](../Images/197a75d2395ee9615d23819c42097b0a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KsW6xjAq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/its-gonna-be-ok-antenna.png)

我有点害怕强行推进这块看起来很精致的金属，但没关系。我希望有人告诉我这些事情。

您可以继续阅读他们的其他指南，这对您更好地了解事物非常有帮助(例如引脚的功能以及如何闪烁 LED)。当你准备好连接你的 Neopixel 到电子的时候回来。

## [](#step-2-install-particle-cli)第二步:安装粒子 CLI
...
## [](#step-3-connect-your-neopixel)第三步:连接你的 Neopixel！
...
[![Neopixels on Breadboard](../Images/034cc16713e62fe0d3397aa2ab9902f6.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--vtYqffpA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/breadboard-yay.JPG) 
*耶！我最终会焊接这些，但多么伟大的想法。*
...
[![Wire Diagram](../Images/02a07c8bb5cb10c61261bd26f34c1bd3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--SrNSRM-d--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/neopixel-and-electron.jpg) 
*我一直在找这张藏宝图*
...
[![Finally Connected](../Images/b1914429a77968348fd6a065b450645c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--m16SYh-g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/setup.JPG) 
*我花了很多时间搜索和询问。希望你能快点明白。*

## [](#step-4-the-code)第四步:代码！
...
*保存前* | *保存后*|
|[![Step 1](../Images/fd9cd56612c1182d99b486af0f8e35ab.png)|](https://res.cloudinary.com/practicaldev/image/fetch/s--MXr7bel3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/neopixel-electron/step1.png)|[|![Step 1](../Images/83c1aa2f631f28c74bf8fbeea4ecf1f0.png)|](https://res.cloudinary.com/practicaldev/image/fetch/s--RCUJeUwM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/neopixel-electron/step1half.png)|
|*保存前* | *保存后* | |
...
## [](#step-5-lets-get-some-lights-moving)第五步:让一些灯光动起来！
...
[![too much fun](../Images/5feaae3efcb7013b3ca098ffaebbd913.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--KuWeRUhE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://chardane.github.io/codelove/images/posts/too-much-fun.jpg) 
*太好玩了。*
...
*最初发布在我的博客中， [Codelove](http://chardane.github.io/codelove/images/) 。分享给一个可能困在软件人身体里的硬件人。你可以在推特上找到我。*
