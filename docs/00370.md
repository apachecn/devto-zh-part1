...
> 原文:[https://dev . to/lobo _ tuerto/how-to-setup-full-disk-encryption-on-a-secondary-HDD-in-Linux-4047](https://dev.to/lobo_tuerto/how-to-setup-full-disk-encryption-on-a-secondary-hdd-in-linux-4047)
...
# [](#correctly-identify-the-drive-name)正确识别驱动器名称
...
# [](#write-zeros-to-the-drive)向驱动器写入零
...
# [](#create-the-partition-table)创建分区表
...
## [](#create-a-new-ext4-filesystem)创建一个新的 ext4 文件系统
...
## [](#unmount-and-secure-your-data)卸载并保护您的数据
...
## [](#remount-the-encrypted-partition)重新挂载加密分区
