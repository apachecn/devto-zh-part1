...
> 原文:[https://dev . to/mikkpr/workspace-grid-for-MAC OS-without-external-tools](https://dev.to/mikkpr/workspace-grid-for-macos-without-external-tools)
...
[![You can’t assign these unless you already have created the 9 desktops in Mission Control](../Images/e6039438252dd240a5f357fe3f9bcdb4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ueV9CZW7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3j26vj417kbhyjocss8q.png)

要绑定热键切换到特定的空间，进入“系统偏好设置>键盘”，选择左侧边栏上的“快捷键”标签和“任务控制”。只有在您实际创建了额外的空格后，这些组合键才可用。

## [](#every-app-has-a-home-now)现在每个 app 都有家了
...
[![This makes iTerm always open on the 2nd space, easily accessible via Cmd+Ctrl+W](../Images/2c83f4e62a160a3806bdc5d3279600d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m_X5G4a---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8sqjlqzait4ij7vsqeoe.png)

为了保持空间的首选顺序，在 Mission Control 偏好设置中还有一个选项可以取消选中:“根据最近的使用情况自动重新排列空间”。

[![You wouldn’t want your Spaces randomly rearranging themselves, so uncheck this](../Images/c76d2054d81bb76f8409834aa95ff569.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--hhU-dMMD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7udeboxbtglkje1mu5t2.png)
