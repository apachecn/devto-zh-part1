...
[![image](../Images/5f09c4312c72557b961f0006e71336ad.png)T2】](https://www.youtube.com/watch?v=Oh4WURZoR98)

## [](#how-do-i-protect-myself)我该如何保护自己？

更新您的系统、路由器、移动设备等。
大多数厂商已经发布了补丁更新，你可以在这里[查看更大的英特尔](https://www.krackattacks.com)

## [](#vendor-patch-matrix-noncomplete)厂商补丁矩阵(不完整)
...
## [](#vendor-response-complete)供应商响应(完成)
