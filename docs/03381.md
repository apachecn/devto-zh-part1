...
> 原文:[https://dev . to/PS nebc/sudo-add-apt-repository-ppapmjdebruijndarktable-release-3nm](https://dev.to/psnebc/sudo-add-apt-repository-ppapmjdebruijndarktable-release-3nm)
