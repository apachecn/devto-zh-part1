...
> 原文:[https://dev . to/goshacmd/where-does-authentic ation-fit-in-a-react-native-app](https://dev.to/goshacmd/where-does-authentication-fit-in-a-react-native-app)
...
### [](#a-way-to-let-the-server-know-who-the-user-is)一种让服务器知道用户是谁的方式
