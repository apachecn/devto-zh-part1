...
> 原文:[https://dev . to/adammckerlie/提速-postgres-恢复-部分-2-226a](https://dev.to/adammckerlie/speeding-up-postgres-restores-part-2-226a)

#### [](#because-cutting-the-time-to-restore-in-half-just-wasnt%C2%A0enough)因为把恢复的时间减少一半还不够

<figure>[![](../Images/a9f8740b851ac4ba883d537fb90d69eb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--IKvedkSR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ACf4I9LTIdGTtyFTlqCFZKw.jpeg) 
...
#### [](#investigation-into-size-of-backup)调查备份的大小
...
#### [](#minimizing-the%C2%A0backup)最小化备份
...
#### [](#final-tips-and%C2%A0thoughts)最后的提示和想法
