...
[![Google Cloud CPU](../Images/cea2ed0ee99cbd3c07228ae973e1dd8b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---r10x_6I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/m8fjiicc4btxbtqls31h.png)

现在，您有了一台需要部署代码的机器。嘘你的方式通过。

## [](#things-youll-have-to-do-on-your-vm-now)您现在必须在虚拟机上做的事情
...
## [](#opening-any-port-from-google-cloud-console)从谷歌云控制台打开任意端口

从左侧的导航中，转到网络→防火墙规则。创建一个新的防火墙规则，填写所需的详细信息，然后就可以了！

[![Google Cloud Firewall](../Images/dfecd5f143f458d15c7107f5e13aa2be.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nC5px5K6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/36wybuq4rwf51j1ygb25.png)
