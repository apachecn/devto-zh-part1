...
> 原文:[https://dev . to/_ shahroznawaz/consuming-restful-API-in-PHP-with-guzzle](https://dev.to/_shahroznawaz/consuming-restful-api-in-php-with-guzzle)
...
## [](#understand-the-guzzle-client)了解狂饮客户
...
## [](#install-guzzle-in-php)在 PHP 中安装 Guzzle
...
## [](#what-you-can-do-with-the-cloudways-api)你能用 Cloudways API 做什么
...
## [](#create-the-http-requests-in-guzzle)在 Guzzle 中创建 HTTP 请求
...
## [](#create-a-post-request-to-get-access-token)创建 Post 请求以获取访问令牌
...
## [](#create-a-get-request-to-fetch-all-servers)创建一个获取请求来获取所有服务器
...
[![1*67IO8OPa2CqVN_XOBdff8Q.png](../Images/339cf178d1e2544c91500597cb726e7e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BEj_XQFJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A67IO8OPa2CqVN_XOBdff8Q.png)
...
[![](../Images/134919730df538fff1115a016193bbad.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LEAZL6W8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A-lpI1dadZj_Q51Hs2Y2NrA.png)

## [](#create-a-put-request-to-change-server-label)创建一个 PUT 请求来改变服务器标签
...
[![](../Images/9cf99feb0870de55353885a4956714ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qTAsAIyE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A3ZDP0TnRK57UEb1SW2oETA.png)

## [](#create-a-delete-request-to-remove-a-server)创建删除请求以删除服务器
