...
> 原文:[https://dev . to/adamkdean/encapsulating-console-log-with-spread-operator-1nl 7](https://dev.to/adamkdean/encapsulating-console-log-with-spread-operator-1nl7)
