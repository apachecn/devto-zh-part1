...
> 原文:[https://dev . to/choo Yan/understand-the-basic-idea-of-http-based-on-TCP-3i5j](https://dev.to/chooyan/understand-the-basic-idea-of-http-based-on-tcp-3i5j)
...
# [](#tiny-tcp-socket-programs)微小的 TCP 套接字程序
...
# [](#communication-using-http)使用 HTTP 进行通信
...
## [](#receiving-http-response)接收 HTTP 响应
