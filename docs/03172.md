...
[![](../Images/1b13f36599e58db062128dc6a06029a3.png)T2】](/images/match_n.png)
...
[![](../Images/1e4f20e950c7499c0986247284f4cfbd.png)T2】](/images/eger-sub-graph.png)

#### [](#get-nodes-by-name)按名称获取节点
...
#### [](#get-nodes-by-label-and-name)按标签和名称获取节点
...
#### [](#relationships-with-undefined-directions)方向不明的关系
...
#### [](#relationships-with-defined-directions)与定义方向的关系
...
#### [](#getting-the-type-of-the-relationship)获取关系的类型
...
#### [](#get-nodes-or-relationships-by-id)按 id 获取节点或关系
