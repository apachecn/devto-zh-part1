...
> 原文:[https://dev . to/suhas _ chatekar/converting-a-JavaScript-project-to-typescript-a-time-one-file](https://dev.to/suhas_chatekar/converting-a-javascript-project-to-typescript-one-file-at-a-time)

# [](#convert-a-javascript-application-to-typescript)将 JavaScript 应用程序转换为 Typescript
...
# [](#1-adding-typescript-config-and-webpack)1。添加 typescript 配置和 webpack
...
# [](#2-add-type-declaration-files)2。添加类型声明文件
...
## [](#installing-type-declaration-files-for-external-modules)为外部模块安装类型声明文件
...
## [](#creating-type-declaration-files-for-external-modules)为外部模块创建类型声明文件
...
# [](#3-convert-the-entry-module-into-typescript)3。将入口模块转换为类型脚本
