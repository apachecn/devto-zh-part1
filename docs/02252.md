...
> 原文:[https://dev.to/__namc/applicative-functors-inhaskell-gm](https://dev.to/__namc/applicative-functors-inhaskell-gm)
...
### [](#list-an-an-applicative)列出一个适用项！
...
### [](#curious-case-of%C2%A0-raw-either-endraw-)好奇案例之`Either`
