...
# [](#lessons-learned-from-building-a-serverless-distributes-amp-batch-data-architecture)构建无服务器分布式&批处理数据架构的经验
...
# [](#move-fast-with-stable-build-infrastructure)快速移动，构建稳定的基础设施
