...
> 原文:[https://dev . to/stephencanvender/c-selenium-ms test-quick start-guide-31p 9](https://dev.to/stephencavender/c-selenium-mstest-quickstart-guide-31p9)
...
[![Create a new project](../Images/28401dfa90210bc0ec1e338fbcbd0226.png "Create a new project")](https://res.cloudinary.com/practicaldev/image/fetch/s--aGNmWmnM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.cavender.io/assets/images/dotnet-selenium-mstest/new-project.png) 选择单元测试项目模板(**Templates>Visual c#>Test**，给它命名并配置一些选项。按“确定”创建项目。Visual Studio 将创建项目并打开您的第一个 UnitTest 类。 [![New project's first view](../Images/96a3aec8286bc24d5e06c23332e081ac.png "New project's first view")](https://res.cloudinary.com/practicaldev/image/fetch/s--BMIBWHYq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.cavender.io/assets/images/dotnet-selenium-mstest/new-project-first-view.png)

### [](#importinstall-selenium)导入/安装硒

现在我们需要获取 Selenium DLLs 并让我们的项目访问它们。

**工具> NuGet 包管理器>管理解决方案的 NuGet 包**

[![Open NuGet](../Images/1bb104059b12e3d487b6551ca74cef1d.png "Open NuGet")](https://res.cloudinary.com/practicaldev/image/fetch/s--7yMrBO2s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.cavender.io/assets/images/dotnet-selenium-mstest/open-nuget.png) 选择浏览，搜索‘硒’，安装两个硒。WebDriver 和 Selenium。支持你的新项目。
