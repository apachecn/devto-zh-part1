...
> 原文:[https://dev . to/riccardo _ cardin/single-respons ibility-principle-done-right-15eo](https://dev.to/riccardo_cardin/single-responsibility-principle-done-right-15eo)
...
## [](#the-singleresponsibility-principle)单一责任原则
...
[![Violation of SRP](../Images/2bcba1a7fcc0e5140218e6f3d97b6ed7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BchUpsLU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://rcardin.github.io/assets/2017-12-26/srp_wrong_design.png)
...
[![Design SRP-proof](../Images/b1018e5105334f257a3c42587458d69b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yqWiWfDw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://rcardin.github.io/assets/2017-12-26/srp_design.png)

按照上面类图中的描述来安排类之间的依赖关系，几何应用程序不再依赖于用户界面。

## [](#the-dark-side-of-the-singleresponsibility-principle)单一责任原则的阴暗面
...
## [](#its-all-about-cohesion)这都是关于凝聚力的
...
### [](#pushing-to-the-limit-effects-on-the-degree-of-dependency)推至极限:对依赖程度的影响
