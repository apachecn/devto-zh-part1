...
> 原文:[https://dev.to/udzura/trying-seccomp-via-mruby-6af](https://dev.to/udzura/trying-seccomp-via-mruby-6af)
...
## [](#combination-with-raw-forkexec-endraw-)与`fork()/exec()`的组合
...
## [](#original-japanese-article)日本原文
