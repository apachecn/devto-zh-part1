...
> 原文:[https://dev . to/venkat 2811/http-load-balancer-on-top-of-wso2-gateway-part-1-project-repository-architecture-and-features-bm8](https://dev.to/venkat2811/http-load-balancer-on-top-of-wso2-gateway-part-1-project-repository-architecture-and-features-bm8)

[![banner-gsoc2016_2.png](../Images/68701f4470de0d41de7a4b22448944f5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--e3WkTe6Y--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1668356758609/EX8b6jpm0.png) 快四个月了，这是一段令人惊奇的旅程！在此，我要感谢我的导师 [** Isuru Ranawaka **](https://github.com/isururanawaka) 和 [** Kasun Indrasiri **](https://github.com/kasun04) 以及 WSO2 社区成员，特别是 [** Senduran **](https://github.com/bsenduran) 和 [** Isuru Udana **](https://github.com/isudana) 在整个项目中对我的持续指导、支持和指导。
...
[![](../Images/b207b0169476b92250ae29d1d8104abe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zXYY0vf4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1668355861612/wn6ShKcui.png)
...
[![](../Images/59c00016996b73a41f7ab6a23b85ef5c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--E9j-X_zg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1668355863156/YZVZ6qWQv.png)
...
### [](#request-flow-from-client-gt-lb-gt-backend)请求流:来自客户端- > LB - >后端
...
[![](../Images/04a24dd1a3d850eaa1db7a336c2541d4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Y84OMex2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1668355864408/2wymPWgw4.png)

**图 3:消息流**

### [](#response-flow-from-backend-gt-lb-gt-client)响应流程:从后端- > LB - >客户端
...
### [](#outbound-endpoints)出站端点

后端服务端点被映射为 Carbon Gateway 框架中的出站端点。LB 引擎需要很少的附加属性来对这些出站端点进行负载平衡。**图 4** 清楚地解释了出站端点、LB 出站端点、加权 LB 出站端点和 LB 出站端点对于最小响应时间算法的区别。

[![](../Images/f2c85d41cf71a01e26dd0a828a36daf7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xACjNcxb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1668355865588/WEMTZ-9zS.png)
...
### [](#nonweighted-simple-algorithms)非加权(简单)算法
...
#### [](#3-strict-client-ip-hashing)3)严格的客户端 IP 哈希
...
#### [](#4-least-response-time)4)最少响应时间
...
### [](#weighted-algorithms)加权算法

#### [](#1-weighted-roundrobin)1)加权循环法
...
### [](#easily-extensible-nature)易于扩展的性质
