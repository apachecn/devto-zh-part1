...
> 原文:[https://dev . to/Joe nas/SMS-gateway-and-push-notifications-48ni](https://dev.to/joenas/sms-gateway-and-push-notifications-48ni)
...
### [](#automatically-switch-mode-when-inserted-or-after-reboot)插入时或重启后自动切换模式
...
### [](#symlink-to-devsms-for-consistency)符号链接到/dev/sms 以确保一致性
...
## [](#forward-texts-with-webhook)用 WebHook 转发文本
...
### [](#modified-version-of-the-script)修改版本的脚本
