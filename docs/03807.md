...
> 原文:[https://dev . to/PS nebc/sudo-add-apt-repository-PP autoto-kesselgulaschgimp-edge-df2](https://dev.to/psnebc/sudo-add-apt-repository-ppaotto-kesselgulaschgimp-edge-df2)
