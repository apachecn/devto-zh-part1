...
## [](#step-2-postgresql-or-what-ever-database-you-use)第二步:PostgreSQL(或者你用过的任何数据库)
...
## [](#step-3-init-your-database-and-migration)步骤 3:初始化您的数据库并迁移
...
## [](#step-4-build-and-test)第四步:构建和测试
