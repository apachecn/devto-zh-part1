...
> 原文:[https://dev . to/Andrew Chou/a-初学者-尝试-在-mithriljs-6 公里](https://dev.to/andrewchou/a-beginners-attempt-at-mithriljs-6km)
...
### [](#step-1-create-some-components)第一步:创建一些组件
...
### [](#step-2-add-in-the-state-variable-and-necessary-functions)第二步:添加状态变量和必要的函数
...
### [](#step-3-put-it-all-together)第三步:把所有东西放在一起
...
### [](#step-4-final-thoughts)第四步:最终想法
