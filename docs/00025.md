...
> 原文:[https://dev . to/nimmo/state-driven-development-for-user-interfaces-part-2-finite-state-machines-3hgc](https://dev.to/nimmo/state-driven-development-for-user-interfaces-part-2-finite-state-machines-3hgc)
...
[![Diagram showing LOCKED -> Unlock -> CLOSED -> Open -> OPENED transitions](../Images/06bd135014291801262d5e782d148cec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i3WGWAEl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/msad1wt8juebhkb216ss.png)
...
[![Diagram showing LOCKED -> Unlock -> CLOSED -> Open -> OPENED transitions](../Images/a34af0cae8ecf42cbae1817abedd515b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tg7RQvF6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/avtto0irobpxjze3s6gs.png)

现在，我们并没有花太多的时间来构建虚拟门户，但是我们认为我们已经发现了市场的一个缺口，我们希望通过将门户构建成一个网络应用来填补这个缺口。

我们已经完成了第一步:找出我们的状态和转换。现在是时候写一点代码了。

## [](#enter-redux)输入 Redux
