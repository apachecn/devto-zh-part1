...
> 原文:[https://dev . to/ken taro/generating-currency-code-like-name-in-ruby-c6a](https://dev.to/kentaro/generating-currency-code-like-name-in-ruby-c6a)

各种货币。此外，加密货币的兴起增加了类似货币的价值储存手段的数量。我们才敢往里面加点。当时，给货币命名是个问题。

## [](#whats-the-currency-codes)货币代码是什么？
...
## [](#currency-codes-for-smart-tokens)智能令牌的货币代码
