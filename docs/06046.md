...
> 原文:[https://dev.to/quarterto/thinking-in-make-1826](https://dev.to/quarterto/thinking-in-make-1826)

好的，但是*是一个 makefile 文件。实际上是什么？*

## [](#make-is-for-running-tasks)Make 是为运行任务准备的
...
## [](#make-is-for-generating-files)Make 是用于生成文件的
...
## [](#make-is-for-generating-files-from-other-files)Make 用于从其他文件生成文件
...
## [](#make-can-work-out-filenames-from-patterns)Make 可以从模式中计算出文件名
...
## [](#dont-tell-make-what-to-do-let-it-find-its-own-way)不要告诉 Make 该做什么，让它自己找到路
...
## [](#the-part-where-i-actually-talk-about-the-title-of-the-post)我实际上谈论文章标题的部分
...
## [](#extra-credit-automatically-rebuilding-files)额外积分:自动重建文件
...
## [](#make-can-do-a-whole-lot-more)Make 可以做更多的事情
