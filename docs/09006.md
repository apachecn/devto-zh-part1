...
> 原文:[https://dev . to/goshacmd/should-a-react-form-for-editing-update-the-underlying-model](https://dev.to/goshacmd/should-a-react-form-for-editing-update-the-underlying-model)
