...
> 原文:[https://dev.to/psnebc/sudo-apt-get-install-krusader-44j](https://dev.to/psnebc/sudo-apt-get-install-krusader-44j)

### [](#sudo-aptget-install-krusader)须藤 apt-get 安装克鲁萨德
...
### [](#sudo-aptget-install-arj)sudo apt-get 安装 arj
...
### [](#sudo-aptget-install-unace)sudo apt-get install unace
...
### [](#sudo-aptget-install-kompare)sudo apt-get 安装 kompare
