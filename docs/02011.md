...
> 原文:[https://dev.to/aurelkurtula/introduction-to-react-532](https://dev.to/aurelkurtula/introduction-to-react-532)
...
## [](#creating-the-first-component)创建第一个组件
...
[![](../Images/6f19d0f1462edaea1b4429f6a59c9927.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lDeycPlH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hp3t0ot5o2mgxhbeu4e3.png)
...
## [](#modifying-the-state-through-user-actions)通过用户动作修改状态
...
### [](#lets-change-the-state-on-submit)让我们更改提交时的状态
...
### [](#lets-change-the-state-on-change)让我们在改变时改变状态
