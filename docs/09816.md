...
## [](#bringing-a-branch-up-to-date)更新分支
...
[![Visual of commit tree during git rebase](../Images/6f69ccb371d227a439de7b6663ab9083.png "Visual of commit tree during git rebase")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BTsRd9V4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jason.pureconcepts.net/images/tree-progressing-git-rebase.png)
...
## [](#changing-a-set-of-commits)更改一组提交
...
[![Commit message from git rebase -i](../Images/2479dd2d31669ac0a4113a0ae2d1ec5e.png "Commit message from git rebase -i")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L1ezt38j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://jason.pureconcepts.net/images/git-rebase-interactive-message.png)
