...
[![php oop tutorial](../Images/a791bef691c47d111059588388a5f08e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3GVo0YsF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.parthpatel.net/wp-content/uploads/2017/05/php-oop-tutorial-1024x576.jpg)
...
## [](#why-use-object-oriented-programming)为什么要使用面向对象编程？
...
## [](#understanding-classes-and-objects)理解类和对象:
...
[![class and objects php](../Images/2d46c7eba6ac16948205ee39afefea36.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wV14H4hY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.parthpatel.net/wp-content/uploads/2017/05/class-and-objects-php.jpg)
...
### [](#what-is-method-and-property)什么是方法和属性？

类中的属性是可以存储不同数据类型的数据的变量。方法是在类内部定义的函数。

从该类实例化的所有对象都获得了该属性变量的副本和所有成员函数(也称为方法)的副本。

### [](#how-to-create-class-and-object)如何创建类和对象？
...
### [](#how-to-define-properties-in-class)如何在类中定义属性？
...
### [](#how-to-define-methods-in-class)如何在类中定义方法？
...
## [](#assigning-visibility-in-php)在 PHP 中分配可见性
...
### [](#how-to-create-static-method-and-property)如何创建静态方法和属性
