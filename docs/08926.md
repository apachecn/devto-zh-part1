...
> 原文:[https://dev.to/designfrontier/monument-5h05](https://dev.to/designfrontier/monument-5h05)

在过去的几年里，我一直在为 nodejs 开发一个新的应用程序框架。Monument 目前正在发布它的第二个主要版本。

## [](#what-is-monument)什么是纪念碑
...
## [](#but-what-can-i-use-it-for)但是我能用它做什么呢？
