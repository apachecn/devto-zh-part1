...
> 原文:[https://dev . to/mortoray/should-function-arguments-be-assignable-or-mutable-4np 6](https://dev.to/mortoray/should-function-arguments-be-reassignable-or-mutable-4np6)
...
## [](#the-default-but-not-a-hard-requirement)默认，但不是硬性要求
