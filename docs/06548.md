...
> 原文:[https://dev.to/jonstodle/flatmap-explained-3oo](https://dev.to/jonstodle/flatmap-explained-3oo)
...
### [](#multiply-a-the-current-value)乘以一个当前值
...
### [](#convert-the-current-value)转换当前值
...
### [](#convert-to-a-constant-value)转换为常数值
