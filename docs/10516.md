...
# [](#basic-cryptography-concepts-for-developers)面向开发者的基本密码学概念
 ...
 *[![Categories of cryptographic and non-cryptographic concepts](../Images/f2de646fc4a7e5bbcb712630dde27c3b.png "Categories of cryptographic and non-cryptographic concepts")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K4LZBy3P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://paragonie.com/files/blog/crypto-categories.png)
...
## [](#the-first-rule-of-cryptography-dont-implement-it-yourself)密码学第一法则:不要自己实现
...
### 认证密钥加密[](#authenticated-encryption)
...
[![Secret Key Cryptography vs Public Key Cryptography](../Images/e2f22430c594ff68bcd73fca8c3ca1cb.png "Secret Key Cryptography vs Public Key Cryptography")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NmnQoyrF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://paragonie.com/files/blog/crypto_types.png)
...
# [](#common-misconceptions-and-pitfalls)常见的误解和陷阱
