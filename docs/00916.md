...
> 原文:[https://dev . to/mezie/how-to-build-a-laravel-chat-app-with-pusher-2e2o](https://dev.to/mezie/how-to-build-a-laravel-chat-app-with-pusher-2e2o)
...
[![](../Images/1eaa4787a2ea293b7aa9d7e0bb251542.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9ZKbb8jS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://blog.pusher.com/wp-content/uploads/2017/02/laravel-pusher-chat-demo.gif)
...
## [](#message-model-and-migration)消息模型和迁移
...
## [](#user-to-message-relationship)用户与消息的关系
...
## [](#broadcasting-message-sent-event)广播消息发送事件
...
## [](#listening-for-message-sent-event)监听消息发送事件
