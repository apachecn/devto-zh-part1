...
[![](../Images/cf750a51b99bd8678d2286fe9c5d11c7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LMyeBiKA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AtYTDNJnDLKxf4tbmAgJFPg.png)

我将向您展示如何使用模块模式(对象文字)用普通 JavaScript 创建私有函数和公共方法。

#### [](#javascript-module%C2%A0pattern)JavaScript 模块模式
...
#### [](#selfinvokingfunctionexpression)自调用-函数-表达式
...
#### [](#how-to-use-the-public-and-private-method-and-function)如何使用公有和私有的方法和函数？
...
#### [](#how-to-use-the-public-methods-inside-another-javascript-module)如何使用另一个 JavaScript 模块内部的公共方法？
...
#### [](#do-you-want-to-have-a-training-by%C2%A0me)**你想由我来训练吗？**
