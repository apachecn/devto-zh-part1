...
> 原文:[https://dev . to/mortoray/debugging-a-synchronous-callback-in-loop-defect](https://dev.to/mortoray/debugging-a-synchronous-callback-in-loop-defect)
...
## [](#the-danger-of-synchronous-callbacks)同步回调的危险
...
## [](#but-why-wasnt-it-noticed)但是为什么没人注意到呢？
