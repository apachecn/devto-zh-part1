...
[![Example code Object statement expression screentshot](../Images/beb0376d2bd8c89f45a0caf5fde085f8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GSp0f8jN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tkjfva9zp7kt9tajmxy8.PNG)
...
### [](#expressions-produce%C3%A2-value)**表达式产生一个值**
...
### [](#expressions-dont-necessarily-change%C3%A2-state)**表情不一定变化状态**
...
### [](#function-declarations-function-expressions-and-named-function-expressions)**函数声明、函数表达式和命名函数表达式**
...
### [](#converting-expressions-to-statements-expression-statements)**将表达式转换为语句:表达式语句**
...
### [](#semicolon-vs-comma-operator)**分号 vs 逗号运算符**
...
### [](#object-literals-vs-block-statements)**对象文字 vs 块语句**
