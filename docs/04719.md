...
> 原文:[https://dev . to/sparkpost/archiving-emails-a-how-to-guide-for-tracking-sent-mail](https://dev.to/sparkpost/archiving-emails-a-how-to-guide-for-tracking-sent-mail)
...
[![](../Images/60c427de6375d5f4ae292ccf1c099eef.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eB7oWLAq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://media.sparkpost.com/uploads/2017/09/Screen-Shot-2017-09-11-at-2.54.02-PM.png)
...
### [](#set-up-an-inbox-relay-webhook)设置收件箱中继 Webhook
...
### [](#create-a-collector-to-process-and-store-the-archive-email)创建一个收集器来处理和存储归档电子邮件
...
### [](#send-an-archived-copy-of-the-email)发送电子邮件的存档副本
...
### [](#voila-archiving-emails-is-simple)瞧！归档电子邮件很简单！
