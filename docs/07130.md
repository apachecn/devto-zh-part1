...
> 原文:[https://dev.to/andre2w/scaffolding-with-aspnet](https://dev.to/andre2w/scaffolding-with-aspnet)

# [](#scaffolding-with-aspnet-core)脚手架用 ASP.Net 芯
...
## [](#creating-a-aspnet-core-project)创建 ASP.Net 核心项目
...
### [](#generating-our-first-controller)生成我们的第一个控制器
...
### [](#controller-with-crud)带有 CRUD 的控制器
...
#### [](#generating-a-crud-for-post)为 Post 生成一个 CRUD
