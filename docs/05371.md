...
> 原文:[https://dev.to/dmerejkowsky/exceptional-python](https://dev.to/dmerejkowsky/exceptional-python)

*原载于[我的博客](https://dmerej.info/blog/post/exceptional-python/)*

# [](#introduction-error-management)简介:错误管理
...
# [](#part-two-a-concrete-example)第二部分:具体例子
...
## [](#using-tsrc-as-a-library)使用 tsrc 作为库
