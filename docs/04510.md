...
## [](#whats-a-supply-chain-attack)什么是供应链攻击？
...
## [](#a-recent-history-of-supply-chain-attacks)最近的供应链攻击史
...
## [](#the-fundamental-problem-with-software-update-security)软件更新安全的根本问题
...
## [](#does-this-really-matter)这真的重要吗？

自从我们公司成立以来，我们一直专注于确保软件更新足够安全以实现自动化的问题。

我们坚信，大规模解决这一问题将比所有信息安全和应用密码学中的其他问题对互联网安全产生更深远的影响。

### [](#wait-i-think-i-can-solve-this-using-buzzword)“等等，我想我可以用【流行语】解决这个问题。”
