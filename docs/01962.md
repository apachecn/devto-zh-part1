...
> 原文:[https://dev . to/vi3k6i 5/regex-was-taking-5-days-run-so-I-build-a-tool-that-did-it-c98](https://dev.to/vi3k6i5/regex-was-taking-5-days-to-run-so-i-built-a-tool-that-did-it-in-15-minutes-c98)
...
## [](#data-science-starts-with-data-cleaning)数据科学从数据清洗开始。
...
[![Oh the horror.](../Images/afb2379760d193031d70d1f2637a4b01.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZptWYzyy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AGpNMd7fBtrH4TvVZRglfNg.jpeg)
...
[![Time taken by FlashText to find terms in comparison to Regex.](../Images/40e79980cdec3077b7e3ce7d46e87d22.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--l7repANE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xruf50n6z1r37ti8rd89.png)

上面显示的图表是一个文档的编译正则表达式和 FlashText 的比较。随着关键字数量的增加，Regex 所用的时间几乎呈线性增长。然而，有了 FlashText，这并不重要。

## FlashText 将我们的运行时间从 5 天减少到 15 分钟！！

[![We are good now :)](../Images/3417f2502d1d3c4d8c3d22d109b634b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_hs8EAf0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AZfRhHGtxhbEB0dS-3BHOAw.png)

与 Regex 相比，FlashText 替换术语所用的时间。
[![Time taken by FlashText to replace terms in comparison to Regex.](../Images/dc9122e39630e7bc767328a680a6c139.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--duFLyJ1T--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k44ghwp8o712dm58debj.png)
...
## [](#so-what-is-flashtext)那么什么是 FlashText 呢？
...
> ![Radim Řehůřek profile image](../Images/32ededd9c6cb2f858fc17a27e5858762.png)拉迪姆·řehůřek@拉迪姆·雷雷克![twitter logo](../Images/4c8a2313941dda016bf4d78d103264aa.png)[@ arnicas](https://twitter.com/arnicas)对于每个文档 1k 个关键字& ~10k 个标记，比编译的 regexp 快 28 倍。好听 [@vi3k6i5](https://twitter.com/vi3k6i5) ！
> 纯 Python t…[twitter.com/i/web/status/9…](https://t.co/K8x84q5q2E)2017 年 9 月 05 日上午 08:48[![Twitter reply action](../Images/44d8b042100e231770330321e5b63d65.png)](https://twitter.com/intent/tweet?in_reply_to=904989624589803520)[![Twitter retweet action](../Images/93d9c70ccc54851d2e8e881b53c21dae.png)](https://twitter.com/intent/retweet?tweet_id=904989624589803520)[![Twitter like action](../Images/2e93f7775eadefab8bcd34a4542cc5a7.png)](https://twitter.com/intent/like?tweet_id=904989624589803520)

Radim Rehurek 是 Gensim 的创建者。

## [](#why-is-flashtext-so-fast-)为什么 FlashText 这么快？
...
[![Trie dictionary of the corpus.](../Images/f55db14e21f8bf2833cb66059237efc6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jw9yTF9L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AN09Y_XEQFhFMxVpgEeqExQ.png)
...
[![<Start> Python <EOT> is present in dictionary.](../Images/d97f1ded437f9ab9e1e0f8b628f418cd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2nwZQ3se--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AnoWWci3fCrbcbrj40B4UaA.png)
...
## [](#so-when-should-you-use-flashtext)那么什么时候应该使用 FlashText 呢？

简单回答:当关键词数量> 500 时

[![FlashText outperforms Regex for Find when Number of keywords > 500](../Images/844465f2a9e5d31d73177691ecc74f2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jPcqd4XN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kzg3ol40sfuzpodazspp.png)
...
## [](#how-to-use-flashtext)如何使用 FlashText
