...
> 原文:[https://dev.to/ladvien/working-with-r-excel-libraries-110k](https://dev.to/ladvien/working-with-r-excel-libraries-110k)
...
## [](#installing-r-libraries-for-excel)为 Excel 安装 R 库
...
## [](#working-with-xlconnect)使用 XLConnect
...
### [](#loading-data-from-xlsx-documents)从 Xlsx 文档中加载数据
...
[![](../Images/fcad5b9dcb0c5b54fa086dd7b3972dd3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vJEplXoB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/excel_sheets.png)
...
[![](../Images/e462970dd27ae1702470fe93e4aebaed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L37xcRfj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/excel_robot_budget.png)

我们可以通过告诉 XLConnect `startRow = 3`跳到列标题所在的第三行。

### [](#writing-a-dataframe-to-excel-document)将数据帧写入 Excel 文档
...
[![](../Images/e75a405610b32039483df8d37794399b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EcW5QVse--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/xlconnect_written_workbook.png)
...
## [](#why-use-excel-documents)为什么要使用 Excel 文档
