...
> 原文:[https://dev . to/schwamster/deploying-a-aspnet-core-container-with-zeit-now](https://dev.to/schwamster/deploying-a-aspnet-core-container-with-zeit-now)
...
## [](#add-a-dockerfile)添加一个 Dockerfile
...
[![](../Images/2d1c4e265c5bb5728b3e4df9e49c7988.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JB5HYVE3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ln0uxvo4u6ei4dj83d51.png)

有 3 种方法可以解决这个问题(可能更多):

### [](#use-the-build-image)使用构建图像
...
### [](#remove-the-large-files)删除大文件

违规文件(refs/Microsoft。CodeAnalysis*)在这个项目的运行时实际上是不需要的

[![](../Images/8981ffd5b71c59c9dbc9fe7a91c570e8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dKxwn9Lk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/slefly8fj56xpl54r4yy.png)

### [](#use-a-registry)使用注册表
...
[![](../Images/1d1991a9b4b4f52166bcd98ebef45bf9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XffWQXuX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/41hpuiydiiifwmopy393.png)

在输出的开头，您会发现现在为您创建了一个 url。在浏览器中打开该地址并添加/api/values。结果应该和在本地运行它一样。

[![](../Images/d556c5abeb7e93358fa0598b009c6384.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--saKLQfVQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/2qe9gozyapw0xad8cqqh.png)

## [](#creating-aliases)创建别名
