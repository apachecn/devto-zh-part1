...
> 原文:[https://dev . to/samueleresca/solid-principles-using-typescript](https://dev.to/samueleresca/solid-principles-using-typescript)
...
## [](#the-openclosed-princple%C3%A2-ocp)开闭原则(OCP)
...
[![SOLID principles using Typescript - OCP Right](../Images/9bb3ff9ec6b1e248b7b268fb4bf3d2b3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--o02ZwuKv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://samueleresca.net/wp-content/uploads/2016/08/OCP_right.png)T3】
...
## [](#the-liskov-substitution-principle-lsp)利斯科夫替代原理(LSP)
...
[![SOLID principles using Typescript - LSP Right](../Images/c9d07b10ed0f4d8f6d34d0e592b3675b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--1LYSVMc_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://samueleresca.net/wp-content/uploads/2016/08/lisp_right.png)T3】
...
## [](#the-interface-segregation-principle-isp)接口隔离原理(ISP)
...
## [](#the-dependency-inversion-principle-dip)依存倒置原则(DIP)
...
[![SOLID principles using Typescript - DIP wrong way](../Images/372fcc8496e85349d302ffcd1f979168.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--G03UDUnw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://samueleresca.net/wp-content/uploads/2016/08/dip_wrong.png)T3】
...
#### [](#uml)UML ![SOLID principles using Typescript - DIP right way](../Images/05e13dc631e49b2bb315331b969fa115.png)
