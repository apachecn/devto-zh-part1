...
> 原文:[https://dev . to/borisschapira/assure-secured-connections-with-hsts-http-strict-transport-security](https://dev.to/borisschapira/ensure-secured-connections-with-hsts-http-strict-transport-security)
...
## [](#hsts-to-force-https)HSTS 逼 HTTPS
...
## [](#hsts-preloading-to-reliably-secure-the-exchanges)HSTS 预压可靠地保障了往来
...
[![Capture of Chrome Dev Tools](../Images/9afa4f25a45e27d63e0b479d1b0cad5f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--u24jWCsp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/64mia5hnuoxuwfju2teg.png) 
...
## [](#protect-your-users-with-hsts)用 HSTS 保护你的用户
...
## [](#bonus-with-hsts-preload-protect-your-domain-from-ssl-strip-attacks)奖励:与 HSTS 预载，保护您的域名免受 SSL 带攻击
...
## [](#further-information-about-hsts)关于 HSTS 的进一步信息
