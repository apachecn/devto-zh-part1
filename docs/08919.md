...
> 原文:[https://dev . to/stephena famo/moving-a-WordPress-site-into-a-docker-container-di2](https://dev.to/stephenafamo/moving-a-wordpress-site-into-a-docker-container-di2)

[![docker-wordpress](../Images/3dc903206df845e0dfdbd2532b733b4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bV60rERo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i1.wp.com/stephenafamo.com/blog/wp-content/uploads/2017/03/docker-wordpress.png%3Ffit%3D944%252C496%26ssl%3D1)
...
## [](#step-1-understanding-docker-compose)第一步:了解 Docker 撰写
...
## [](#step-2-export-the-wordpress-site)第二步:导出 WordPress 站点
 ...
 *## [](#step-3-set-up-the-site-source-code)第三步:设置站点源代码
...
## [](#step-4-set-up-the-site-database)第四步:建立站点数据库
...
## [](#step-5-start-docker-containers-using-dockercompose)步骤 5:使用 docker-compose 启动 Docker 容器
...
## [](#step-7-fix-wpconfigphp)步骤七:搞定 wp-config.php
...
## [](#step-8-install-a-free-ssl-certificate-and-use-https-optional)步骤 8:安装免费的 SSL 证书并使用 HTTPS(可选)
