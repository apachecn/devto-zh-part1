...
> 原文:[https://dev . to/kbariotis/environment-based-application-configuration-using-web pack-4fb](https://dev.to/kbariotis/environment-based-application-configuration-using-webpack-4fb)
...
## [](#searching-for-a-solution)寻找解决办法
