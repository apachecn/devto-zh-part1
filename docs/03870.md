...
> 原文:[https://dev . to/star BIST/a-guide-to-static-site-generators-using-hexo-and-WordPress-400](https://dev.to/starbist/a-guide-to-static-site-generators-using-hexo-and-wordpress-400)
...
## [](#from-optimizing-wordpress-to-going-static)从优化 WordPress 到走向静态
...
## [](#enter-static-page-generators-and-hexo)输入静态页面生成器和 Hexo
...
[![Fixing Google Analytics caching issue](../Images/ed023e2959a05620ffb901c7a038cff5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZPhoAG5K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://uploads.toptal.io/blog/image/124397/toptal-blog-image-1507862928251-9e43ac2926f950710ba0f0450dd7e5cd.png)

## [](#migrating-wordpress-to-hexo)将 WordPress 迁移到 Hexo
...
## [](#markdown-and-its-limitations)降价及其局限性
...
## [](#redesign-and-optimization)重新设计和优化
...
## [](#the-case-for-static-site-generators)静止现场发电机的情况
