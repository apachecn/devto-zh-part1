...
> 原文:[https://dev . to/Paul _ kin LAN/a-simple-client side-templating-langauge-3l3f](https://dev.to/paul_kinlan/a-simple-clientside-templating-langauge-3l3f)
...
<template id="itemTemplate">
  <div class="item new" data-bind_id="guid" id="">
    ...
    <div>
      ...
      <svg class="share" url="" title="" viewBox="0 0 24 24"  width="24" height="24">
