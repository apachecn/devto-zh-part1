...
> 原文:[https://dev.to/roperzh/overview-of-elixir-executables-4bk](https://dev.to/roperzh/overview-of-elixir-executables-4bk)
...
### [](#a-few-words-on-archives)档案上的几个字
...
## [](#managing-escripts-using-mix)使用 Mix 管理脚本
