...
> 原文:[https://dev.to/jeffreymfarley/deploy-atomically-with-travis-NPM-68b](https://dev.to/jeffreymfarley/deploy-atomically-with-travis--npm-68b)

# [](#deploy-atomically-with-travis-amp-npm)使用特拉维斯& npm 自动部署
...
## [](#github-and%C3%A2-releases)GitHub 和β版本
...
### [](#does-this-fit-our-use%C3%A2-case)这符合我们的用例吗？
...
## [](#npm-version-to-the%C3%A2-rescue)npm 版来了——救援
...
### [](#the-default-use-case-is-for%C3%A2-releases)默认用例是发布

如果您开始阅读 Travis 文档，很明显他们的主要用例是构建资产并将其推送到 GitHub 版本。既然我们已经确定那不适合我们，是时候开始试验和谷歌搜索了。

### [](#na%C3%A3%C2%AFve-first%C3%A2-steps)天真的第一步
...
### [](#detached-head%C3%A2-mode)分离头模式
...
## [](#writing-a-travis%C3%A2-script)编写 Travis 脚本
