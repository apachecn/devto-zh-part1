...
> 原文:[https://dev.to/jrop/pratt-parsing](https://dev.to/jrop/pratt-parsing)
...
## [](#not-to-be-pedantic-but-how-do-you-handle-right-associativity)不是迂腐，而是如何处理右结合性？
