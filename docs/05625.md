...
> 原文:[https://dev.to/onmyway133/pixel-and-point](https://dev.to/onmyway133/pixel-and-point)

TL；DR:不要用`nativeScale`和`nativeBounds`，除非你在做一些非常低级的事情

### [](#what-is-point-and-pixel)什么是点和像素
...
### [](#the-scale-factor-and-display-mode)比例因子和显示方式
