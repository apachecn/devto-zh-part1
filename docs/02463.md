...
> 原文:[https://dev . to/mttaggart/things-I-learned-writing-my-first-elm-app-27b](https://dev.to/mttaggart/things-i-learned-writing-my-first-elm-app-27b)
...
## [](#elm-makes-some-clean-code)Elm 制作了一些干净的代码
