...
> 原文:[https://dev . to/kwabenberko/sugar-ORM-an-a-ease-way-to-work-with-SQLite-databases-in-Android-CpG](https://dev.to/kwabenberko/sugar-orm-an-easier-way-to-work-with-sqlite-databases-in-android-cpg)
...
#### [](#selecting-an-existing-record-by-its-id)通过 id 选择现有记录
...
#### [](#updating-an-existing-record)更新现有记录
...
#### [](#deleting-an-existing-record)删除现有记录
