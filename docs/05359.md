...
> 原文:[https://dev . to/alexjoverm/write-the-first-vuejs-component-unit-test-in-jest-35f](https://dev.to/alexjoverm/write-the-first-vuejs-component-unit-test-in-jest-35f)
...
## [](#set-up-a-vuetest-sample-project)建立一个 vue-测试样本项目
...
### [](#the-problem-with-nested-components)嵌套组件的问题
...
### [](#what-is-shallow-rendering)什么是浅层渲染？
...
## [](#testing-a-component-with-vuetestutils)用 vue-test-utils 测试一个组件
