...
## [](#factors-to-consider)要考虑的因素

### [](#browser-amp-device-compatibility)浏览器&设备兼容性
...
### [](#wide-range-of-chart-types)多种图表类型
...
### [](#price-license-and-support)价格、许可和支持
...
## [](#popular-free-libraries)热门免费图书馆

Wikipedia 提供了一个非常好的所有 Javascript 图表库的特性对照表。在这里，我将只进入一些最受欢迎的。

### [](#chartjs)

[![screenshot of chartjs](../Images/679412069ba011080f51f9b15c3c888b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Et2oNeBL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.moesif.com/blog/images/posts/technical/chartjs.png)
...
[![screenshot of google charts](../Images/5377eae7bc570535fcc7b18e270cf00c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qVOeKG-F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.moesif.com/blog/images/posts/technical/googlecharts.png)
...
[![screenshot of d3js](../Images/a1f146a54635edc3fb777a6a06e9ec67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RaCd52mN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.moesif.com/blog/images/posts/technical/d3js.png)
...
## [](#paid-commercial-libraries)付费商业图书馆
...
## [](#visualization-libraries-for-specific-frameworks)针对特定框架的可视化库
...
## [](#specific-one-chart-type-focused-libraries)特定的一个图表类型的聚焦库。
