...
> 原文:[https://dev.to/riccardo_cardin/resolve-me-implicitly-ee8](https://dev.to/riccardo_cardin/resolve-me-implicitly-ee8)
...
## [](#the-problem-dependency-injection)问题:依赖注入
...
[![Resolve your declared dependencies](../Images/2698c590658cdb607c0e1fba6430c1fd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4XnZM9O8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1xlkmb.jpg)
...
## [](#resolving-dependencies-in-scala)在 Scala 中解析依赖关系
...
[![Function currying be like](../Images/1a83536d7c0b958218522bc6143be6d2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J5AMkvS---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1xlkul.jpg)
...
[![Implicits, implicits everywhere](../Images/af997da82c03065e406f1e678f9cad20.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ocPsCJHR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1xll84.jpg)

到目前为止，一切顺利。我们刚刚为依赖注入难题添加了另一块拼图。现在是时候把所有的材料放在一起，烤一个美味的依赖注射蛋糕。

### [](#dependency-injection-using-implicits)依赖注入使用隐含
...
[![Y U not explicit the implicits!](../Images/3396220d6f406ac18a0a6a5b0f379aa1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Bbwdh132--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1xn1z9.jpg)
