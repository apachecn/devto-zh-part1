...
> 原文:[https://dev . to/stefanjudis/til-promise-resolution-with-objects-including-a then-property-2nhj](https://dev.to/stefanjudis/til-promise-resolution-with-objects-including-a-then-property-2nhj)
