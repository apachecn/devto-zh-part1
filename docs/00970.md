...
> 原文:[https://dev.to/mizutani/design-面向家庭和小型办公室的现代路由器 linux 实施-4301](https://dev.to/mizutani/design--implementation-of-modern-router-with-docker--linux-for-home-and-small-office-4301)

[![photo](../Images/2c855220c177fdf0dc9fff9e92205120.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vZSxfieT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pt6hc4n6nzh49hi1utvx.jpg)
...
[![architecture](../Images/cf994aa17ff6ecb7ed44c14fa46435c2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b4u5N4AR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yqi5p06l5rq22qv1chh5.png)
...
## [](#preparing-the-machine)准备机器

这次准备的机器会在下面。

> XCY 英特尔赛扬 J1900 准系统(2 Ghz 四核 4 线程)千兆局域网* 4 无风扇小型节省空间(4g RAM 32g SSD)
> 
> [![photo](../Images/d85c46f8e0fd08a7701b47c6354cebcb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--LKvoeXQF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/371jkmoztmbsn38gg8qc.jpg)
...
## [](#installing-linux-as-a-host)安装 Linux 作为主机

[![IMG_0024 2.jpg](../Images/4899097d056e52ba2066b11a576b836c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9NK0Vwpp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/04mmer8vs3es7ckcrcm5.jpg)

### [](#os-installation)OS 安装
...
### [](#nat-amp-fw-configuration)NAT & F/W 配置
...
### [](#rsyslog-configuation)rsyslog 配置
...
### [](#monitoring-service-installation)监控服务安装
...
[![Screen Shot 2018-01-07 at 22.01.41.png](../Images/1c47d771f81fc610cc6beb54dcbb1d97.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--c3M09NaE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/f1i42a1zlrqn7iakpucs.png)

## [](#service-configuration)服务配置

### [](#services)服务

#### [](#fluentd-log-collection)fluentd(日志收集)
...
#### [](#unbound-dns-cache-server)未绑定(DNS 缓存服务器)
...
#### [](#softflowd-flow-monitoring)softflowd(流量监控)
...
#### [](#dnsgazer-dns-monitoring)dns-gazer (DNS 监控)
...
### [](#preparation-of-external-service)准备对外服务
...
### [](#make-dockercompose-to-start-up-at-machine-startup)使 docker-compose 在机器启动时启动
...
[![dashboard](../Images/da78521e8ea4f02e73ea8b2a4dc3b9fa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gisKfDe1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1gkay5a9qr09o3k796lw.png)
