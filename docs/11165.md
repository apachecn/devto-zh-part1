...
# [](#apple-doesnt-like-robots)苹果不喜欢机器人。
...
# [](#this-is-a-workinprogress%C2%A0)**这是一项正在进行中的工作！**

### [](#initialize-an-instance-of-the-bleserialmanager-class)**初始化 bleSerialManager 类的一个实例**
...
## [](#set-your-bleserialdelegate)**设置你的祝福者**
...
### [](#optional-call-back-method-1)**可选回调方法#1**
...
## [](#get-discovered-devices-information)**获取被发现设备的信息**
...
[![](../Images/6fc5eed722041b4c20bc9d84de7b8235.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pqi0SLZm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/RSSI_Mapping_Table.png)
...
## [](#discovered-peripheral-advertisement-data)发现周边广告数据
