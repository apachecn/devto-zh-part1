...
> 原文:[https://dev.to/philnash/the-web-share-api](https://dev.to/philnash/the-web-share-api)
...
[![A tray slides up from the bottom of the screen with sharing options from your installed applications.](../Images/06495e6442668b84a8524a9d620da0b4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IcGZuPCp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://philna.sh/images/webshare.png)
...
## [](#implementing-the-web-share-api)实现 web 共享 API
...
## [](#thoughts-on-the-api)关于 API 的思考
...
### [](#minimising-javascript)最小化 JavaScript
