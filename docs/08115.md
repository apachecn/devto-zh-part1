...
### [](#message-passing-between-the-web-page-context-and-content-script)消息在网页上下文和内容脚本之间传递。

这涉及到使用`window.postMessage()`

#### [](#1-sending-the-message)1。发送消息
...
#### [](#2-receiving-message-and-make-the-ajax-call)2。接收消息并进行 AJAX 调用
...
#### [](#3-return-result-of-the-ajax-to-original-context)3。将 Ajax 的结果返回到原始上下文
