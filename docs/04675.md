...
[![GitHub Pages Jekyll Theme](../Images/3f1004c57185c61539304b8d5f922300.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Db9y8RKv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/76nkqy3fobe6u9h31mes.png)
...
## [](#step-1-create-a-github-account)步骤 1 -创建 GITHUB 账户
...
## [](#step-2-create-a-repository)步骤 2 -创建存储库
...
## [](#step-3-enable-github-pages-for-the-repository)步骤 3 -为存储库启用 GITHUB 页面

1.  单击存储库主页上的“设置”按钮。

2.  进入设置页面后，向下滚动到“GitHub 页面”部分，选择源的主分支。

## [](#step-4-create-the-hello-world-website)步骤 4 -创建 HELLO WORLD 网站
...
## [](#step-5-visit-your-website)第五步——访问你的网站！
...
## [](#bonus-using-jekyll-themes)奖励——使用哲基尔主题
