...
> 原文:[https://dev . to/vinhnglx/integration-testing-phoenix-application-with circle-ci-20-50md](https://dev.to/vinhnglx/integration-testing-phoenix-application-with-circle-ci-20-50md)
...
### [](#install-selenium-driver)安装硒驱动程序
