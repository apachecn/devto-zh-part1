...
#### [](#test-pass-and-console-is-not-mocked)测试通过且控制台未被嘲讽
...
#### [](#test-fail-and-console-is-not-mocked)测试失败，控制台未被嘲笑
...
#### [](#test-fail-and-console-is-mocked)测试失败，控制台被嘲笑
