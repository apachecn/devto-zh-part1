...
> 原文:[https://dev . to/Lars waechter/sending-daily-live-data-to-your phone-automatically](https://dev.to/larswaechter/sending-daily-live-data-to-your-phone-automatically)
...
### [](#importing-the-required-modules)导入所需模块:
...
### [](#creating-the-weather-class)创建天气类:
...
### [](#receiving-the-weather-data)接收天气数据:
...
### [](#sending-the-data-to-your-phone)发送数据到您的手机:
