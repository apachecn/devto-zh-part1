...
> 原文:[https://dev.to/azizhk110/javascript-promise-chaining 错误处理](https://dev.to/azizhk110/javascript-promise-chaining--error-handling)

以下可能看起来像一篇固执己见的文章，也请给出你的意见。事实上，我发表这篇文章是为了验证我的想法。如果你同意，请推荐。

## [](#improving-a-piece-of-bad-code)改进一段糟糕的代码
...
## [](#log-unhandled-rejected-promises)记录未处理的拒绝承诺

### 浏览器中的[](#in-the-browser)
