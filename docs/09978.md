...
> 原文:[https://dev . to/Ahmed Khan/convert-MySQL-with-elastic search-using-mysqlwitheelastic search-package](https://dev.to/ahmedkhan/convert-mysql-with-elasticsearch-using-mysqlwithelasticsearch-package)
