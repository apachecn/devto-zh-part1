...
### [](#payment-methods-are-like-plugins-for-payment-request%C2%A0api)**支付方式就像支付请求 API 的插件**
...
[![](../Images/31c110d03348cf02b9116f745981f960.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oZFA39kg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/473/1%2A8U7xtaTaUKtTL_5p7ux9TA.png)

### [](#payment-method-identifiers)支付方式标识符
...
#### [](#standardized-payment%C2%A0methods)标准化支付方式
...
#### [](#urlbased-payment%C2%A0methods)基于网址的支付方式
