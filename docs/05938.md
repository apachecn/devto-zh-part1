...
## [](#problem-1-what-happens-to-a-temporary-file-if-the-shell-script-exits-unexpectedly)问题 1:如果 shell 脚本意外退出，临时文件会怎样？
...
## [](#problem-2-what-happens-if-the-filesystem-fills-up)问题 2:如果文件系统写满了会怎么样？
...
## [](#problem-3-beware-redirection-attacks)问题三:谨防重定向攻击。
...
## [](#avoiding-temporary-files)避开临时文件
...
## [](#i-have-no-choice-but-to-create-a-temporary-file-what-can-i-do)我别无选择，只能创建一个临时文件。我能怎么做呢？
