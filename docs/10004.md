...
> 原文:[https://dev . to/riccardo _ cardin/implementing-time-series-in-MongoDB](https://dev.to/riccardo_cardin/implementing-time-series-in-mongodb)
...
## [](#why-this-why-that)这是为什么？为什么会这样？
...
## [](#which-came-first-the-chicken-or-the-egg)先有鸡还是先有蛋？
...
# [](#three-step-initialization)三步初始化
