...
> 原文:[https://dev.to/raulavila/comparing-spock-and-junit](https://dev.to/raulavila/comparing-spock-and-junit)
...
### [](#the-class-we-need-to-test)我们需要测试的类
