...
### [](#integrate-your-email-channel-and-app-with-inemail-interactivity)将您的电子邮件频道和应用程序与电子邮件互动功能相结合。
...
### [](#but-what-does-that-really-mean)但那到底是什么意思呢？
...
### [](#what-you-get-back)自己拿回来的东西。

我们的`/campaigns/:id/html`端点将返回给你 HTML，完全准备好交付。不需要对它做任何事情，只是把它发送出去。这是在苹果邮件中看到的上述完整请求的电子邮件:

[![](../Images/0e67e506d69c62b4d5ca18e2df790afa.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VVwWcK-g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://media.sparkpost.com/uploads/2017/10/Screen-Shot-2017-10-16-at-1.51.51-PM.png)

### [](#interactive-email-analytics)互动邮件分析。
