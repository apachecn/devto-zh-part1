...
> 原文:[https://dev.to/isabolic99/oracle-apex-chat-demo](https://dev.to/isabolic99/oracle-apex-chat-demo)

一两周前，我在 apex.oracle.com 发布了简单的 apex 聊天演示。这是关于如何集成 oracle apex 和 socket.io (node.js)的演示。

## [](#basics-part-i-oracle-apex)基础知识，第一部分:Oracle apex

Oracle apex 是用于 Oracle 数据库的快速 web 应用程序开发工具。仅使用 web 浏览器和有限的编程经验，您就可以开发和部署既快速又安全的专业应用程序。

## [](#basics-part-ii-socketio)基础知识第二部分:Socket.io
...
[![alt text](../Images/a43007ce1f602384f19df6cab64d7cf4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--5q8DcuRg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8vta2nx01xmx41sf334y.png) 
...
## [](#server-side-nodejs)服务器端，node.js
...
## [](#monitoring-network-between-client-and-server)监控客户端和服务器之间的网络

为此，我使用谷歌开发者工具进行截图。在**网络**标签下的**开发者工具**和 **WS** 中，你可以看到所有当前来往的流量(在**框架**标签下，你可以看到发送/接收的文本消息)。
[![alt text](../Images/5b242a4a74a9e3cdab1fe26dfabc5b7c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--XBwopADw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7arovjjr9oaijod6telu.png)

[![alt text](../Images/5cc87c54dba4bcf7f80b4cec5ad0001e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fukASTu2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pp5c98d5nufvg5qie8zd.png)

## [](#deploying-on-apexoraclecom-openshift-online)在 apex.oracle.com[部署](https://goo.gl/eiE0TZ) / [OpenShift Online](https://www.openshift.com/)
...
[![alt text](../Images/10fa6a7e032820b67b685defcd675f32.png)T2】](https://i.giphy.com/media/JltOMwYmi0VrO/giphy.gif)
