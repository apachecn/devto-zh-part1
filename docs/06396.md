...
> 原文:[https://dev . to/d stull/my-journey-from-rspec-feature-tests-to-rails-system-tests](https://dev.to/dstull/my-journey-from-rspec-feature-tests-to-rails-system-tests)
...
# [](#rspec-failures)Rspec 故障

## [](#trying-headless-chrome-with-capybara)尝试[无头铬带水豚](https://robots.thoughtbot.com/headless-feature-specs-with-chrome)

### [](#specrailshelperrb)spec/rails_helper.rb
...
## [](#trying-capybara-webkit)正在尝试[水豚 webkit](https://github.com/thoughtbot/capybara-webkit)
...
## [](#trying-poltergeist)承欢[捣蛋鬼](https://github.com/teampoltergeist/poltergeist)
...
### [](#modifying-some-tests-for-known-clickon-issues)针对已知的[问题修改一些测试](https://github.com/teampoltergeist/poltergeist/issues/530):
...
#### [](#testtesthelperrb)测试/测试 _ 助手. rb
...
#### [](#testapplicationsystemtestcaserb)测试/应用 _ 系统 _ 测试 _ 案例. rb
...
#### [](#testsystemappmymaptestrb)测试/系统/应用/我的地图 _ 测试. rb
