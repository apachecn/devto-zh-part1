...
> 原文:[https://dev.to/chrisvasqm/loops-a-la-kotlin-2m4k](https://dev.to/chrisvasqm/loops-a-la-kotlin-2m4k)
...
### [](#1-imagine-you-are-shopping-on-amazon-and-you-want-to-raw-filter-endraw-the-raw-products-endraw-so-that-you-only-see-the-ones-with-3-or-more-as-their-raw-rating-endraw-)1)想象你在亚马逊购物，你想`filter``products`，这样你就只能看到有 3 个或 3 个以上的`rating`:
...
### [](#2-lets-say-we-want-to-print-all-the-names-of-our-raw-productswiththreeorhigherrating-endraw-to-check-which-are-the-product-we-got)2)假设我们想打印我们的`productsWithThreeOrHigherRating`的所有名称，以检查哪些是我们得到的*产品*:
...
### [](#3-now-what-if-we-want-to-know-if-there-is-at-least-1-product-in-inside-our-raw-productswiththreeorhigherrating-endraw-that-has-a-raw-rating-endraw-value-of-5)3)现在，如果我们想知道在我们的`productsWithThreeOrHigherRating`中是否至少有 1 个*产品*的`rating`值为 5 呢？
