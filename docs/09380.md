...
> 原文:[https://dev.to/ladvien/lumi3-debriefing-notes-4paj](https://dev.to/ladvien/lumi3-debriefing-notes-4paj)

# [](#c-learning-journal-refactoring-lumi)C#学习日志:重构米露
...
* [瓦尔迪兹变种人棋盘](https://ladvien.com/images/robots/valdez-mutant-board/)

不幸的是，这个项目超出了我的能力范围。在那里花了几个月的时间写 C 代码后，它就不能用了。当然，在这个过程中学到了很多关于 C 的知识。

几年后，我开始编写代码，使用瓦尔迪兹变种人文章中描述的相同方法上传编译好的 Atmel ATMega 和 ATtiny 程序。不过这次上传器是在 Windows 上用 C#写的。并且它与 Atmel uCs 上的 [TinySafeBootloader](https://ladvien.com/images/robots/tsb/) 接口。
...
[![](../Images/1e1f33837c587289a7cf84f93dff0ea3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VSPHNmm7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/lumi_blink_upload2.png)
...
[![](../Images/239f499deb3cc6e3dd480b343741febf.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--04zh7Lyo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/pooh.png) 然而，当我开始尝试添加 ESP8266 支持时——好吧，事情变糟了。似乎上面列出的所有问题中，唯一解决的是增加了蓝牙 LE 支持。我的技能没有提高。
