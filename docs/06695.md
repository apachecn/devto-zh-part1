...
### [](#1-create-a-raw-tsconfigjson-endraw-file)1。创建一个`tsconfig.json`文件
...
### [](#2-add-raw-tsloader-endraw-and-webpack-tweaks)2。添加`ts-loader`和 webpack 调整
...
### [](#3-add-raw-esmodule-true-endraw-to-raw-buildvueloaderconfjs-endraw-)3。将`es-module: true`添加到`build/vue-loader.conf.js`
...
### [](#4-use-typescript-in-files)4。在文件中使用类型脚本
...
## [](#tslint-prettier-goddess)TSLint，更漂亮...女神！
