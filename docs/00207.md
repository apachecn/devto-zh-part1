...
## [](#creating-a-new-blog-with-jekyll)用 Jekyll 创建新博客
...
## [](#adding-comments-to-jekyll%C2%A0blog)向 Jekyll 博客添加评论

现在，当我们至少有一个基本的博客时，我们可以添加评论，这样你的访问者就可以对你的内容发表评论。

首先，通过 Github 或脸书登录，在 Just Comments 上创建一个账户。您将看到系统自动生成的 API 密钥。

[![https://60devs.com/img/article-jc-jekyll/api-key.png](../Images/8c2730cb213573de234e6bb70ddea4d8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6yimH2GK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://60devs.com/img/article-jc-jekyll/api-key.png)
...
[![https://60devs.com/img/article-jc-jekyll/result.png](../Images/00157dc9b0c92a0360ae79ae4f47b670.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VbBgvI90--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://60devs.com/img/article-jc-jekyll/result.png)