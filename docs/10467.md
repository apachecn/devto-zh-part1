...
> 原文:[https://dev.to/gnclmorais/binary-in-javascript-2chb](https://dev.to/gnclmorais/binary-in-javascript-2chb)
...
## [](#a-few-technicalities-first)先说几个技术细节

让我快速地告诉您一些关于 JavaScript 如何处理数字和二元运算符的重要技术细节。

### [](#numbers-are-stored-using-64-bits)数字使用 64 位存储
...
### [](#numbers-with-more-than-32-bits-get-truncated)超过 32 位的数字被截断
...
### [](#bitwise-operations-are-performed-on-pairs-of-bits)对比特对进行逐位运算
...
[![Mind. Blown.](../Images/372c6be0d2db45a93151acdf0484ce98.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kRTu-1jV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://mrwgifs.com/wp-content/uploads/2013/11/Finns-Mind-Is-Blown-In-Space-On-Adventure-Time.gif)
...
### [](#-raw-gtgt-endraw-signpropagating-right-shift)`>>`(符号传播)右移
...
### [](#-raw-gtgtgt-endraw-zerofill-right-shift)`>>>`(补零)右移
...
### [](#convert-strings-to-numbers-emulating-raw-parseint-endraw-)将字符串转换为数字，仿效`parseInt`
...
### [](#multiply-a-number-by-multiples-of-2)将一个数乘以 2 的倍数
...
### [](#different-substring-search)不同子串搜索
...
## [](#so-should-you-use-this)那么……应该用这个吗？
