...
> 原文:[https://dev . to/code prototype/updating-local window S10-and-azure-nodejs-version-and-keep-them-in-sync-c2n](https://dev.to/codeprototype/updating-localwindows10-and-azure-nodejs-version-and-keep-them-in-sync-c2n)
...
[![Azure NodeJS version](../Images/c82fdbda3db2dec261c4cda7e874d606.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rCqwy0WP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gyophl4w2xcdp5kr7iu8.png)
...
2.  选择您的 NodeJS 应用
3.  在**设置**下，选择**应用设置**
4.  在弹出的新刀片上向下滚动到**应用程序设置**，找到网站 _ 节点 _ 默认 _ 版本，从任何版本更改为 8.9.0 ![WEBSITE_NODE_DEFAULT_VERSION Application Settings](../Images/365d5cdd408dc972f900a54bad6113b8.png)
5.  不要忘记保存
6.  很遗憾，请重启您的应用服务。
