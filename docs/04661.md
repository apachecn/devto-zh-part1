...
## [](#how-to-create-a-traildb)如何创建 TrailDB
...
## [](#how-to-query-a-traildb)如何查询 TrailDB
...
### [](#setting-a-dumb-reference-point)设置哑参考点
...
### [](#querying-with-traildb-filter-api)使用 TrailDB 过滤器 API 查询
...
### [](#querying-with-traildb-command-line-tool)使用 TrailDB 命令行工具查询
...
### [](#querying-with-traildb-command-line-tool-and-a-prepared-index)使用 TrailDB 命令行工具和准备好的索引进行查询
...
## [](#how-to-merge-multiple-traildbs)如何合并多个 TrailDBs
...
## [](#querying-139-million-events)查询 1.39 亿个事件
...
## [](#bonus-content-how-to-query-traildb-files-on-amazon-s3)额外内容:如何在亚马逊 S3 上查询 TrailDB 文件
...
## [](#bonus-content-query-traildb-with-reel-an-experimental-language)奖励内容:用 reel 查询 TrailDB，一种实验性语言
...
## [](#considerations-and-conclusions)考虑事项和结论
