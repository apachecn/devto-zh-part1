...
> 原文:[https://dev . to/Nikola/how-to-create-icons-and-splash-screen-images-automatically-in-ion-framework-3](https://dev.to/nikola/how-to-create-icons-and-splash-screen-images-automatically-in-ionic-framework-3)

[![](../Images/afffd898f01ff81455072fd278c39d58.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--u21QcSh8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vj0rcfynhdrnmej02v8l.jpg)
...
[![](../Images/cc1f339fd72657e59429ae3b66b0b99b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QbInCjYy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/IIi4opI.png)

我要用第一排的最后一个。只需点击它，您应该会看到如下所示的下载页面:

[![](../Images/b08056c1281404debf6415913efd15b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EgNJDD80--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/BtvGIBC.png)
...
[![](../Images/67a13e4eb8a56b15533b334e15b9c3db.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Fbvhax6Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/lLbXt9G.png)

现在我们需要做几个步骤:

*   选择整个区域(`Ctrl + a`或`Command + a`)并按下键盘上的`DEL`按钮。这会给你留下一张空白的画布。
*   在这块白色画布上拖动计算器图标，您应该会看到类似这样的内容:![](../Images/0ce6b8606d5c733e4efa64cc49ac391b.png)
*   单击缩放工具
*   ![](../Images/7733613f688f86ba751d894bdf28a209.png)
*   然后点击计算器图像。您应该会看到这个弹出窗口:
*   ![](../Images/c32bf08614ba526a5fdc645f327ba3c5.png)
*   将弹出菜单中的宽度和高度值更改为`1024px`，并点击`Scale`按钮。
*   单击对齐工具，然后单击计算器图像，然后单击下图中带圆圈的两个按钮。这将水平和垂直对齐计算器图像
*   ![](../Images/a94768b4283255584781e8926c2a6db3.png)

现在转到`File->Overwrite icon.png`保存文件:

[![](../Images/9d7baa147e9cb0b085810a285b952db5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wPkeqeo1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/4C8mzLi.png)

重复该过程以创建闪屏图像，并将其命名为`splash.png`(将其改写为)。我想到的图像是这样的:

[![](../Images/a7683a0374b1a9da34975f4cb0b1f4f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WCek-Cnj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/a10DZi5.png)
