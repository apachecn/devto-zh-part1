...
> 原文:[https://dev . to/aperture less/let-build-a-web-app-with-vue-chart js-and-an-API](https://dev.to/apertureless/lets-build-a-web-app-with-vue-chartjs-and-an-api)
...
[![response.data](../Images/faddf436d03f30cd94db89caeaa0bd85.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VxNUUXK3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/r0WjLCi.png)
