...
[![Microservices at Descartes Labs](../Images/d464477b1fb833a38997d6494f5a3370.png)T2】](https://justin.poehnelt.com/images/microservices-1EOecTj8ug-600.jpeg)

笛卡尔实验室的微服务

## [](#logging-bytes-sent)记录发送的字节
...
## [](#using-a-detached-thread)使用分离的线程

我们实现的解决方案包括在每个 NGINX worker 上使用一个分离的线程和一个共享的线程安全缓冲区。

[![OpenResty architecture](../Images/ce026273509b40ee49bd2db8eca5a0fe.png)T2】](https://justin.poehnelt.com/images/architecture-diagram-VMzP_YOA0Y-600.jpeg)
...
[![Google BigQuery Results Using Vegeta for Load Testing](../Images/0500cd702820a39ca55c000a43277479.png)T2】](https://justin.poehnelt.com/images/bigquery-table-output-w47vX3NkvB-400.jpeg)
