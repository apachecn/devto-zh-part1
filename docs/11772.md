...
> 原文:[https://dev . to/adamkdean/SQL-three somes-two-foreign-keys-one-primary-key-2 plh](https://dev.to/adamkdean/sql-threesomes-two-foreign-keys-one-primary-key-2plh)
