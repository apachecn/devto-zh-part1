...
### [](#packages-well-need-installed)我们需要安装的软件包
...
## [](#using-the-redux-store-in-in-react-components)使用 redux 存储在 react 组件中
...
## [](#working-with-the-react-component)使用 react 组件
