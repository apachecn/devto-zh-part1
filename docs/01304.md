...
[![](../Images/8b719be3a2851c9c3dcd7655efcbf0ee.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bgIvXkqK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/29p3wlp2mut86pp7h3gs.gif)
...
### [](#creating-controllers-and-action-methods)创建控制器和动作方法
...
## [](#implementing-the-whos-typing-feature)实现“谁在打字”功能

### [](#listening-for-the-typing-event)监听打字事件
...
### [](#creating-the-endpoint-triggered-by-the-typing-event)创建由打字事件触发的端点
...
### [](#using-pusher-to-make-our-application-update-in-realtime)使用 Pusher 使我们的应用程序实时更新
...
[![](../Images/df1e50fd1b2525c29f7bc2c70297e0c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--J2zA61w9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ow6vnmkxls9zq4ah0eud.gif)
