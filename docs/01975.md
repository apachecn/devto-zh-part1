...
> 原文:[https://dev . to/rion monster/hands-free-security-scanning-in-net-applications-DDP](https://dev.to/rionmonster/hands-free-security-scanning-in-net-applications-ddp)
...
#### [](#getting-started-with-a-security-analysis-extension)安全分析扩展入门

首先，**在 Visual Studio 的扩展和更新区域中搜索并安装一个或两个上述扩展(Roslyn Security Guard 或 Puma Scan):**

[![Installing Security Scanning Extensions](../Images/c80bf173d0a31bc8cbd3819539f7b089.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ma7uY5zB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://rion.io/content/images/2017/09/security-scanning-extensions.PNG)

安装一个(或两个)扩展后，您需要**确保您在 Visual Studio 中的工具>选项> C# >文本编辑器>高级>启用完整解决方案分析:**下启用完整解决方案分析

[![Setting Up Solution Analysis](../Images/ac8bb55c5ba27602b37afc35564c1014.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kCGnr4SM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://rion.io/content/images/2017/09/full-solution-analysis.PNG)

此时，您已经做好了一切准备，可以开始在您的应用程序中寻找潜在的漏洞了，所以让我们看看是什么样子的。

#### [](#hello-world-now-with-security)你好世界(现在有安全保障)

因为这两个扫描器都利用了 Roslyn 编译器平台，所以它允许它们实时工作，并在您编写代码时警告您潜在的代码漏洞。

让我们在 Visual Studio 中构建一个新的 Web API 项目来看看这一点:

[![Detecting CSRF](../Images/1950ecac69b8c9e0df6327f211ee52e8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--P8jzj4Gs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://rion.io/content/images/2017/09/csrf-detection.gif)
...
[![Detecting SQL Injection](../Images/3cd8d4716d5d94976495713aa7c71ed3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oPzaVD3s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://rion.io/content/images/2017/09/sqlinjection-detection.gif)
...
[![Running Analysis Manually](../Images/03fb850ed4d4a3257b1bcb3ab2fcab62.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1UhaE3jS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://rion.io/content/images/2017/09/run-analysis.png)

> **注意:**如果您发现您的错误列表中没有出现与安全相关的错误，**请确保在该部分下的可用下拉列表**中选择了 Build + Intellisense。要么这样——要么你根本没有任何错误:)

#### [](#taking-it-beyond-the-ide)超越 IDE
