...
# [](#introduction-the-rise-of-linters)简介:棉绒的崛起
...
## [](#finding-the-binaries-to-run)查找要运行的二进制文件

知道林挺程序使用哪种二进制文件可能很困难。有时候你可以使用在你的`$PATH`中的那个，但是有时候你想要在`node_modules/.bin`中的二进制

## [](#learning-the-style-convention)学习风格惯例
...
[![vim-ale gutter signs](../Images/078625edae0a932a55facc96fbe64f2a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--O3ysd98D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dmerej.info/blog/pics/vim-ale-gutter.png)
...
## [](#adding-a-vimale-linter)添加维姆-阿勒棉绒
