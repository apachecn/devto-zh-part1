...
> 原文:[https://dev.to/icambridge/code-review-sanity-checks](https://dev.to/icambridge/code-review-sanity-checks)

在大多数情况下，对代码进行健全性检查是为了确保没有错误。出于这个原因，保证正确地完成健全性检查变得很有必要。如果你不检查数据是否有效，而它是无效的，那么你将允许无效数据继续。在这里，我将讨论我认为我们应该如何在 PHP 中进行健全性检查。

## [](#asserting-valid-data)断言有效数据
...
### [](#here-is-some-example-code-with-this-problem)下面是一些关于这个问题的示例代码:
