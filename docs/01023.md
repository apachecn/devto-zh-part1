...
> 原文:[https://dev . to/freekmurze/handling-CORS-in-a-laravel-application-4o4g](https://dev.to/freekmurze/handling-cors-in-a-laravel-application-4o4g)
...
## [](#using-spatielaravelcors)使用 spatie/laravel-cors
...
## [](#using-cors-profiles)使用 CORS 个人资料
