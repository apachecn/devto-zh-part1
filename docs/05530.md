...
# [](#cut-between-frontend-and-backend-rest)前端和后端/刀架之间的切割
...
## [](#bad-the-way-we-work)不好/我们的工作方式
...
## [](#the-old-way-what-we-do-at-work)老办法/我们在工作中做什么
...
# [](#server-side-backend)服务器端/后端

## [](#perl-anyevent-dancer2-dbixclass)Perl，AnyEvent，Dancer2，DBIx::Class
