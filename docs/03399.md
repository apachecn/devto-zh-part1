...
# [](#how-a-program-outputs-its-content-on-the-terminal)一个程序如何在终端上输出其内容。
...
# [](#shell-redirections-operators)外壳重定向操作符
...
## [](#-raw-gtamp-endraw-and-raw-ltamp-endraw-)`>&`和`<&`
