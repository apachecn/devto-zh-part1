...
[![](../Images/d562ff1ac374e0afc6ced825db041e60.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yGm5v9_X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://derickbailey.com/wp-content/uploads/2015/10/hidden-variable.jpeg)

不幸的是，神话和错误信息仍然存在。除了阻止开发者尝试 Docker，他们很少做更多的事情。

所以，让我们来看看最常见的神话——有些是我见过的，有些是我以前相信过的——并试图从中找到真相，以及解决方案(如果有的话)。

## [](#myth-10-i-cant-develop-with-docker)误区十:我不能*和 Docker 发展*…

### [](#because-i-cant-edit-the-dockerfile)因为我不能编辑 Dockerfile
...
### [](#because-i-cant-see-into-my-container-at-all)因为我根本看不到我的容器里面！
...
## [](#myth-8-i-have-to-code-inside-the-docker-container)误区 8:我必须在 Docker 容器内部编码？

### [](#and-i-cant-use-my-favorite-editor)而我不能用我喜欢的编辑器？！
...
### [](#and-i-vastly-prefer-my-ides-debugger)和我*非常喜欢我 IDE 的调试器*
...
## [](#myth-6-i-have-to-docker-run-every-time)误区六:我每次都得“码头工人跑”

### [](#and-i-cant-remember-all-those-docker-run-options)我不记得所有那些“docker 运行选项…
...
## [](#myth-4-docker-is-commandline-only)误解 4: Docker 只是命令行

### [](#and-i-am-significantly-more-efficient-with-visual-tools)我和*显著地*用视觉工具更有效率
...
### [](#it-wont-scale-properly-and-ill-lose-my-data)无法正常缩放……*而且我会丢失数据！*
...
### [](#because-docker-is-allornothing)因为 Docker 是*全有全无*
...
## [](#myth-1-i-wont-benefit-from-docker-at-all)误区 1:我根本不会从 Docker 中受益…

### [](#because-docker-is-enterprise-and-devops)因为 Docker 是“企业”，而“devops”
...
## [](#dont-buy-the-hype-or-believe-the-myths)不要相信炒作或神话
