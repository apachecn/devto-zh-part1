...
### [](#defining-an-authenticated-route)定义认证路由
...
### [](#configuring-the-store-and-router-component)配置商店和路由器组件
...
## [](#the-sign-in-api-endpoint)登录 API 端点

### [](#phoenix-authorization-dependencies)凤凰授权依赖
...
## [](#setting-the-current-user)设置当前用户
...
### [](#establishing-the-current-users-socket-connection)建立当前用户的套接字连接
...
### [](#connecting-to-the-users-channel)连接到用户通道
...
## [](#making-authenticated-api-requests)发出认证 API 请求
