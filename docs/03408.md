...
> 原文:[https://dev.to/aurelkurtula/introduction-to-redux-1g3](https://dev.to/aurelkurtula/introduction-to-redux-1g3)
...
[![website](../Images/a533443f6b66c6e977cdd9a00821f41a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--M-BW0I5c--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oierevk2x9khc1moauwf.png)
...
## [](#1-interacting-with-the-redux-store-api)1。与 Redux store API 交互
...
### [](#12-getting-items-on-the-page)1.2 获取页面上的项目
...
[![shopping items](../Images/072ba46b5494dc6d42067b7c01bc235a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DK5lTsS2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6prwbf47mns31ajp5udk.png)

### [](#2-reducers-and-actions)2。减速器和动作
...
#### [](#21-the-power-of-reducers)2.1。减速器的动力
...
#### [](#22-never-mutate-state)2.2。从不改变状态
...
[![](../Images/c31b44d3accf74ab03aadbf4bfda584d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bNtS3MMj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/pbiori7dbypu5bow0i3c.png)

如果你安装了 chrome 或 firefox 的 Redux 扩展，然后在打开该扩展的情况下观看演示，你会看到每次调度一个动作时都会出现动作名称，如果你点击“跳过”(如上图右侧所示)，你会看到你的动作被撤消，这都是因为状态会不断更新。

### [](#3-subscribing-to-the-store)3。订阅商店
...
### [](#4-a-final-action-to-drive-everything-home)4。把一切都带回家的最后一次行动
