...
#### [](#linux-debian-based-distributions-)Linux(基于 Debian 的发行版) :
...
# [](#a-little-bit-of-theory-just-kidding)一点点理论(开玩笑)
...
#### [](#opening-or-creating-a-new-file)打开或创建一个新文件:
...
#### [](#writing-some-text-finally-)写一些文字(最后...):

如果你幸存到这里，你可以通过输入“我”找到你的奖励。它会将你置于**插入**模式，现在你可以随心所欲地键入文本。当你完成后，你可以使用你的退出键回到**正常**模式来保存你的更改或退出。

#### [](#some-other-useful-shortcuts-in-the-normal-mode-)其他一些有用的快捷键(在**正常**模式下) :
...
#### [](#bonus-showing-line-numbers)奖金(显示行号):
