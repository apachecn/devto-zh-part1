...
### [](#which-raw-using-endraw-statements-are-most-widely-used)哪些`using`语句使用最广泛？
...
### [](#how-many-lines-of-code-loc-are-in-a-typical-c-file)典型的 C#文件中有多少行代码(LOC)？

C#开发人员是否倾向于创建长达 1000 行的大文件？有些是，但幸运的是，这是我们中的少数人！！

[![Percentiles of lines of code per file](../Images/6e648ee17887e7fb88bdc2542dd18b8a.png)T2】](http://mattwarren.org/images/2017/10/Percentiles%20of%20lines%20of%20code%20per%20file.png)
...
[![Uncle Bob - Clean Code - Number of lines of code in a file](../Images/3a6247df86c02b8e545dd327933d0781.png)T2】](http://mattwarren.org/images/2017/10/Uncle%20Bob%20-%20Clean%20Code%20-%20Number%20of%20lines%20of%20code%20in%20a%20file.png)
...
### [](#what-is-the-most-widely-thrown-endraw-exception-raw-)最广抛的是什么`Exception`？
...
### [](#asyncawait-all-the-things-or-not)【异步/等待所有的事情】还是不是？
...
[![Number of C# Files per Repository](../Images/2e82569cc1dc29242d5cc90112d851ee.png)T2】](http://mattwarren.org/images/2017/10/Number%20of%20Files%20per%20Repository.png)
...
### [](#what-is-the-most-popular-repository-with-c-code-in-it)最流行的里面有 C#代码的库是什么？
...
### [](#what-are-the-most-popular-c-endraw-class-raw-names)最流行的 C# `class`名字有哪些？
...
### [](#bigquery-analysis-of-other-programming-languages)其他编程语言的 BigQuery 分析
