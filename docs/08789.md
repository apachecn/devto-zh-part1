...
> 原文:[https://dev . to/peterfication/multi-az-kubernetes-with-kops-in-AWS-regions-with-only-2-az](https://dev.to/peterfication/multi-az-kubernetes-with-kops-in-aws-regions-with-only-2-az)
