...
### [](#way-1-generating-a-ssh-key-recommended)方式 1——生成 SSH 密钥**(推荐)**
...
### [](#way-2-generating-a-personal-token)方式 2 -生成个人令牌
...
### [](#setting-up-a-global-gitignore)设置全局。gitignore
