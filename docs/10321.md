...
## [](#the-application-ping-pong)应用:乒乓球
...
### [](#version-zero-a-single-thread)版本零:单线程
...
### [](#version-one-players-as-threads)版本一:玩家如线程
...
### [](#version-2-infinite-game)版本 2:无限游戏
...
#### [](#version-2b-more-about-interrupt)版本 2b:关于中断的更多信息
