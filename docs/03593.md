...
# [](#containers-containers-everywhere)集装箱，到处都是集装箱！
...
## [](#collecting-dependencies)收集依赖关系
...
# [](#mounting-external-files)挂载外部文件
...
## [](#running-the-server-on-startup)启动时运行服务器
