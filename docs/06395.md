...
### [](#make-an-array-of-all-the-text)制作一个所有文本的数组
...
### [](#make-lots-of-random-text)制作大量随机文本
...
### [](#keeping-a-modular-approach)保持模块化的方法
