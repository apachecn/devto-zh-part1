...
> 原文:[https://dev . to/adammckenna/improve-the-performance-of-webstorm-and-other-jetbrains-ides-11bc](https://dev.to/adammckenna/improve-the-performance-of-webstorm-and-other-jetbrains-ides-11bc)
...
## [](#optimising-webstorms-performance)优化 WebStorm 的性能

### [](#setup-config-files)设置配置文件
...
### [](#appearance-and-behaviour)外表和行为
...
## [](#languages-amp-frameworks)语言&框架
