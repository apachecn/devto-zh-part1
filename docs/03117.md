...
> 原文:[https://dev . to/orask/send-monolog-critical-logs-directly-to-slack-6nh](https://dev.to/orask/send-monolog-critical-logs-directly-to-slack-6nh)
...
[![](../Images/224c674e2e9ec67b80fc4e308ec3179c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lrAPUwBj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nkjzshrnox4kef06ayl0.png)
[![](../Images/5dad6bdb0ac8efb6cbcee3a8adcc4f67.png)T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--4epkg0Zf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h9pdxt59ib29a270yhf7.png)
...
> ### [](#please-note-that-raw-debug-endraw-will-flood-your-channel-with-lots-of-logs-so-use-raw-critical-endraw-)Please note that `debug` will flood your channel with lots of logs, so using `critical`
> 
> ### [](#-raw-channel-endraw-should-start-with-just-like-how-it-does-appear-on-slack)`channel` should start with #, just like how it appears on Slack.
