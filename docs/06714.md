...
[![](../Images/688e8ba277e0079e482f143f68f827e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nwVSZ7RM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/r-datatypes.png)
...
## [](#sqldf-and-datatypes)SQLdf 和数据类型
...
[![](../Images/7571914dd6897aecb5b3a6d09eef167c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GnMHDX8s--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/zip-codes-number-to-string.png)

这将把 zipCode 列从一个数字转换成一个字符串，然后将它赋回 zipCodes 列。嘣！我们已经告诉计算机不要试图把邮政编码变成数字。而是把它当成一个字符串。就这样，我们稍后会告诉计算机如何使用邮政编码。

## [](#coerce-date-types-into-strings-before-passing-to-sqldf)在传递给 SQLdf 之前，将日期类型强制转换为字符串
