...
# [](#start-with-the-interface)从界面开始
...
# [](#creating-a-reference-without-a-variable)创建没有变量的参考
...
# [](#converting-blocks-to-expressions)将图块转换为表达式
...
[![Passing Tests](../Images/9b13e04a9506c822895b0c217e4ed272.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--k_NfBnGC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rrceuq9hq3mc3a9wkaf6.png)

源代码@[https://github.com/joelnet/XPromise](https://github.com/joelnet/XPromise)

# [](#postgame-wrapup)赛后总结
