...
> 原文:[https://dev . to/disk drive/how-to-get-free-SSL-certificate-for-your-meteor-site-using-lets encrypt-and-MUP-4 i14](https://dev.to/diskdrive/how-to-get-free-ssl-certificate-for-your-meteor-site-using-letsencrypt-and-mup-4i14)
...
### [](#getting-the-certificate-to-your-local-machine)获取本地机器的证书
...
### [](#turning-off-site-next-time-you-want-to-run-certbot)~~下次运行 CertBot 时关闭站点~~
