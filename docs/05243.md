...
> 原文:[https://dev . to/ray melon/automating-your-keyboards-backlit-with-bash](https://dev.to/raymelon/automating-your-keyboards-backlit-with-bash)

你有一个键盘，它在晚上有背光，但在白天没有。你节省了一点能量，而且你的键盘在晚上看起来很酷。太好了！

### [](#but-wait-a-minute)但是...等一下。
