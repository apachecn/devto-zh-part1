...
# [](#how-to-gitlab-and-docker-registry)如何:GitLab 和 Docker 注册表
...
### [](#1-install-docker-on-your-gitlab-server)1。在 GitLab 服务器上安装 Docker
...
### [](#2-make-changes-to-gitlab-config)2。对 GitLab 配置进行更改
