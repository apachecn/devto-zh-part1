...
> 原文:[https://dev . to/simply Michael/introduction-to-JavaScript-functions-DBE](https://dev.to/simplymichael/introduction-to-javascript-functions-dbe)
...
## [](#how-to-define-and-use-functions)如何定义和使用函数
...
### [](#calling-invoking-our-function)调用本方函数
...
## [](#improving-upon-our-function)改进我们的功能
...
## [](#more-on-javascript-parameters)关于 JavaScript 参数的更多内容
...
### [](#dealing-with-earlier-versions-of-javascript)处理早期版本的 JavaScript
...
## [](#summary-and-concluding-remarks)总结和结束语
