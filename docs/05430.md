...
> 原文:[https://dev.to/sake_92/render-static-site-from-scala-code](https://dev.to/sake_92/render-static-site-from-scala-code)

你有没有想过:

> 如果我丑陋的 HTML 中有一个变量...这样我就不必重复所有那些引导类，并且可以在一个地方改变它们...

# [](#sbthepek-to-the-rescue)[Sbt-hepek](https://github.com/sake92/sbt-hepek) 前来救援
