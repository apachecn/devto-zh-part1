...
> 原文:[https://dev.to/moreonfew/how-to-check-jquery-version-dl9](https://dev.to/moreonfew/how-to-check-jquery-version-dl9)
...
## [](#how-to-check-jquery-version-in-console)如何在控制台检查 jQuery 版本？
...
## [](#how-to-detect-get-jquery-ui-version)如何检测/获取 jQuery UI 版本？
