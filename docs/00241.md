...
[![](../Images/3b374a4e78e5e8d0680aa7bf2f23089f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--G60-N0vm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/690/1%2AhlWxQRXVUz4GJysQCV4F9Q.png)
...
[![](../Images/de356a8acc3f0bda988bebe40b69ed48.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--o6qnIgeC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A0vgRcttdQVBKyzWfwNtSgg.png)

### [](#switching-from-python-to-go)从 [Python](https://stackshare.io/python) 切换到[围棋](https://stackshare.io/go)
...
[![](../Images/4a4834d076e647111b466f25eae55d41.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Tj9G88sY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/434/1%2A3YtBsG5iw6brMTHvPA4ztQ.png)

如果你从未尝试过围棋，你会想试试这个在线巡回赛:[](https://tour.golang.org/welcome/1)
...
[![](../Images/1523b12f2f84f16ef9f6ea1bf4c9f3e7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--dYuw-FAv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1000/1%2AuCWv4L8tYxlUsBjLPz2_Fw.png)

### [](#switching-from-cassandra-to-rocksdb-amp-raft)从卡珊德拉切换到[洛克 sDB](https://stackshare.io/rocksdb) &筏
 ...
 **[![](../Images/bbd8c01a2638c30cdee56a7c2f308fd6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--B7QtcpQV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/965/1%2Al3C6o4EqveWRd5KImjf5gA.png)
...
要查看我们划分为堆栈的所有服务，请点击这里的[](https://stackshare.io/stream/stacks)**。**
...
[![](../Images/e545e9016cb6339aa6f95732942cfbe3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RthVxgQN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/786/1%2A0XAcnQgsD_f-JNAoll-_4w.png)
...
*   [](https://stackshare.io/jupyter)**(开发用)**
***   [**台面框架**](https://github.com/projectmesa/mesa)**

 ****分析**

分析数据是通过一个基于 Go 的微型服务器收集的。在后台，它将生成 go-routine 来根据需要汇总数据。由此产生的指标存储在[](https://stackshare.io/elasticsearch)**中。过去，我们看着 [**德鲁伊**](https://stackshare.io/druid) ，这似乎是一个坚实的项目。现在，我们可以用一个更简单的解决方案。**
...
因为我们的基础设施是用代码定义的，所以推出新区域变得很简单。我们大量使用[](https://stackshare.io/aws-cloudformation)**。我们堆栈的每一个部分都在 CloudFormation 模板中定义。如果需要，我们可以在几分钟内生成一个新的专用碎片。此外，AWS 参数存储用于保存应用程序设置。我们最大的部署在美国东部，但我们在东京、新加坡和都柏林也有分支机构。**
...
[![](../Images/a94f6da40559caa6ed52c72dd0257fa1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LlrgH-VK--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/888/1%2Ah7BP-v2TyRosk8_LvWTEWQ.png)
...
[![](../Images/62d5496992ab2358b9fbf5002f91a44c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6BmLYeer--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/430/1%2AJxfmNSyUsFHmKMZLZJmINQ.png)

我们的大部分基础设施都运行在 AWS 上:

*   [](https://stackshare.io/aws-elastic-load-balancing)**进行负载均衡**
...
[![](../Images/f1c32f5824f4737f8d7485711d272292.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bw54zYDp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AFLDN9Kgu-A7EwtFMQlckkg.png)
...
> 栈中的一个新成员是[](https://stackshare.io/opentracing)**。过去我们使用 [**New Relic**](https://stackshare.io/new-relic) ，它对 Python 来说就像一个魔咒，但不能自动测量 Go 的跟踪信息。用 [**Jaeger**](https://stackshare.io/jaeger) 进行 OpenTracing 是一个很好的解决方案，非常适合 Stream。它也可能是追踪解决方案的最佳标志:**

 **[![](../Images/32870e5ed4442827a736d372f9e53f29.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rMrPC-M3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/484/1%2AEKEsybT_RuPyfpm3CYA8lw.png)
