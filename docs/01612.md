...
[![Travis CI Service Activation](../Images/410e848fad9e941bb5f5a1fe113b182e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AqbX_Oq---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://onlythepixel.com/content/images/2017/11/travis-ci-service-activation.PNG)

这就是我所需要的，谢谢你的阅读！啊...好吧，也许需要更多的东西...

[![Travis CI without builds](../Images/3bd60c879fb1f37d0727f04544c126fe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vu-2uPGd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://onlythepixel.com/content/images/2017/11/travis-ci-no-builds.PNG)

好了，要开始用 Travis 构建东西，我必须更新代码。一旦 Travis **在回购上检测到一些新的分支或提交**，它**将运行代码为**的构建，但此时，它将失败。

## [](#setup-travis-ci-for-nodejs)为节点设置 Travis CI
...
### [](#-raw-travisyml-endraw-)`.travis.yml`
...
## [](#wait-this-post-for-a-file-with-3-lines-only)等待...这篇文章是为一个只有 3 行的文件写的吗？

是的，但是已经做了一些事情，比如在`package.json`中良好定义的依赖关系，以及使用 NodeJS 标准实践和`npm test`定义的测试。

想要更多吗？好了，还有更多的事情要做。

### [](#travis-ci-caching)特拉维斯 CI 缓存
...
### [](#travis-build-over-multiple-nodejs-versions)Travis 构建多个 NodeJS 版本
...
### [](#the-travis-status-badge)特拉维斯身份徽章

[![Build Status](../Images/d3abcd8a774076b369ea96646329b6cd.png)T2】](https://travis-ci.org/AlbertoFdzM/another-todo-api)
...
### [](#github-code-supervision-with-travis-ci)GitHub 代码监督用 Travis CI
...
[![GitHub Commits With Travis CI Status](../Images/537495e954f474031804c5f769f5e090.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ee2KKOsk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://onlythepixel.com/content/images/2017/11/github-commits-with-travis-status.PNG)
...
[![GitHub Branch Protection](../Images/a5118bfdebcea63f2fa1757651d7de6f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sPKmgevC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://onlythepixel.com/content/images/2017/11/github-branch-protection.PNG)

通过这种方式，该分支中所有要修改的代码都必须通过 PR，然后与 Travis 一起完成一次成功的构建。

[![Travis CI PR Check](../Images/7b471cca69563b1b04c73fab6a1b620b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_JXKAdjw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://onlythepixel.com/content/images/2017/11/travis-ci-pr-check.PNG)
