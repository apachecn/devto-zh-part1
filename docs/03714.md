...
# [](#zfs-y-el-problema-de-la-memoria)ZFS 和内存问题
...
# [](#pero-cu%C3%A1l-es-el-problema)但问题是？
...
# [](#como-hacer-que-zfs-se-porte-bien)因为 ZFS 是个好地方。
 ...
 **# [](#para-ir-empezando-con-zfs)从 ZFS 开始。
