...
> 原文:[https://dev.to/cr0wst/queues-and-stateful-services-4c72](https://dev.to/cr0wst/queues-and-stateful-services-4c72)
...
### [](#the-queue-worker-command)队列工作者命令
...
## [](#why-do-i-need-to-worry-about-this)我为什么需要担心这个？
...
### [](#stateless-vs-stateful-services)无状态 vs 有状态服务
...
### [](#the-consequences-of-stateful-services)有状态服务的后果
...
## [](#but-wait-im-not-using-singletons-am-i-safe)但是等等，我没有用单线，我安全吗？
