...
> 原文:[https://dev . to/nehalist/dependency-injection-in-typescript-39nb](https://dev.to/nehalist/dependency-injection-in-typescript-39nb)

[![Dependency Injection in TypeScript](../Images/7d3c44ba01212f9eb9a70ce094add8c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--81WJTVo---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ghost.nehalist.io/content/images/2019/06/di-ts.png)

我非常喜欢成熟框架的一点是，它们都实现了某种依赖注入。最近，我在 TypeScript 中试用了这项技术，以便更好地理解*如何在表面下工作。*

## [](#what-is-dependency-injection-di)什么是依赖注入(DI)？
...
## [](#dependency-injection-in-typescript)依赖注入在 TypeScript 中
...
### [](#reflection-and-decorators)倒影和装饰者
...
### [](#the-type-of-raw-target-endraw-)的类型`target`
...
### [](#interfaces-are-gone-after-compilation)接口编译后消失
...
### [](#circular-dependencies-causes-trouble)循环依赖带来麻烦
...
## [](#implementing-our-very-own-injector)实现我们自己的注入器
