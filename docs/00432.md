...
#### [](#to-clone-an-existing-repository)要克隆现有存储库:

#### [](#from-a-server-ie-github)从服务器即 GitHub:
...
[![](../Images/da549262f0f41070bf73ab89426b3a7d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sQJE1qa4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/proxy/1%2Abb6So7Y0zC5tcqyZm3LZQg.png)

或者…

#### [](#from-an-existing-repository-on-your-local%C2%A0machine)从本地机器上的现有存储库中:

```
git clone /path/to/repository 
```

#### [](#adding-a-file-to%C2%A0git)向 git 添加文件:
...
#### [](#pushing-our-commitschanges-to-the-remote-repository)将我们的提交/更改推送到远程存储库:
