...
> 原文:[https://dev.to/dzeban/packer-ansi ble-docker file-awesome container-2e 17](https://dev.to/dzeban/packer--ansible---dockerfile--awesomecontainer-2e17)
...
## [](#ansible-in-dockerfile)在 Dockerfile 中可回答
...
## [](#packer-with-ansible-provisioner)带供应器的封隔器
...
### [](#building-redis-image-with-packer-and-ansible)用 Packer 和 Ansible 构建 Redis 图像
