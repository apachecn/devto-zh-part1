...
> 原文:[https://dev . to/promise tochi/what-you-need-to-know-about-JavaScript s-implicit-construction-e23](https://dev.to/promisetochi/what-you-need-to-know-about-javascripts-implicit-coercion-e23)
...
## [](#nonnumeric-values-in-numeric-expressions)数值表达式中的非数值
...
#### [](#the-case-for-the-operator)为+运算符的情况
