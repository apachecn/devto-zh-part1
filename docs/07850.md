...
> 原文:[https://dev . to/barryo sull/cleaning-up-your-code base-with-a-clean-architecture](https://dev.to/barryosull/cleaning-up-your-codebase-with-a-clean-architecture)
...
## [](#learning-the-patterns-isnt-enough)学习模式是不够的
