...
> 原文:[https://dev . to/ryanwelcher/better-unit-testing-with-data providers-4j2j](https://dev.to/ryanwelcher/better-unit-testing-with-dataproviders-4j2j)
...
## [](#option-1-write-more-tests)选项一:多写测试。
...
## [](#option-2-use-a-dataprovider)选项 2:使用 DataProvider
