...
> 原文:[https://dev . to/forest Hoffman/hosting-WordPress-over-https-with-docker-5gc](https://dev.to/foresthoffman/hosting-wordpress-over-https-with-docker-5gc)
...
## [](#docker-compose-configuration-overview)Docker 撰写配置概述
...
## [](#nginx-proxy-container)Nginx 代理容器
...
## [](#nginx-for-wordpress-container)Nginx for WordPress 容器
...
## [](#installing-ssl-certificates-with-certbot)用 Certbot 安装 SSL 证书
