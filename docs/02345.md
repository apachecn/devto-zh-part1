...
## [](#the-problem-capturing-context)问题:捕捉上下文
...
[![StoreFinder with two Storekeeper scenario](../Images/e9253b9e983c29ab9366aa9e60d3a636.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Nz8-rBbg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://rcardin.github.io/assets/2017-11-16/sequence_diagram_sf_sk.png)

`Storekeeper`Actor 的回答数量和他们响应的主体代表了`StoreFinder` Actor 的执行上下文。

## [](#actors-context-handling)演员的上下文处理
...
[![One does not simply...](../Images/1eec65a5f691fabf0133a0604ca2575c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vf6mzLtB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1zweev.jpg)

### [](#asking-the-future)询问未来
...
### [](#finally-presenting-the-cameo-pattern)终于呈现出浮雕图案
...
[![The moment when you succeed in using the Cameo pattern](../Images/54b8c22fd2280cf3aa37fbef523b133e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QXvFo0zS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1zv67w.jpg)
...
[![I don't always handle context...](../Images/979c3afd7a6bb40ff3fb383cf9735b4a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w_x_KCxY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1zwdxs.jpg)
