...
> 原文:[https://dev.to/kahlil/zerofux 无状态单向数据流实现自定义事件 31io](https://dev.to/kahlil/zerofux---a-stateless-unidirectional-data-flow-implemented-with-custom-events-31io)
