...
> 原文:[https://dev . to/hanzeljesheen/setup-git lab-for-docker-based-development](https://dev.to/hanzeljesheen/setup-gitlab-for-docker-based-development)
