...
> 原文:[https://dev . to/k _ ivanow/using-pixijs-to-generate-or-animate-a-chrome-extension-icon](https://dev.to/k_ivanow/using-pixijs-to-generate-or-animate-a-chrome-extension-icon)
...
### [](#why-would-anyone-do%C2%A0this)为什么会有人这么做？
...
### [](#how-to-animate-the%C2%A0icon)如何制作图标动画
...
#### [](#a-few-things-to-keep-in%C2%A0mind)要记住的几件事:
...
[![](../Images/a632bd24b0788835ab39a4badfaa3230.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gtNusLY0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/164/1%2A03D71diPHSc0JlE1eVt-HA.gif)
