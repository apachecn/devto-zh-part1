...
> 原文:[https://dev . to/for foreach/knockout js-simple-truncate-text-binding-handler-4jmg](https://dev.to/forforeach/knockoutjs-simple-truncate-text-binding-handler-4jmg)
