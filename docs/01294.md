...
## [](#configure-serverlessyml)配置 serverless.yml
...
## [](#make-configuration-for-each-environments)对每个环境进行配置
...
## [](#configure-raw-circleciconfigyml-endraw-)配置`.circleci/config.yml`
