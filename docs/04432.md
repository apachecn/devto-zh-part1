...
> 原文:[https://dev . to/satans deer/getting-schwifty-with-pull-requests-MLA](https://dev.to/satansdeer/getting-schwifty-with-pull-requests-mla)
...
## [](#break-it-into-a-stack-of-prs)将其拆分成一叠 PRs
...
## [](#after-youve-got-your-prs-reviewed)审核完你的 PRs 后
