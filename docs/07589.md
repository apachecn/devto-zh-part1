...
> 原文:[https://dev . to/thatflankdev/developer-tooling-on-windows-a-cleaner-powershell-profile](https://dev.to/thatfrankdev/developer-tooling-on-windows-a-cleaner-powershell-profile)
...
[![Screenshot of a customized command prompt](../Images/ef3a2ad3ab328a34ee082257be7c0727.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--51pyWLIP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://4.bp.blogspot.com/-okseuC5zGMw/WSQZLLHGO6I/AAAAAAAAADE/IUAV-9_sxMcVmFn3p640XzbVguBBozNvgCKgB/s640/prompt_sample.png)

## [](#execute-profile-scripts-on-powershell-session-startup)在 PowerShell 会话启动时执行配置文件脚本
...
## [](#because-were-all-so-lazy-a-little-install-script)因为我们都太懒了:一点安装脚本
