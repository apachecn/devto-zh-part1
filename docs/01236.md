...
> 原文:[https://dev . to/mizutani/how-to-get-core-file-of-segmentation-fault-process-in-docker-22ii](https://dev.to/mizutani/how-to-get-core-file-of-segmentation-fault-process-in-docker-22ii)

## [](#configure-to-get-core-file)配置获取核心文件
...
## [](#after-segmentation-fault)分割故障后
...
## [](#after-boot-a-container)启动一个容器后
