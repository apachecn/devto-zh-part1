...
> 原文:[https://dev . to/Mr tango/dynamic-screen-definitions-in-i3wm-328 a](https://dev.to/mrtango/dynamic-screen-definitions-in-i3wm-328a)
...
## [](#separating-i3-config-files)分隔 i3 配置文件
...
## [](#generating-the-screen-config-file-for-i3)生成 i3 的屏幕配置文件
...
## [](#generating-the-i3-config-from-configd-files)从 config.d 文件生成 i3 配置
