...
> 原文:[https://dev.to/lloydstubber/my-wsl-setup-for-development](https://dev.to/lloydstubber/my-wsl-setup-for-development)
...
### [](#download-amp-install-the-wsl)下载&安装 WSL

*   在这里遵循非常详细的说明

### [](#get-your-terminal-looking-pretty-pt1)让你的终端看起来漂亮点 1

*   下载 Hyper.js [这里](https://hyper.is/)
*   我选择了“超蓝”主题

### [](#automatically-open-in-bash)在 Bash 中自动打开
...
### [](#get-your-terminal-looking-pretty-pt2)让你的终端看起来漂亮点 2
...
### [](#fix-the-ls-and-cd-colours)确定 ls 和 cd 的颜色
...
### [](#setup-a-ssh-key-and-link-to-your-github)设置一个 SSH 密钥，链接到你的 Github
...
### [](#install-node-version-manager)安装节点版本管理器

*   遵循这里的说明，这将使您在 Node/npm 上运行，并且可以轻松地回滚到合适的版本。

### [](#install-gulp-cli)安装 Gulp CLI
