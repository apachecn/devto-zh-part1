...
> 原文:[https://dev . to/gonsie/part-1-using-org-to-develop-elisp-4 ILC](https://dev.to/gonsie/part-1-using-org-to-develop-elisp-4ilc)
...
## [](#the-power-of-introspection)自省的力量
...
## [](#starting-with-org-blocks)从组织块开始
...
### [](#basics-running-and-results)基础知识:跑步和成绩
