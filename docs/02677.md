...
> 原文:[https://dev . to/Victoria/batch-rename-images-including-image-resolution-with-awk-2d 7](https://dev.to/victoria/batch-renaming-images-including-image-resolution-with-awk-2d7)
...
## [](#isolate-the-information-we-want)分离出我们想要的信息
...
## [](#avoid-duplicate-file-names)避免重复文件名
...
## [](#bonus-round-rainbow-output)奖励回合:彩虹输出！
