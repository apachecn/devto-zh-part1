...
# [](#but-wait-why-should-i-use-my-own-git-server)但是等等…为什么要用自己的 Git 服务器？
...
# [](#ok-im-sold-what-do-i-need)好吧，我卖了。我需要什么？
...
# [](#all-checks-are-green-how-do-i-install-that)所有检查都是绿色的。我如何安装它？
...
# [](#great-so-how-do-i-use-nginx-as-a-proxy)伟大。那么我如何使用 nginx 作为代理呢？
...
## [](#configure-the-socket-to-use-the-gitlab-workhorse)配置套接字以使用 GitLab
...
## [](#configure-the-site-in-nginx)在 nginx 中配置站点
...
## [](#configure-gitlab-to-work-behind-nginx)配置 GitLab 在 nginx 后面工作
