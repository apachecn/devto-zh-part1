...
> 原文:[https://dev . to/danlebrero/how-to-docker-compose-a-developer-environment-an-open-source-example-72k](https://dev.to/danlebrero/how-to-docker-compose-a-developer-environment-an-open-source-example-72k)
...
## [](#akvo-lumen-architecture)Akvo 流明架构
...
[![Akvo Lumen architecture](../Images/795e9f57813c83314766756be08f0688.png "Akvo Lumen production architecture")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GUZsaOrw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://danlebrero.com/images/blog/docker-compose/prod-setup.jpg)

*   Keycloak 是一款开源的单点登录应用。它与其他 Akvo 产品共享。
*   Nginx 为 SPA 提供服务，并将请求代理到后端。
*   后端就是后端...

## [](#before-docker-compose)在 docker 撰写之前
...
[![Akvo Lumen developer docker compose setup](../Images/d35af9f782eb5be6b722e331d785242b.png "Developer environment setup with Docker Compose")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--89mmhEKp--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://danlebrero.com/images/blog/docker-compose/dev-docker-compose.jpg)

## docker 撰写文件

整个 docker 编写文件可以在[这里](https://github.com/akvo/akvo-lumen/blob/develop/docker-compose.yml)找到。

### [](#postgres-and-keycloak)Postgres 和 Keycloak
...
## [](#running-tests-and-other-build-tasks)运行测试和其他构建任务
...
## [](#a-note-on-startup-dependencies)关于启动依赖的一个注记
