...
> 原文:[https://dev . to/mariordev/load-a-random-background-image-on-page-load-in-Jekyll-i16](https://dev.to/mariordev/load-a-random-background-image-on-page-load-in-jekyll-i16)
