...
## [](#what-are-we-working-with)我们在做什么？
...
### [](#1-setting-up-an-aws-account)1。设置 AWS 帐户
...
### [](#2-adding-an-iam-user-to-the-account)2。向帐户添加 IAM 用户
...
### [](#3-adding-permissions-for-cloud9-and-administration-to-that-user)3。向该用户添加 Cloud9 权限和管理权限
...
### [](#4-logging-into-aws-with-the-created-user)4。使用创建的用户登录 AWS
...
### [](#5-creating-a-cloud9-environment)5。创建云 9 环境
...
### [](#6-installing-and-configuring-bucklescript)6。安装和配置 BuckleScript
...
#### [](#interlude-setting-the-ec2-instance-back-to-t2micro)插曲:将 EC2 实例设置回 t2.micro
...
### [](#7-installing-and-configuring-serverless)7。安装和配置无服务器
...
### [](#8-converting-the-javascript-code-to-reason)8。将 JavaScript 代码转换为 Reason
...
### [](#9-compiling-reason-to-javascript)9。将原因编译成 JavaScript
...
### [](#10-deploying-function-to-aws-lambda)10。将功能部署到 AWS Lambda
