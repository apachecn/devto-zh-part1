...
> 原文:[https://dev . to/nisrulz/things-I-wish-I-know-when-I-started-building-Android-SDK libraries](https://dev.to/nisrulz/things-i-wish-i-knew-when-i-started-building-android-sdklibraries)
...
[![header](../Images/bf1453a7e4d4ca6f9a9844925c5e53a4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xG3lH7M1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/header.png)
...
### [](#why-would-you-create-an-android-sdklibrary)为什么会创建 Android SDK/库？

[![question](../Images/2e1ee1b19855f08f7351d2cddad353b0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BpVKoOXs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/question.gif)
...
### [](#what-are-the-packaging-options-for-your-artifacts)你的神器有哪些包装选择？
...
### [](#we-have-the-artifact-now-what-where-does-one-host-these-artifacts)我们有了神器，现在怎么办？这些人工制品存放在哪里？

[![question](../Images/e21ddff5d681d028359fc66232c31e6c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LvOLzQ8B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/trickquestion.gif)
...
##### [](#localremote-maven-repositories)本地/远程 Maven 知识库
...
##### [](#maven-central-jcenter-or-jitpack)Maven Central、Jcenter 或 JitPack
...
### [](#avoid-multiple-arguments)避免多重争论
...
[![easy](../Images/ac70a484e8976d6ed93cbe3c62f90ef9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ukJttSdo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/easy.gif)

### [](#minimize-permissions)最小化权限
...
### [](#support-different-versions)支持不同版本

[![how many](../Images/c84cf1ef02ba4f4992d028acc41ce848.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UF92XjOy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/howmany.gif)
...
### [](#do-not-log-in-production)不登录生产

[![donot](../Images/9a149026d09d6a28dd06def441ed771a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GikJZ1xx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/no.gif)
...
### [](#do-not-crash-silently-and-fail-fast)不要无声无息的崩溃，快速失败

[![crash](../Images/c8e935599a2e495068bd7cee503e6c12.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--EMMEMVvo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/crash.png)
...
### [](#degrade-gracefully-in-an-event-of-error)在发生错误时优雅地降级

我的意思是，当你的 android 库代码失败时，尝试进行检查，这样代码就不会使应用程序崩溃，而是只有你的库代码提供的功能被禁用。

### [](#catch-specific-exceptions)捕捉特定的异常
...
### [](#handle-poor-network-conditions)处理恶劣的网络条件

[![poor connections](../Images/73b371a523bc89e84e93b2052e44627a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bG3h_p4j--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/loading.gif)
...
### [](#reluctance-to-include-large-libraries-as-dependencies)不愿包含大型库作为依赖项
...
### [](#do-not-require-dependencies-unless-you-very-much-have-to)除非万不得已，否则不需要依赖
...
### [](#try-not-to-hog-the-startup)尽量不要抢着启动

[![worst](../Images/ff13c6dbd6696de5cbf3963b33b1d905.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8lrBWlA---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/worst.gif)
...
### [](#remove-functionality-and-features-gracefully)优雅地删除功能和特性
...
[![document](../Images/e9d1f48537270ae9df3c46cc85d19027.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jHGh42dU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/davinci.gif)
...
[![changelog](../Images/b6d40b6aebfcfd299431702b96555399.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ty7yB1FS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/changelog.jpeg)
...
### [](#provide-a-most-minimalistic-sample-app)提供一个最简约的样例 App
...
### [](#consider-putting-up-a-license)考虑贴出许可证
...
### [](#last-but-not-the-least-get-feedback)最后，获得反馈

[![feedback](../Images/340f17d21d94ba8a7d78e5f03e2c8288.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iXXmrg8P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://crushingcode.github.io/images/posts/things-i-wish-i-knew-when-i-started-building-android-sdk-libraries/feedback.gif)
