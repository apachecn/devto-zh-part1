...
> 原文:[https://dev . to/adamkdean/local-DNS-resolver-found-in-resolv-conf-and-containers-can-t-use-it-55ih](https://dev.to/adamkdean/local-dns-resolver-found-in-resolv-conf-and-containers-can-t-use-it-55ih)
