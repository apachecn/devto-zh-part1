...
> 原文:[https://dev . to/fede kau/automatically-managing-personal-and-work-git-configuration s-27ad](https://dev.to/fedekau/automatically-managing-personal-and-work-git-configurations-27ad)
...
## [](#step-1-configure-your-ssh-keys)步骤 1:配置您的 SSH 密钥
...
## [](#step-2-add-user-details-to-work-and-personal-folders)第 2 步:将用户详细信息添加到工作和个人文件夹
...
## [](#final-step-overriding-git-configuration-based-on-current-folder)最后一步:基于当前文件夹覆盖 git 配置
