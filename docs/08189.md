...
> 原文:[https://dev.to/dzeban/how-to-point-gdb-to-your-sources-5ho0](https://dev.to/dzeban/how-to-point-gdb-to-your-sources-5ho0)
...
### [](#2-change-gdb-source-path)2。更改 GDB 源路径
...
### [](#3-set-gdb-substitution-rule)3。设置 GDB 替换规则
...
### [](#4-move-binary-to-sources)4。将二进制文件移动到源代码
...
### [](#5-compile-with-raw-fdebugprefixmap-endraw-)5。用`-fdebug-prefix-map`编译
