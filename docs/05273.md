...
> 原文:[https://dev . to/scastiel/create-a-simple-and-tested-redux-like-app-with-react](https://dev.to/scastiel/create-a-simple-and-tested-redux-like-app-with-reason-react)
...
## [](#describing-our-applications-state)描述我们的应用程序的状态
...
## [](#defining-the-possible-actions)定义可能的动作

### [](#actions-definitions)动作定义
...
## [](#designing-the-react-component)设计 React 组件
...
#### [](#testing-rendering-with-snapshots)用快照测试渲染
