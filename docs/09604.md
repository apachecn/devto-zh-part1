...
### [](#securing-your-elasticsearch-instances-and-keeping-all-the-fun)保护您的 ElasticSearch 实例，享受所有乐趣
...
## [](#part-one-restricting-the-access-to-your-elasticsearch-instance)第一部分:限制对你的 ElasticSearch 实例的访问
