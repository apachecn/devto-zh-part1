...
### [](#create-base64url-header-and-payload-strings)创建 Base64Url 头和有效载荷字符串
...
### [](#base64url-encode-the-signature)Base64Url 编码签名
...
### [](#create-the-json-web-token)创建 JSON Web 令牌
