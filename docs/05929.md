...
当我运行测试时，我看到它失败了:
[![screenshot](../Images/5772649eb052d34a60774f13ad7b518e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ja5bB37g--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/50a3mgwe421oh3qjtm0t.png) 
问题是我将堆栈的大小作为堆栈的一个元素读入。相反，我应该忽略它:`str_stack = input().split(' ')[1:]`。

# [](#how-the-solution-works)解决方案的工作原理
