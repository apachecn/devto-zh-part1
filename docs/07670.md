...
> 原文:[https://dev . to/fmvilas/introducing-the-async API-specification](https://dev.to/fmvilas/introducing-the-asyncapi-specification)
...
# [](#why-another-specification)为什么是另一种规格？
...
### [](#documentation-generators-and-api-support)文档生成器和 API 支持
