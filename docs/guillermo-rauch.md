...
> 原文：<https://dev.to/betweenthewires/guillermo-rauch>

*我是***的创始人。我们的使命是让云部署变得简单、全球化和实时。我还构建了*[*socket . io*](http://socket.io/)*并在之前创办了两家创业公司:LearnBoost 和 CloudUp。**

 *## **给我们介绍一下你的童年，以及你在哪里长大的。**

我在阿根廷布宜诺斯艾利斯外的一个小镇长大。这是一个很小的居住社区，几乎没有互联网接入，也很难获得一台电脑。
...
<figure>[![](img/5f04d5062adcbaf303b2f97d040e15db.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--s7aw416X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ARgTaOHeiq7rSxyeKXF949g.jpeg) 

<figcaption>吉列尔莫，12 岁，向理查德·斯托尔曼解释说 VI>emacs</figcaption>
...
我想那是我第一次意识到编程对我来说非常令人兴奋。我实际上可以从黑屏上的这几个字符中提取如此多的兴奋。对编程的兴奋与此有很大关系，因为在这个过程中有太多的负面反馈，以至于胜利会让你非常兴奋。正是这些小事——比如屏幕上有一串绿点的测试通过——让我非常兴奋。

## 那好像是受 [Hyper.app](https://hyper.is/) 的影响吧？
...
## 你的第一家创业公司 LearnBoost，开发了这么多开源项目，并在早期帮助推动了 Node JS 的采用，你是如何做到的，或者这是一个副作用？
...
我认为有两种情感挑战。一种是你直接面对的——也许你试图销售你的产品，但因为他们选择了你的竞争对手而被拒绝了，或者你被投资者拒绝了。这种类型的挑战是“哦，出问题了”的直接反馈
...
## 有趣。很明显，你已经用 ZEIT 和 HyperTerm 重新开始了，所以第一次启动并没有让你失望。我很想知道，现在你正在构建它，你认为 ZEIT 和 HyperTerm 的成功的长期结果是什么？
...
我们的愿景是，公司中的任何人都将能够自己完成整个产品或体验并进行部署。你把权力交给一个人，否则就需要一整队人。你可以在 100 毫秒内给他们反馈，而过去需要几分钟、几小时或几周。
...
<figure>[![](img/38140f4912bb670a32997c3b8a3ccda0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--y5POi5Jz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2At3UFr8sntJi51plbPl4PJg.jpeg) 

<figcaption>Zeit 团队及其欧洲最大的客户</figcaption>

</figure>

我给你举一个我认为分布式团队最大优势的例子:我们推出了 Hyper.app，这是我自己花了大约两周时间开发的。然后我向世界开放了。接下来发生的事会让你大吃一惊。在我们发布它的一个星期后，我们已经有 50 个贡献者提出了拉取请求。我们在它上面写了 100 个插件。
...
<figure>[![](img/74c03b28da7a6f580ac6e699fb0d3a54.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--lGPipk0X--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2ACEIMwxWSvQwRZMj1y-gccA.jpeg) 

<figcaption>Dei，soÂ zen。</figcaption>
...
*本帖最初发表于[betweenthewires.org](https://betweenthewires.org/2016/11/02/guillermo-rauch/)T3】**