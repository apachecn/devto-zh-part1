...
[![](../Images/f5cfc47bfbb7ea90215194648c1906ff.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Byfs16_R--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jofn8buzhvkot1xkpvq5.JPG)
...
[![](../Images/f57144cd18af0b49e786a651752c5e72.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kFMwgWhT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d5mwhbuiruymgip00quf.JPG)
...
[![](../Images/f602a4a5900add8a6491928ba3132647.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--xkdFnwCV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rhyou3q14z1cjhjimq59.JPG)
[![](../Images/d757a36f043d8db639c1b38ecceeeb1c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--09mT2BhX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kt35hh9t6cy98dbyf6k1.JPG)
...
### [](#router-named-path-parameters-amp-wildcard)路由器:命名路径参数&通配符
...
### [](#router-all-the-above-mixed-without-conflict)路由器:以上所有混合无冲突
...
### [](#router-custom-http-errors)路由器:自定义 HTTP 错误
...
### [](#100-compatible-with-nethttp)100%兼容网络/http
...
### [](#view-aka-templates-embedded-into-app)嵌入应用程序的视图(又名模板)
...
#### [](#what-is-a-view-engine)什么是视图引擎

当框架支持模板加载时，自定义和内置的模板功能可以在关键部分挽救我们的生命。

### [](#view-engine-std)查看发动机:标准

当框架支持通过标准的`html/template`解析器加载模板时。

### [](#view-engine-pug)查看引擎:Pug

当框架支持通过`Pug`解析器加载模板时。

### [](#view-engine-django)查看引擎:Django

当框架支持通过`Django`解析器加载模板时。

### [](#view-engine-handlebars)查看发动机:车把

当框架支持通过`Handlebars`解析器加载模板时。

### [](#view-engine-amber)查看引擎:琥珀色

当框架支持通过`Amber`解析器加载模板时。

### [](#renderer-markdown-json-jsonp-xml)渲染器:Markdown、JSON、JSONP、XML...
...
### [](#file-server-embedded-into-app)文件服务器:嵌入 App
...
### [](#response-can-be-modified-many-times-through-lifecycle-before-sent)响应在发送前可以通过生命周期多次修改
...
### [](#maintenance-amp-autoupdates)维护&自动更新
