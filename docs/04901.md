...
> 原文:[https://dev . to/r0f 1/python 中最让你困惑的是什么](https://dev.to/r0f1/what-is-the-most-confusing-thing-to-you-in-python)

只是一些陷阱和陷阱，我花了一段时间来适应 Python。

### [](#list-methods-vs-builtin-methods)列表方法与内置方法
