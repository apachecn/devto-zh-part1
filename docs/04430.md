...
> 原文:[https://dev . to/alexhyettdev/running-scheduled-console-apps-with-net-core-cron-and-docker-441 e](https://dev.to/alexhyettdev/running-scheduled-console-apps-with-net-core-cron-and-docker-441e)
...
## [](#gotcha-1-no-environment-variables)问题 1:没有环境变量
...
## [](#gotcha-2-invalid-environment-variables)问题 2:无效的环境变量
...
## [](#gotcha-3-crossplatform-considerations)问题 3:跨平台考虑
