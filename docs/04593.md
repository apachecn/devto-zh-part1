...
## [](#resources-for-beginners)初学者资源

### [](#typescript-official-documentation)[打印正式文件](https://www.typescriptlang.org/docs/home.html)

### [](#typescript-introduction-free-udemy-course-1-hour)[打字稿介绍(免费 Udemy 课程- 1 小时)](https://www.udemy.com/typescript/learn/v4/overview)

### [](#great-curse-to-begin-with-typescript-30-minutes)[伟大的诅咒以打字稿开始(30 分钟)](https://tutorialzine.com/2016/07/learn-typescript-in-30-minutes)

### [](#you-can-test-all-the-examples-here)你可以在这里测试所有的例子

## [](#general-types)一般类型

#### [](#number-string-boolean-and-object)数字、字符串、布尔和对象
...
#### [](#return-types-of-callbacks)返回回调类型
...
#### [](#use-optional-parameters)使用可选参数
