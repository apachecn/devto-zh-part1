...
[![](../Images/5ba1414494db523133a137c55e846af3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RxL6aqiQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.techiediaries.com/images/content/ionic2.jpg)
...
## [](#cloud-firestore-features-vs-firebase-realtime-database)云 Firestore 功能与 Firebase 实时数据库对比
...
## [](#first-steps-and-requirements)第一步及要求
...
## [](#integrating-cloud-firestore-with-ionic)整合云 Firestore 与 Ionic
...
### [](#retrieving-or-querying-documents)检索或查询文档
...
### [](#creating-or-adding-documents)创建或添加单据
