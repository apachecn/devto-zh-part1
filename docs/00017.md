...
> 原文:[https://dev . to/booyaa/open-source-tools-and-work-proxy-adn](https://dev.to/booyaa/open-source-tools-and-work-proxies-adn)
...
## [](#environment-variables-env-vars)环境变量(env vars)
