...
> 原文:[https://dev.to/adamkdean/installing-git-for-windows-2l4b](https://dev.to/adamkdean/installing-git-for-windows-2l4b)
...
[![Git Gui](../Images/069493953aeb115e366ad7a7e3455c11.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qQYuQfD2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/uwAkZLA.png)

现在转到`Help`，然后是`Show SSH Key`。您应该看到这个窗口:

[![SSH Key](../Images/8e8c4c8f228851a42cceb58e1c513510.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wnWm8tR7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/QweECTb.png)
...
[![Account settings](../Images/6744a3c71bc3a3fb177a65dcfc4f9b00.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2RanHZXH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/8a4pGFt.png)

接下来，点击`SSH Keys`选项卡。

[![SSH Keys](../Images/650fc5f03181af4336fc2674453b1873.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZNX0WDPO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/zR2wp9Y.png)

一旦你完成了，点击`Add SSH Key`并粘贴你之前在 Git GUI 中生成的大块文本。给它起个好记的名字，比如 *HomePC* 或者 *WorkPC* ，点击`Add key`。

你现在可以关闭`Git GUI`了。

# [](#setting-up-git-profile)设置 Git 配置文件
...
[![Success](../Images/6cb8ed5fcd75eadfd4e912b93e01997f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nerGu-sE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/H3x0E1w.png)
