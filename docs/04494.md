...
> 原文:[https://dev . to/satans deer/magic-mystery-guide-for-asyncait-in-JavaScript-kke](https://dev.to/satansdeer/magical-mystery-guide-for-asyncawait-in-javascript-kke)
...
## [](#asyncawait-not-yet-generators)异步/等待？还没有，发电机
...
## [](#finally-we-are-getting-to-asyncawait)最后，我们开始异步/等待
