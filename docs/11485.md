...
> 原文:[https://dev . to/for foreach/binding-event-to-all-elements-except-specific-element-and-all-its-contents-3c 29](https://dev.to/forforeach/binding-event-to-all-elements-except-specific-element-and-all-its-contents-3c29)
