...
> 原文:[https://dev . to/aaahmedaa/create-restapi-for-your-python-scripts-using-flask-with-15-line-of-code-10ml](https://dev.to/aaahmedaa/create-restapi-for-your-python-scripts-using-flask-with-15-line-of-code-10ml)

## [](#creating-virtualenv-for-save-working)创建用于保存工作的 virtualenv
...
## [](#creating-the-project-files)创建项目文件
