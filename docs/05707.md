...
> 原文:[https://dev.to/sroy8091/final-app-submission](https://dev.to/sroy8091/final-app-submission)

这是关于构建我的 web 应用程序 Snipcode 之旅的最后一篇文章。这里可以看到源代码[。](https://www.github.com/sroy8091/snipcode)

下面是我的网络应用

[https://www.youtube.com/embed/hWaWZ3cPk8o](https://www.youtube.com/embed/hWaWZ3cPk8o)
...
*   Node.js 以及它有多美
*   Postgresql(大象是开发人员最好的朋友)
*   Codemirror(基于 Web 的 IDE)
*   编写有效代码的一些简洁实践

我希望在这之后，我仍然可以通过做一些事情来学习东西。因为当你创造东西的时候很有趣。
