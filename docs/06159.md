...
## [](#options-for-scaling-out-your-database)扩展数据库的选项
...
### [](#scaling-out-postgres-with-ease-by-adopting-a-multitenant-data-model)采用多租户数据模型轻松扩展 Postgres
...
### [](#multitenancy-and-colocation-a-perfect-pair)多租户和共址，完美的一对
...
[![Example of multi-tenant sharded tables](../Images/ac0dbd09d520efb6097dfe4d8c40c9cf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KhAKq2io--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://d3vv6lp55qjaqc.cloudfront.net/items/0n0E3430183k0J410H05/shard_tenant.png%3Fv%3Df9133ad4)
