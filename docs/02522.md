...
## [](#no-dont-do-it)不，不要这样做

我知道，模仿那些通过数据库或网络调用来使规范运行得更快的库可能很有诱惑力，但这不是测试双精度的目的。

Test doubles 旨在帮助您在应用程序的各个部分之间创建实用而方便的接口。

[![mocking](../Images/b80e7fa2d064b644ae5e7ad2063ba3ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--cUZra8CB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://d33wubrfki0l68.cloudfront.net/ffdb5ecb003cb96dfe10eb900fe011835d06f89e/2c8d8/assets/images/dont_mock_1.png)
