...
> 原文:[https://dev . to/swergi 0/understanding-closures-in-JavaScript-with-delicious-Mexican-food](https://dev.to/swergi0/understanding-closures-in-javascript-with-delicious-mexican-food)
...
# [](#how-to-create-a-closure)如何创建闭包
