...
## [](#avoid-losing-the-generic-type)避免丢失类属类型
...
## [](#avoid-matching-on-generic-type-parameters)避免在泛型类型参数上匹配
...
## [](#introducing-typeable-and-typecase)引入可类型化和类型化案例
...
### [](#keeping-the-generic-type-generic)保持类属类型“类属”
...
### [](#typeables-secret-sauce)Typeable 的秘制酱
...
### [](#custom-type-class-instance-for-typeable)自定义可类型化的类型类实例
...
### [](#type-tags-and-unknown-types)类型标签和未知类型
...
### [](#extracting-the-boilerplate)提取样板文件
...
### [](#casting-time-relation-to-input-size)铸造时间与输入尺寸的关系
