...
[![Depth progression for  raw `Vector[(Int, String)]` endraw ](../Images/efda1e359266baded98fec157e0dfbda.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VMEMqZfb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lepovirta.org/posts/images/sample_depth.png)
...
## [](#from-case-classes-to-products)从案例类到产品
...
## [](#from-sealed-traits-to-coproducts)从封闭性状到联产品
...
## [](#a-type-class-for-deriving-type-class-instances)用于派生类型类实例的类型类
...
[![Graph demonstrating the generic solution using Shapeless types.](../Images/c68c7982b99d11f87daee4e392098438.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---2mk2rer--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://lepovirta.org/posts/images/type_universes.png)
