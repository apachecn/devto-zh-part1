...
> 原文:[https://dev.to/farisj/custom-buildpacks-in-heroku-5176](https://dev.to/farisj/custom-buildpacks-in-heroku-5176)
...
### [](#enter-custom-heroku-buildpacks)进入:自定义 Heroku Buildpacks！
...
#### [](#-raw-bindetect-endraw-)`bin/detect`
...
#### [](#-raw-bincompile-endraw-)`bin/compile`
...
#### [](#-raw-binrelease-endraw-)`bin/release`
