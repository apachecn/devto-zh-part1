...
> 原文:[https://dev . to/fence posterror/hacking-开源软件-以娱乐和非盈利为目的](https://dev.to/fenceposterror/hacking-open-source-software-for-fun-and-non-profit)
...
[![sqli](../Images/e235d67db4f34fbd0891eb57a14d4714.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WdvHRmvG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/7ih55faysl7ykv6xz3je.png)
...
### [](#unquoted-sql-injections)无引号的 SQL 注入
...
### [](#find-vulnerabilities-in-nonactive-code)查找非活动代码中的漏洞
...
### [](#logic-errors-are-difficult-to-find-with-static-code-analysis)用静态代码分析很难发现逻辑错误
...
### [](#same-php-object-instantiation-but-different)相同的 PHP 对象实例化但不同
