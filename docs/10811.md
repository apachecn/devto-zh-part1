...
> 原文:[https://dev . to/0x 4445565 a/避免代码抓取测试](https://dev.to/0x4445565a/avoiding-the-code-crawl-with-tests)
...
## [](#a-story-as-old-as-time)一个和时间一样古老的故事
...
## [](#what-about-a-real-life-example)现实生活中的例子呢？
