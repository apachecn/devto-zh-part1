...
> 原文:[https://dev . to/buntine/DOM-elements-with-ids-is-global-variables](https://dev.to/buntine/dom-elements-with-ids-are-global-variables)
...
## [](#should-i-make-use-of-this)我该利用这个吗？
