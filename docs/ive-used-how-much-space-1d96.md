...
> 原文：<https://dev.to/ferricoxide/ive-used-how-much-space-1d96>
...
我不是一个很擅长 GUI 操作的人，我想要一些可以从 CLI 运行的东西，这些东西可以提供给带外通知程序。AWS CLI 提供了`s3api`工具集，对于这样的操作非常方便。我的第一次挖掘(和一些谷歌搜索)，我整理出“我如何获得这个桶的总利用率视图”。它看起来像:
...
“一天的备份”也超出了预期。上次我对他们的备份进行普查时(今年夏天早些时候)，他们可能有 400 亿字节的数据。他们想要一周的备份。然而，在 200 gib/天的备份量下，我发现我真的无法削减利用率。这也意味着，也许他们一直在控制老化的东西。

*注意:是的，S3 有生命周期政策，允许您自动将东西转移到成本较低的层。不幸的是，自动分层(至少从常规 S3 到 S3 IA)的最短期限为 30 天。没用的，这里。*

挽救恩典:至少我找到了一种不用 web GUI 就能获得(特定)指标的方法。另一个副作用是，我有了一种方法来验证到达 S3 的数量是否与从他们的 CI/CD 应用程序中导出的数量相匹配。