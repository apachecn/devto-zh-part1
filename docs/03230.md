...
> 原文:[https://dev . to/MRM 8488/using-es6-array-destruction-with-promises-CCO](https://dev.to/mrm8488/using-es6-array-destructing-with-promises-cco)
...
### [](#asyncawait-version-extra-for-devto-friends-)异步/等待版本(额外提供给朋友) :
