...
> 原文:[https://dev . to/jmbejar/how-to-quick-deploy-a-vuejs-app-to-heroku-5b 0f](https://dev.to/jmbejar/how-to-quickly-deploy-a-vuejs-app-to-heroku-5b0f)
...
### [](#step-1-add-a-minimal-nodejs-server)第一步:添加一个最小 NodeJS 服务器
...
### [](#step-2-setup-packagejson-scripts)第二步:设置 package.json 脚本
...
### [](#step-3-try-it-and-enjoy)第三步:尝试，享受！
...
### [](#do-not-use-raw-devdependencies-endraw-)不使用`devDependencies`
...
### [](#set-npmconfigproduction-to-false)将 NPM _ 配置 _ 生产设置为假
