...
> 原文:[https://dev . to/adamkdean/easy auth-now-available-via-nuget-4k3o](https://dev.to/adamkdean/easyauth-now-available-via-nuget-4k3o)
...
### [](#homecontrollercs)HomeController.cs
