...
> 原文:[https://dev . to/techiediaries/ionic-4-tutorial-with-angular js-and-Cordova-45jn](https://dev.to/techiediaries/ionic-4-tutorial-with-angularjs-and-cordova-45jn)
...
## [](#generating-a-new-cordova-project)生成一个新的科尔多瓦项目
...
## [](#installing-angularjs-and-ionic-4-core-components)安装 AngularJS 和 Ionic 4 核心组件
...
## [](#adding-the-browser-platform)添加浏览器平台
...
## [](#adding-routing-using-uirouter)使用 UI 路由器添加路由
...
## [](#creating-an-angularjs-app-and-add-states)创建 AngularJS 应用并添加状态
...
## [](#creating-your-ionic-pages)创建你的离子页面
...
[![](../Images/78db70566135adccf4e24486ccb226d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AEKpDIw6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://screenshotscdn.firefoxusercontent.com/images/f913187a-c11b-4bd2-bafe-e4d2b8738b1c.png)
...
[![](../Images/039a868c43fa13e076920dff05f42e54.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pepWP0VA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://screenshotscdn.firefoxusercontent.com/images/6b7e739f-e24e-4342-b3bb-bb48430a256d.png)

您可以使用链接在主页和“关于”页面之间导航

## [](#adding-a-target-cordova-platform)添加一个目标 Cordova 平台
...
## [](#running-your-app-in-real-devices)在真实设备中运行您的应用
