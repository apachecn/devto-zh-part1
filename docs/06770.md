...
## [](#creating-a-simple-markdown-book)创建简单的减价书
...
### [](#adding-a-cover-image)添加封面图片

要添加图像作为图书封面，您只需确保元数据中指定的路径指向该图像。

### [](#applying-metadata-to-book)将元数据应用到图书
