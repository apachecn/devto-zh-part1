...
> 原文:[https://dev.to/fdocr/learning-rails-in-2017](https://dev.to/fdocr/learning-rails-in-2017)
...
## [](#two-steps-forward-never-step-back)向前两步，绝不后退一步
