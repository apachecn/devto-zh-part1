...
> 原文:[https://dev.to/subbramanil/android-data-binding](https://dev.to/subbramanil/android-data-binding)

# [](#android-data-binding)安卓数据绑定
...
## [](#data-binding-library-process)数据绑定库流程
...
可以在这里找到截图:
[![App Screenshot](../Images/42ecdeb0747b485bd535ae2625518e09.png "Weather App Screenshot")](https://res.cloudinary.com/practicaldev/image/fetch/s--vlMiPTg2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3-us-west-2.amazonaws.com/my-blogresources/weather_app_screenshot.png)
