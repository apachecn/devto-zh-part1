...
> 原文:[https://dev . to/adamkdean/discovering-service-discovery-services-10cd](https://dev.to/adamkdean/discovering-service-discovery-services-10cd)

服务发现的问题在于，为了使用它来发现服务，服务必须首先发现服务发现服务。

Docker 动态地为容器分配 IP 地址，所以你不能保证知道一个服务的确切位置。你也不想将 docker 套接字传递给容器，因为那是一件不好的事情。

[![1](../Images/3717a75ec098a619b8ba455f7968d869.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CAbDObUU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/z0XLS6Q.png)
...
[![2](../Images/619ede46f6d36ff0c3cf443c6adc415e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WuebPqEx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/HIjUVQw.png)
...
## [](#a-more-permanent-network-interface)一个更永久的网络接口
