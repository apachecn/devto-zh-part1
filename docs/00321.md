...
[![](../Images/ab7f3ded75cbd4cedb0bca28b92d9d14.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--W2km4y49--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/460/1%2AP4nLyOPjf0MmVt-YEjKxyw.png)

### [](#why-reactive-programming)为什么要无功编程？
...
### [](#what-does-reactive-programming-really-means)反应式编程到底是什么意思？
...
### [](#how-does-reactive-programming-works)反应式编程是如何工作的？
...
### [](#observables-in-reactive-programming)反应式编程中的可观测量
...
### [](#observers-in-reactive-programming)反应式编程中的观察者
...
### [](#subjects-in-reactive-programming)科目无功编程
...
### [](#continue-reading-this-article-at-auth0com)在 Auth0.com[继续阅读本文](https://auth0.com/blog/reactive-programming-in-python/)
