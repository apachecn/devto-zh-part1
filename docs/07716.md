...
[![Docker](../Images/b6227cbda1ac37032ef49ea7cc00e5d9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nzzqowlu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nrempel.com/docker.png)
...
## [](#write-your-application-code)编写你的应用程序代码
...
## [](#pull-it-all-together-with-a-bash-script)使用 bash 脚本将所有内容整合在一起
