...
> 原文:[https://dev . to/huytd/rust-FFI-sending-strings-to-the-outside-world-50l](https://dev.to/huytd/rust-ffi-sending-strings-to-the-outside-world-50l)
...
### [](#string-must-be-returned-as-a-pointer)字符串必须作为指针返回
...
### [](#stdmemforget-it-to-keep-it)std::mem::算了留着吧
...
## [](#sending-out-a-vector-of-string)发出一个向量的字符串
