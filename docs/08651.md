...
[![The flow of the Sagefy learner experience.](../Images/66dc8a18d35752f210557924506ffcbe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--V4A-lwTS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-1.png)

## [](#popular-models-of-learning)流行的学习模式
...
[![The Ebbinghaus Forgetting Curve, r = e^(-t/s)](../Images/3831393217395a049e20927b4e41029f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--c55h_D7S--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-2.png)
...
[![The Learning Curve, a = 1-e^(-t/s)](../Images/5d75d042cb5a45058a41819d04867a7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nGlCGC3Z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-3.png)

`a`在哪里学习。一些作者提出了另一种学习模型，一种 sigmoid 函数:

[![Alternative learning curve, a = 1/(1+e^(-(t-u)/s)))](../Images/a0fcc366e9718a594d64b98df82c4b35.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mn92OA22--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-4.png)
...
| [![Bayes’ Theorem, p(A | B) = p(A) \* p(B | A) / p(B)](../Images/7b0c9e358e78c6c56bdfd4b4d3bf40d8.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--LlyKRmOj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/math-5.png) |
...
| [![A Bayes normalizer. p(B) = p(A) \* p(B | A) + p(~A) \* p(B | ~A)](../Images/78837ccc4d0098f9d2fa5665316e8be6.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--hndtTWMT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/math-6.png) |
...
[![Probability of a correct answer: p(C) = p(L) * p(~S) + p(~L) * p(G)](../Images/04959360522cc629019409636b803e77.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Aj6BbvcJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-7.png)

综上所述，给定一个正确答案，学习者学会该技能的概率是:

[![The probability the learner has learned the skill, given a correct answer.](../Images/eea6c2f390d3079616ced39aa4de8e2d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FiWLYelo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-8.png)

给出一个错误答案:

[![The probability the learner has learned the skill, given an incorrect answer.](../Images/1365ff02019ab9d9d442841e7af4a69e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iNlj5Pe2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-9.png)

我们还必须考虑到学习者可能在卡片过程中提高了技能。所以…

[![We now include transit, as the probability the learner has learned the action during the action.](../Images/a433c9fe399cddfb1f391d5794ac8c37.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fCTz31G---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-10.png)
...
[![The simpler IRT, which only uses item difficulty.](../Images/7ea436715d969b8773def8839a07842c.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--Z21hFVcb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-11.png) [ ![The more complex IRT, which uses difficulty, discrimination, and guess.](../Images/5ecdd2236e9a2b68ad1b007c60faf3e2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--D-WOP2Mv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-12.png)
...
[![SuperMemo 2\. i(n) = i(n-1) * e](../Images/403890844ff49f39289a41a07fa24d76.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pxiVn1EI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-13.png)
...
### [](#why-sagefy-uses-bayesian-knowledge-tracing)为什么 Sagefy 使用贝叶斯知识追踪
...
### [](#adding-time-to-bayesian-knowledge-tracing)给贝叶斯知识追踪添加时间
...
## [](#how-im-working-to-learn-card-unit-and-subject-parameters)我是如何学习卡、单位和科目参数的

到目前为止，这里的一切都展示了如何估计学习者了解该单元的可能性。但是，其他的参数是什么，我们又是怎么知道的呢？这是更具挑战性的领域。

### [](#parameters-of-cards-units-and-subjects)卡片、单位、科目的参数
...
[![Error rate. sqrt( sum( (si — ri) ^ 2 ) / n )](../Images/f278fcf6a4c0b0564e5a5aa610e586d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--atdEDuN4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-14.png)
...
## [](#traversing-the-graph-of-units)遍历单位图
...
[![An example graph of units.](../Images/ec86405ed48dcf75d028edce32ef9522.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--npTPtcHU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-15.png)
...
[![Now, our graph of units after diagnosis.](../Images/1763ac2b7e7ca54c52227a62de15bade.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IqUEWJHX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-16.png)
...
## [](#contributor-ratings-and-consensusbased-decision-making)贡献者评级和基于共识的决策

[![The proposal flow.](../Images/c13b6cdbff3fda13f381001c1ebab3ab.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--63kjQlaE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://heiskr.com/images/math-17.png)

接受提议的决定有几个因素:提议者和投票者的**声誉**以及实体的**使用**。

### [](#entity-calculation)实体计算
...
### [](#some-of-the-other-opportunities-to-use-math-in-sagefy)在 Sagefy 中使用数学的其他一些机会:
