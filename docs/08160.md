...
> 原文:[https://dev.to/underdogio/python-for-javascript-developers](https://dev.to/underdogio/python-for-javascript-developers)
...
### [](#creating-a-block-in-javascript)在 JavaScript 中创建块
...
### [](#creating-a-block-in-python)在 Python 中创建块
...
### [](#numbers)[数字](https://docs.python.org/3/library/stdtypes.html#numeric-types-int-float-complex)
...
### [](#lists)[列举](https://docs.python.org/3/library/stdtypes.html#lists)
...
### [](#strings)[琴弦](https://docs.python.org/3/library/stdtypes.html#text-sequence-type-str)
...
### [](#dictionaries)[字典](https://docs.python.org/3/tutorial/datastructures.html#dictionaries)
...
### [](#none)[无](https://docs.python.org/3/library/constants.html#None)
...
### [](#classes)[类](https://docs.python.org/3/tutorial/classes.html#classes)
...
### [](#inheritance)[传承](https://docs.python.org/3/tutorial/classes.html#inheritance)
