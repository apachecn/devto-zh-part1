...
> 原文:[https://dev.to/gyandeeps/git-helpers 简化你的 git 工作流程](https://dev.to/gyandeeps/git-helpers---simplify-your-git-workflow)
...
### [](#remove-a-branch-after-work-is-done)工作完成后移除一个分支
...
### [](#update-your-branch-all-changes-commited-with-master)用主数据更新您的分支机构(所有更改已提交)
...
### [](#update-your-branch-uncommited-changes-with-master)用 master 更新您的分支(未提交的更改)
...
### [](#push-your-changes-to-remote)将您的更改推送到远程
...
### [](#pull-changes-from-origin)从原点拉动变化
...
## [](#gist-for-all-the-above-commands)为上述所有命令的要旨
