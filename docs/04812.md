...
#### [](#2-use-strong-password-validation-logic)2。使用强密码验证逻辑
...
#### [](#5-secure-your-cookies)5。保护好你的饼干！
...
#### [](#6-get-rid-of-needless-headers)6。去掉不必要的标题！
...
###### [](#renaming-the-antiforgery-token)重命名防伪令牌
...
###### [](#renaming-the-application-cookie)重命名应用程序 cookie
...
#### [](#9-display-403-forbidden-response-as-a-404)9。将 403 -禁止响应显示为 404
