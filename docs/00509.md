...
> 原文:[https://dev.to/mangelsnc/action-domain-responder-78k](https://dev.to/mangelsnc/action-domain-responder-78k)

[![](../Images/8ec8ba29ee8856b31ff70b4c168b6365.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QbQ0_iau--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A4H5qt_83vt8nACqghNtOtg.jpeg)
...
### [](#adios-mvc-bienvenido-adr)再见 MVC，欢迎来到 ADR
...
#### [](#mvc-y-frameworks-web-actuales)MVC 和当前 web 框架
...
[![](../Images/7f8d1c9234d909044bfd4e2eee39fae0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--zoMM7jSz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/690/1%2Adv9t07ROpLoLPXXHX6HVEQ.png) 

<figcaption>请求-响应流程</figcaption>

尽管如此，在所有这些范式中，驱动程序的形象几乎没有变化，其中一个最大的问题是驱动程序最终变成了一个裁缝箱，其中很大一部分逻辑是在它们中实现的，另一部分则是在模型中实现的。

#### [](#controladores-en-los-actuales-frameworks-web)当前 web 框架中的驱动程序
