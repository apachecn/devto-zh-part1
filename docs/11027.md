...
#### [](#dont-use-typescript-internal-modulesnamespaces)不使用 TypeScript 内部模块/名称空间
...
#### [](#dont-use-iife-immediatlyinvoked-function-expression)不使用 IIFE(直接调用的函数表达式)
...
#### [](#only-create-angularjs-modules-for-a-purpose)只为一个目的创建 AngularJS 模块
...
### [](#define-services-as-classes)将服务定义为类
...
#### [](#only-use-the-factory-method-when-needed)仅在需要时使用出厂方法
...
### [](#bind-directly-to-controller-properties-and-methods)直接绑定到控制器属性和方法
