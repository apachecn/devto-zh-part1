...
> 原文:[https://dev . to/chrismwendt/indexing-arbitrary-JSON-into-elastic search-28 M7](https://dev.to/chrismwendt/indexing-arbitrary-json-into-elasticsearch-28m7)
