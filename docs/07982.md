...
<figure>[![](../Images/54b6369b7f4055cc5c3e458e6ed2e2e7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PRATJ2sZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Am7m_xayCKqAOUHkHm6awyA.jpeg) 
...
### [](#why-sort-oneself%C2%A0out)为什么要整理自己？
...
<figure>[![](../Images/41d510da26cfbf5db4c0bfa8c862f035.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--JlW6lZdR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AL60EX2jZXxZFkmGdQN13Dg.jpeg) 
...
<figure>[![](../Images/0d7ff98fb58283094a3f7dd28d1a3ce5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--S3ZbPVEv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ai0fopl3fml48X4aAxpqM4A.jpeg) 
...
<figure>[![](../Images/5a8f32e8717a36463dbe06a733d3f6cb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CgJXkSZd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AhHJbfVH5qGc8-An94bgjkg.jpeg) 
...
<figure>[![](../Images/5dbcac563e6a6395ea36d06e3dbad7b0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--intURVH4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Ar0avJxNZlmM41SEdv2Q5Hw.jpeg) 
...
### [](#all-sorts-of-classifications)各种分类

既然我们都同意排序是一个概念，那么是时候分解常用的不同类型的排序算法了。

<figure>[![](../Images/22758e1f0cff52dab9de951a8069d62e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--EGhqe4QA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AgyFGnj6fz08wvonmRf3cIg.jpeg) 
...
#### [](#1-time-complexity)1。时间复杂度

对算法进行分类的最简单的方法是通过*时间复杂度*，或者在给定不同输入大小的情况下，通过运行算法所需的相对时间。

<figure>[![](../Images/4e3c62d361f478aa3a1beba75e8f2e02.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--zMbHx9nN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ANdDjcpSIq4hkz8vyDFngAA.jpeg) 
...
#### [](#2-space-complexitymemory-usage)2。空间复杂性/内存使用

不同的算法需要不同的空间量，这取决于它们的空间复杂度。在排序算法的上下文中，考虑空间复杂度的另一种方式是回答这个问题:*这个算法需要多少内存来运行？*

<figure>[![](../Images/6d960d828fa9017c7ce9d70b52611467.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--pDPfJahN--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AeX6Ts3XN9myfT1IXewgc4A.jpeg) 
...
<figure>[![](../Images/6a0fceac305884188b8b8ff7252dec1d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZmwKMxdT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AlOOXCrfZft2vu_jbfQNuvw.jpeg) 
...
#### [](#4-internal-vs%C2%A0external)4。内部与外部

因为我们的机器可以很容易地对大型数据集进行排序，所以一些应用程序必须对巨大的数据集合进行排序是很常见的。在某些情况下，这实际上可能比机器的主存储器(或 *RAM* )所能保存的数据还要多。

<figure>[![](../Images/08aebc57321d722caa8ef691fdca94fe.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--dYaD987N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ArUhxtHDRPntdHSZ7bYMBig.jpeg) 
...
#### [](#5-recursive-or-nonrecursive)5。递归或非递归

一些算法通过分而治之的方式进行排序:也就是说，将一个大型数据集分割成较小的输入，然后对所有这些较小的输入递归调用排序函数。这就是所谓的 ***递归*** 排序算法。

<figure>[![](../Images/c586161a17edb37be769793bc19a268b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--BqAuzyIP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Azlj1h6uHJ9uLlQtLbc4ZEw.jpeg) 
 ...
 *#### [](#6-comparison-sort)6。比较排序

最后，可以根据*如何对元素进行排序来对排序算法进行分类。*

<figure>[![](../Images/374c4d914d411c114ecf35320c191b07.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--11LQhR-0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A0WiaRJ7mDfSP1h6lte6y3A.jpeg) 
...
### [](#sorting-sorting-everywhere-you%C2%A0look)整理，整理，到处找！

好了，我们已经完成了分类列表。希望到现在为止，你可以看到排序算法在计算机科学中是一件大事。人们已经花费了职业生涯的很大一部分时间来研究和编写排序算法！这是有原因的。

<figure>[![](../Images/32a0f8420c6edee38d04914b2d4f1faa.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--jkcnKOLb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2ADwXB8nBkKHe-kvocaHSKZw.jpeg) 
...
<figure>[![](../Images/83205596225fe91b02ee6e350374894a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--WkUkxhQu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AOWZF2CMe2KV1grxNwcdZ9Q.jpeg) 
