...
> 原文:[https://dev . to/blakedeboer/beginners-guide-to-interactive-rebase-10b](https://dev.to/blakedeboer/beginners-guide-to-interactive-rebasing-1ob)
...
[![original git log](../Images/8eaeae00f14aebb30289fad05010c8da.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SD7VCVpr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/988x2cnwvsj5rm7jcgvn.png)
...
### [](#what-commits-do-we-want-to-modify)我们要修改哪些提交？
...
### [](#start-interactive-rebasing)开始交互式重置基础
...
[![Vim window with list of unchanged commits](../Images/b7abffafffb854abe38f67ded4784a1e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mx7trP_9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/rkaoibwx35vox2lnnib1.png)
...
[![Vim window with list of changed commits](../Images/b2215a7f0871783ea94f158560cb7ede.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9YNRyDjT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/c1aigszmnfhgueiqk889.png)

在我们的示例中，对于我们想要修改的提交，我们将命令更改为`edit`,对于我们想要删除的提交，我们将命令更改为`drop`。然后我们运行`:wq`来保存并退出 Vim 窗口。

### [](#amend-the-commit)修改提交

回到终端，我们看到这条消息:

[![Git rebase interactive initial message](../Images/a96e075b8c370e0aed4772bcd3ff7195.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jqOkaCq7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/llukgvquzhmuctes7ieh.png)

这使得我们在`4a4d705`停止是有意义的。这是我们想要修改的一系列提交中最旧的提交。我们将从这个提交开始，并通过每个提交进行工作，直到最近的提交。

提醒一下，`4a4d705`是我们意外提交的合并冲突。当我们打开编辑器时，我们看到了合并冲突:

[![tempChanger.js file contents](../Images/6a8d8ab38960bc504985a26a0d357816.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GUA6IWQT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/smawq2kyftwj6uf0wnfu.png)

所以我们修复了文件中的合并冲突，但是我们现在做什么呢？`git status`拿不准的时候:

[![Git status after changing file](../Images/d84b3e3792fd7269bb7c6459bde5c2f6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a9BuRiob--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zvdwlz7xrhmv3qwhz1qf.png)
...
[![Vim window of first commit](../Images/7cd0bfd025f8afadd7ca93b8f6332557.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MA39mZ94--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o00scj3tzt7ka7rzyguc.png)

我们可以编辑提交消息，也可以保持原样。让我们选择保持提交消息不变，我们将键入`:wq`保存并退出窗口。

我们现在已经编辑了我们的旧提交。那现在怎么办？运行`git status`:

[![Git status after amending first commit](../Images/36e966729681eb16d14741c87cca366e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6f5BPxrf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/kedl2zblk64v1yuzwwjb.png)

### [](#continue-interactive-rebase)继续交互改基

我们在提交中没有其他要更改的内容，所以让我们继续吧！

我们运行`git rebase --continue`并看到以下消息:

[![Git rebase --continue](../Images/fce26d3cc7fc379855e35fb4727346dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--nGPksD8F--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j6rnf40sv2vseg44ntg2.png)
...
### [](#after-interactive-rebase)交互后重置基础

我们的 git 日志现在看起来像这样:

[![Git log after interactive rebase](../Images/97c7ba28beb68833f5704bf7601236a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IkKMizQL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j8w5aayq4g6qivlw6duy.png)
...
### [](#side-effects-of-interactive-rebasing)交互重置基础的副作用
...
[![Git push error](../Images/11ac8f3362efc3da8107d932396c812d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a7jhb5Z---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ylp8qb1p9k3tbefjy1oe.png)
