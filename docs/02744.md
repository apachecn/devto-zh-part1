...
### [](#single-variable-declaration)单变量声明
...
### [](#variable-type-inference)变量类型推断
...
### [](#multiple-variable-assignment)多变量赋值
...
### [](#multiple-assignments-with-different-types-is-that-possible)不同类型的多重作业，可能吗？
...
### [](#declaring-nonnew-variables)声明非新变量
