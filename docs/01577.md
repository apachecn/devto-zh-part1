...
> 原文:[https://dev . to/bitrinjani/why-thes-web-services-sending-number with double-quotes-in-JSON-castable-library-can-handle-them-24 F8](https://dev.to/bitrinjani/why-are-those-web-services-sending-number-with-double-quotes-in-json--castable-library-can-handle-them-24f8)

# [](#castable-typescript-library)可转换类型脚本库

[Castable](https://github.com/bitrinjani/castable) 通过将运行时的所有属性转换为编译时指定的类型来清理外部脏数据。

# [](#why-do-you-need-this-library)为什么需要这个库？
