...
> 原文:[https://dev . to/filipodomingues/learning-nodejs-building-a-simple-express-API-part-I-project-setup](https://dev.to/filipedomingues/learning-nodejs-building-a-simple-express-api-part-i---project-setup)
...
### [](#ide-visual-studio-code)**IDE - Visual Studio 代码**
...
[![structure](../Images/a902a41b9b36cddca155436ab5a3819c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--kgWqNdXA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mltjaj5hqtfi4874fjz2.JPG) 
在这里可以看出没有什么特别之处。
一个 **docs** 目录，这样我们就可以添加任何种类的文档，一个 **src** 目录，我们将把所有的源代码和最后的**测试**目录放在那里。

* * *

# [](#lets-get-to-the-good-stuff)**让我们进入正题吧！**
