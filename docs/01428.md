...
#### [](#solving-duplicate-resource-creation-with-postput-resource%C2%A0creation)用 POST/PUT 资源创建解决重复资源创建

如果 POST 请求只做一个数据库条目和资源 id 的生成，就可以很容易地避免这个问题。流程是这样的:

<figure>[![](../Images/eb47cda69a6c5cc74c2358c387bdc7e9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--qRQmsJuT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/531/1%2An92d9ck91zpX4RplI2cFQQ.png) 
