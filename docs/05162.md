...
> 原文:[https://dev . to/PE iche/weather tab-a-new-tab-extension-for-chrome](https://dev.to/peiche/weathertab-a-new-tab-extension-for-chrome)
...
## [](#about-weathertab)关于 WeatherTab
...
## [](#getting-an-image-from-flickr)从 Flickr 获取图片
