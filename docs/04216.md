...
> 原文:[https://dev . to/melezhik/bash-scripts-testing-with-sparrow-toolkit-b84](https://dev.to/melezhik/bash-scripts-testing-with-sparrow-toolkit-b84)
...
# [](#given-a-bashshell-script)给出一个 Bash/Shell 脚本
...
# [](#create-test-sparrow-scenario)创建测试(麻雀)场景
...
# [](#reporting-test-failures)报告测试失败
...
## [](#checking-lines-sequence)检查线条顺序
