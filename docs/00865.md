...
## [](#first-approach-updating-ranking-through-a-callback)第一种方法:通过回调更新排名
...
## [](#second-approach-background-workers)第二种方法:背景工人
...
## [](#third-approach-database-triggers)第三种方法:数据库触发器
...
## [](#postgres-implementation)Postgres 实现
