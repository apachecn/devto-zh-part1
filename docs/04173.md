...
> 原文:[https://dev . to/melezhik/provision-of-docker-containers-with-sparrow do-8p 5](https://dev.to/melezhik/provision-of-docker-containers-with-sparrowdo-8p5)

# [](#introduction)简介

Sparrowdo 是一个基于 [Perl6](https://perl6.org/) 编写的配置管理工具，在这篇文章中，我将向您展示如何通过 Sparrowdo 场景配置(供应)Docker 实例。

# [](#install-sparrowdo)安装 Sparrowdo

## [](#install-perl6)安装 Perl6
...
# [](#running-docker-container)运行 Docker 容器
...
# [](#creating-sparrowdo-scenario)创建 Sparrowdo 场景
...
## [](#creating-users-files-and-directories)创建用户、文件和目录
...
# [](#installing-system-packages)安装系统包
...
# [](#executing-bash-code)执行 Bash 代码
