...
> 原文：<https://dev.to/waterlink/how-kotlin-calamity-devours-your-java-apps-like-lightning-8fd>

*原载[于](https://hackernoon.com/how-kotlin-calamity-devours-your-java-apps-like-cancer-f3ce9500a028)杂志。*

我听到你在说什么。有传言称 Android 积极采用 Kotlin 作为主要编程语言。而且[趋势](https://fossbytes.com/kotlin-surpass-java-android-programming/)也不看好。

web 开发方面的情况也好不到哪里去。Java 中最流行的 web 框架通过提供合适的 API 来支持越来越多的惯用 Kotlin。
...
### 那个新团队成员如何在几个月内将整个代码库转换成 Kotlin？
...
[![](img/b9f8c7c35de74ffbd9785167a645d8b8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2w4n57JR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2000/1%2Ak42m-mM4WV2Nw-FsGaKtuw.jpeg) 
*“科特林消耗 Java 应用的速度有多快。”(来源:[https://www . pexels . com/photo/blue-clouds-color-danger-268774/](https://www.pexels.com/photo/blue-clouds-color-danger-268774/))*
...
Kotlin 代码可以实现 Java 接口，Java 代码也可以实现 Kotlin 接口。
...
[![](img/b6bcfbdb9a8c2dd704d472520667c055.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--We1buIBV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Ai-TND_5-Gm3IbckzPMq2HQ.png) 
*编译错误，因为小考变量可以为空*
...
[![](img/3a8f03f8befb77967df210f0dd79690c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--07tbKjYG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A_2Bo4_56OChwP8BZdaDjkQ.png) 
*通过添加空值检查，我们修复了编译错误，并将测验“智能转换”为不可空值*

可以看到，`quiz.moveToNextQuestion()`是以一种“特殊”的方式突出显示的。如果您将鼠标悬停在该变量上，它会告诉您它已经被智能转换为`Quiz`类型。

因为编译器现在知道，此时`quiz`变量不能是`null`。

在具有可空类型的不同语言中，通常需要将可空值解包为不可空值。即使你做了一个空检查！
...
[![](img/628f1ff20a051e6f863228e6c01b73a3.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--gnLss1GP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Ax9ilZhAN1nZ_P0m28-VgwQ.png) 
*使用 elvis 运算符可以消除大多数空检查，从而进一步简化代码*

顺便说一下，这些例子来自我的终极教程:Kotlin 入门。这是一个电子书形式的三部分教程，总共有 260 页(将来会更多)的实践内容，你可以跟着学。

至此，如果你有兴趣学习 Kotlin，[在这里下载 PDF 格式的 Kotlin 终极教程](https://iwillteachyoukotlin.com/ultimate-tutorial-getting-started-with-kotlin-kilac)。
...
如果你认为自己已经做好了从 Java 开发人员升级到 Kotlin 开发人员的准备，请[下载终极教程:Kotlin 入门](https://iwillteachyoukotlin.com/ultimate-tutorial-getting-started-with-kotlin-kilac)。

我真诚地感谢您的阅读，并鼓励您尝试一下科特林。反正你也没什么可失去的。你只能从中受益。

如果你想让我开心，那么你可以分享给你的朋友，在社交网络，黑客新闻，Reddit 等。
