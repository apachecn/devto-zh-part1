...
> 原文:[https://dev . to/edmilsonrobson/laravel-55-testing-and-you-8hl](https://dev.to/edmilsonrobson/laravel-55-testing-and-you-8hl)
...
## [](#1-use-setup-and-teardown)1。使用 setUp()和 tearDown()
...
## [](#2-use-carbon-for-timesensitive-scenarios)2。对时间敏感的场景使用碳
...
## [](#3-be-smart-with-your-assertions)3。聪明对待你的断言
...
## [](#4-exceptions-handle-them-or-dont)4。例外:处理它们(或者不处理)
...
## [](#5-hidden-validation-errors-are-a-problem)5。隐藏的验证错误是一个问题
...
## [](#6-mocks-are-your-friends)6。嘲笑是你的朋友
