...
> 原文:[https://dev.to/samipietikainen/my-experiences-learning-rust](https://dev.to/samipietikainen/my-experiences-learning-rust)
...
## [](#type-inference-and-coercions)式推理和胁迫
...
## [](#useful-compiler-error-messages)有用的编译器错误信息
...
## [](#strict-types-and-casts)严格的类型和类型转换
