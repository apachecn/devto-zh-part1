...
> 原文:[https://dev . to/scotthannen/the-dependency-inversion-principle-for-初学者-59l6](https://dev.to/scotthannen/the-dependency-inversion-principle-for-beginners-59l6)
...
## [](#what-are-high-level-modules-and-low-level-modules)什么是高级模块，什么是低级模块？
...
## [](#how-do-we-apply-dependency-inversion)我们如何应用依赖倒置？
