...
> 原文:[https://dev.to/ladvien/hmis-r-sql-work-challenge-two-20fi](https://dev.to/ladvien/hmis-r-sql-work-challenge-two-20fi)

# [](#providing-chronically-homeless-list)提供长期无家可归者名单
