...
> 原文:[https://dev . to/dance 2 die/removing-duplicates-from-a-a-array-using-c-1fl](https://dev.to/dance2die/removing-duplicates-from-an-array-using-c-1fl)
...
#### [](#case-1-removing-duplicates-from-an-ordered-array)**案例 1—**从一个*有序*数组中删除重复项。
...
#### [](#case-21-removing-duplicates-from-an-unordered-array-using-a-set)**案例 2.1**–使用集合从一个*无序*数组中移除重复项。
...
#### [](#case-22-removing-duplicates-from-an-unordered-array-by-sorting-it-and-check-for-next-element-for-duplicates)**案例 2.2**–通过排序从一个*无序*数组中移除重复项，并检查下一个元素是否有重复项。
