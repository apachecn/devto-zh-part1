...
> 原文:[https://dev . to/terrehbyte/visual-studio-code-is-my-favorite-text-editor-5e0d](https://dev.to/terrehbyte/visual-studio-code-is-my-favorite-text-editor-5e0d)
...
### [](#workspacespecific-settings)工作区专用设置
...
[![workspace-specific](../Images/7579d8ed3f0d997abe2b800101ad5e30.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zHwA_1qF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mjxe0iljn7jye9eg1pfo.PNG)
...
### [](#relatively-fast-startup-time)启动时间相对较快

[![start-up time](../Images/4ede03a657bc2dc82de3badebab15170.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--icry3hFm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/776plczjjhl5236v6bvp.gif)
...
### [](#high-versatility-through-extensions-and-settings)通过扩展和设置实现高通用性

[![Screenshot of VS Code's extension panel](../Images/aaeebff24a650784152655ec1c726145.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1uOwh8Ao--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ptnwtp3tu8218nj6vboq.PNG)
...
### [](#a-better-windowing-system)更好的窗口系统
...
### [](#path-normalizing-for-different-file-systems)针对不同文件系统的路径规范化
