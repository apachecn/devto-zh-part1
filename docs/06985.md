...
> 原文:[https://dev.to/booyaa/adding-search-to-your-cobalt-site-第一部分-30pl](https://dev.to/booyaa/adding-search-to-your-cobalt-site---part-one-30pl)
...
## [](#my-cobalt-source-directory-structure)我的钴源目录结构
...
## [](#an-artisanal-lunr-document-collection)手工制作的 lunr 文档集合
...
## [](#but-is-it-webscale)但它是 webscale 吗？
