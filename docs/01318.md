...
> 原文:[https://dev . to/HANA chin/how-to-define-the-method-for-the-DSL-configuration-file-nag](https://dev.to/hanachin/how-to-define-the-method-for-the-dsl-configuration-file-nag)
...
## [](#why-should-we-avoid-to-define-the-method-at-top-level)为什么要避免在顶层定义方法？
...
## [](#the-benefit-of-the-refinements)精益求精的好处
