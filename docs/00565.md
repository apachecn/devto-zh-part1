...
> 原文:[https://dev.to/ardennl/about-promises-and-async-await-5 EBM](https://dev.to/ardennl/about-promises-and-async--await-5ebm)
...
## [](#-raw-promise-endraw-introduction)`Promise` -简介

`Promise`是一个本地对象，作为一个未知值的临时值。承诺允许您创建处理异步操作最终成功或失败的处理程序

### [](#native-promises)土著的承诺
...
#### [](#-raw-getusermedia-endraw-)`getUserMedia`
...
## [](#building-your-own-promises)建立自己的承诺
...
## [](#-raw-promiseall-endraw-multiple-promises)`Promise.all` -多重承诺
...
## [](#promises-vs-callbacks)承诺 vs 回调
...
### [](#awaiting-multiple-promises)等待多个承诺
