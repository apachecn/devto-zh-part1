...
> 原文:[https://dev . to/farisj/the-proper-way-to-test-custom-controllers-in-rspec-3968](https://dev.to/farisj/the-proper-way-to-test-custom-controllers-in-rspec-3968)

# [](#the-proper-way-to-test-custom-controllers-in-rails)在 Rails 中测试定制控制器的正确方法
