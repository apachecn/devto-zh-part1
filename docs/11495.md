...
> 原文:[https://dev.to/ladvien/kossel-mini-calibration-38i3](https://dev.to/ladvien/kossel-mini-calibration-38i3)
...
[![](../Images/22d0a87ec5bc18b3f1cd846a97cdba3f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JMUscZ1N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/G-Code.png)
...
[![](../Images/022be79bcc66eaedc992c16fb2c58e7c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gSnAlsTf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Link_Info.jpg)
...
[![](../Images/76fc7b4081929d59f16c900437557fbe.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Go0Yo-68--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0738.jpg)

1.  **粉丝**

Kossel Mini 有一个 40×40 毫米的小风扇，直接吹向热端，*一直*。

[![](../Images/ead227153aa11b72c56b114b1c4479d0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a3xblL10--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0679.png)
...
[![](../Images/7408868018b012346a16200abc3c9f99.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--PHEYqHaH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Ramps_14_D9.png) **然后我把这些风扇都接到 D9 上。**
...
[![](../Images/c1fa5049b550b8fb30afbedb01442c36.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--_WdMlrTt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Auto_Fan_Config2.png) 我最终做的是找到让我的 D9 频道一直满功率运行的选项。
...
[![](../Images/3def878cc584f66e2b40e194763faecb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iKTzbIf8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Calibration_Variables_v01.png)
...
[![](../Images/73b0274c95f69f6971fd1eb5d5ecc699.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3_MfYKBe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0781.jpg) 我用 Eagle Cad 做了一个直径 170 毫米的圆，并标注了精确的圆心(如下)。然后，我把它按比例印在一张纸上。我把这张纸剪下来，放在我的构建板上，然后用胶带粘好。

[![](../Images/2d5ad41c68a06c1299bbc1cab472c64b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---gO5ZI7O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0782.jpg)

*   [170mm 直径圆模板](https://ladvien.com/images/Kossel_Calibration.pdf)
...
[![](../Images/47611f79f10e95a5e1eff8086dbe54a0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VoXlh-UZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0783.jpg) 好的，测量从一节车厢的顶部到终点挡板上的塑料底部，基本上就是终点挡板按钮被按下时的位置。此外，终点并不重要，因为我们的目标是让他们都一样。

好的，在这一部分你需要一把锯子来给你一个方形的切口。我用了一个测速角尺和一个圆锯。还有，更小的板子，像一块装饰板。按照你测量的长度切一块木头。

[![](../Images/3f33e933098808b6039b9acb57773757.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--PpESO54z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0786.jpg) 把那块木头拿到印刷厂去。降低热端到 Z0。然后，使用目标模板重新居中。现在，把切好的木头放在每个终点挡板和各自车厢的顶部之间，小心不要让马达空转。如果终点挡板太高，降低它，直到它与木头齐平。如果木头放不进去，抬起末端挡板，确保它平齐。通过这种方式，您可以确保每个臂与印刷床的距离相等，同时保持热端居中。
...
[![](../Images/3cc1a6961be733ac530b05537937141e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WhPh3a25--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Concave.png)

[![](../Images/82b1ffba1ea86cb355346cc79776fb8a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--VznCCxrg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Convex.png) 根据马林固件，此图中的蓝线是打印表面。
...
[![](../Images/184b19a7e28a70f6b13a87f387f514a7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C9LvaPGx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Kossel_Flatness.png)
...
[![](../Images/bad51cb7e1989d102ae676020ad124f0.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--KFeKkmDO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Auto-probe_reset2.png) 把这个从 Slic3r 中去掉，
...
1.  放置[纸模板](https://ladvien.com/images/Kossel_Calibration.pdf)并使其居中。
2.  发送命令: **G X0 Y0 Z10**
...
[![](../Images/4e9b68c1dc3308dadc61b0d5dca0cded.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Wpnc2h-o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Excel_auto_probe1.png)

1.  **将积分粘贴到 Excel 中。**它会抱怨格式化，按 OK。

[![](../Images/667481adb281cae534dffde5aad00091.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--R-fcO9RW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Excel_auto_probe2.png)

**3。如果您点击格式化选项并选择“文本导入向导”**然后，您可以选择“空格分隔”粘贴选项。基本上，这将导致 Excel 翻译

[![](../Images/c419715d1703b06a93b6e397ee25d642.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JOI0J4if--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Excel_auto_probe3.png)

**4。一旦你在 Excel 中有了正确的数据，让我们制作一个图表。选择您的数据集，然后转到图形类型“表面”**

[![](../Images/e1c64daba202b2ac314dad8b7bee0056.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--GaA2nC70--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Excel_auto_probe4.png)

**5。这是图表。**

[![](../Images/c706a4715cbef5aa6e9d1afa2a265360.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OXQNbk9D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/Excel_auto_probe5.png)

1.  你可以用这些数据做几件事，但前提是你要有一个定位点。也就是说，图形上的哪个区域代表印刷表面上的区域。为了找到自动探测数据的方向，我在其中一个塔附近的打印表面上构建了一个块，如下所示:

[![](../Images/61c9e607c347ef45c01988f269c36e51.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mQhsAB0o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/IMG_0792.jpg)
