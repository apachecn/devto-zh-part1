...
> 原文:[https://dev . to/thiht/learn-to-use-screen-a-terminal-multiplexer-GL](https://dev.to/thiht/learn-to-use-screen-a-terminal-multiplexer-gl)
...
### [](#automatically-list-the-screen-sessions)自动列出屏幕会话
...
[![screen session with a status bar](../Images/9c079ff76e2088ba364dbd511913911f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mutqokeO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/ZYEdvln.png)
...
### [](#cheatsheet-of-the-main-commands)主命令清单
