...
[![react banner](../Images/5e1ea05dd0e1dd4169bfa3d0e8a4adde.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YPqzSSWz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/8i1bx8y9p3t9x223bjhf.png)

## [](#context-of-react)上下文的反应
...
# [](#1-create-a-indexhtml-with-react-reactdom-and-babel-references)1。用 react，react-dom 和 babel 参考创建一个 index.html。
...
# [](#2-add-textbabel-script-tag)2。添加文本/巴别塔脚本标签
...
# [](#3-write-any-react-example-on-the-web-in-your-new-textbabel-script-tag)3。在你的新文本/巴别塔脚本标签中写下任何一个 react 例子
