...
> 原文:[https://dev.to/sdball/deliberate-git-nlf](https://dev.to/sdball/deliberate-git-nlf)
...
## [](#alternatives-considered)考虑备选方案
...
# [](#git-commits-are-always-in-sync-with-the-code)Git 提交总是与代码同步
...
# [](#using-git-rebase-i)使用 git rebase -i
