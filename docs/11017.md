...
> 原文:[https://dev.to/nflamel/my-emacs-setup-74i](https://dev.to/nflamel/my-emacs-setup-74i)
...
## [](#connect-to-emacs-daemon-from-the-terminal)从终端连接到 emacs 守护进程
...
## [](#connect-to-emacs-daemon-from-the-desktop-environment)从桌面环境连接到 emacs 守护进程
...
### [](#edit-rabl-files-with-ruby)用 ruby 编辑 rabl 文件:
...
### [](#open-the-project-root-when-selecting-a-project-with-projectile)用弹丸选择项目时打开项目根
...
### [](#have-a-separate-file-for-the-emacs-customizations)有一个单独的 emacs 定制文件。
