...
> 原文:[https://dev . to/dced dia/where-and-when-to-fetch-data-with-redux-GM1](https://dev.to/dceddia/where-and-when-to-fetch-data-with-redux-gm1)

> 如果一个组件需要数据来进行渲染，并且您想用 Redux 获取数据并保存在 Redux 存储中，那么什么时候是进行 API 调用的最佳时机呢？

TL；dr-**开始`componentDidMount`生命周期挂钩**中的行动

## [](#how-this-works-in-code)这是如何工作的，用代码表示
...
## [](#but-it-will-render-twice)但是会渲染两次！
...
## [](#but-the-component-shouldnt-have-to-fetch)但是组件不该取！
...
## [](#many-ways-to-skin-this-cat)剥这只猫皮的多种方法
