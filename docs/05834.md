...
> 原文:[https://dev . to/monk nomo/changing-an-controlled-input-to-controlled-error-in-react](https://dev.to/monknomo/changing-an-uncontrolled-input-to-controlled-error-in-react)
...
## [](#i-was-switching-a-form-value-from-raw-endraw-to-raw-null-endraw-)我正在将一个表单值从`''`切换到`null`
