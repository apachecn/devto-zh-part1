...
### [](#create-a-plone-addon-packages)创建 Plone 插件包
...
[![Create addon with plonecli](../Images/cc26e2f99207f483c4ca11cf6d3dc3c6.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KSxcYcJ4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://mrtango.planetcrazy.de/images/plonecli_create_addon_optimized.gif)

用 plonecli 创建插件

## [](#add-a-contenttype-to-your-plone-addon)添加一个内容类型到你的 Plone 插件
...
[![Add a content_type to your package](../Images/795136943b9fc2565088473c31ad362c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4rh_nRVk--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://mrtango.planetcrazy.de/images/plonecli_add_content_type_optimized.gif)
...
[![Add a vocabulary to your package](../Images/77e664dc892d390882073665c5bbfde3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--uGVcDFhW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://mrtango.planetcrazy.de/images/plonecli_add_vocabulary_optimized.gif)

向您的包中添加一个 vacobulary

#### [](#build-a-plone-addon)构建 Plone 插件
...
[![Build your package with plonecli](../Images/1aedd0ccf0dba819ef8769adac9421d3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--z14hDZxh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://mrtango.planetcrazy.de/images/plonecli_build_optimized.gif)

用 plonecli 构建您的包

#### [](#serve-the-development-plone-site-of-the-package)服务包的开发 Plone 站点
...
### [](#combine-chain-commands)组合(链式)命令
...
[![Serve your package with plonecli](../Images/9411e55240ab273f45283a6729e09e67.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mTfH_1yw--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://mrtango.planetcrazy.de/images/plonecli_serve_optimized.gif)
