...
> 原文:[https://dev . to/_ arpy/loading-components-asynchronous-in-react-app-with-an-hoc-6nh](https://dev.to/_arpy/loading-components-asynchronously-in-react-app-with-an-hoc-6nh)

[![](../Images/ed15612a3bf5a7802e023e70f547d7cb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L_L-eYFt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/mrmodbtgw57x3ar8t2nq.jpg)
...
[![](../Images/692487e8df415428d21e711232072872.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--VL857Pwe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a7a0ctfk3rc40uydpfcy.jpg)

因此，我们要做的是，我们将定义一个 HOC，并将其应用于那些我们希望异步加载的组件。

# [](#the-async-component-hoc)异步组件 HOC
...
# [](#using-asynccomponent)使用 asyncComponent
...
# [](#routing-with-async-components)带异步组件的路由
