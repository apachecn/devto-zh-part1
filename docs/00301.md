...
> 原文:[https://dev . to/michaeljota/electron-with type script-using-ts-node-8oi](https://dev.to/michaeljota/electron-with-typescript-using-ts-node-8oi)
...
## [](#creating-tsconfigjson)创建 tsconfig.json
...
## [](#running-electron)运行电子

现在是时候尝试了，如果您遵循集成指南，请运行`npm start`,如果您没有相关的脚本，请运行`electron .`。

你应该看到这样的东西:
[![electron-error](../Images/4c373f56b95e65071e522f4de730c35f.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--oXo--Dpn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z1g6mt642m943tunr9my.png)

这很好。因为我们正在使用`__dirname`作为我们的文件夹根，现在电子找不到应用程序源。

## [](#updating-raw-indexts-endraw-)更新`index.ts`
...
## [](#running-electron-again)(再次运行的电子)
