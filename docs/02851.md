...
## [](#setting-up-docker-and-docker-compose)设置 Docker 并编写 Docker
...
## [](#architecture-of-a-container)容器的架构
...
## [](#dockerizing-a-node-app)停靠节点 app

对于这个简单的设置，我们将在一个基于节点的 web 应用程序上设置 docker，以展示 docker 的酷本质。项目的代码可以在参考库中找到。

### [](#step-1-setting-up-the-base-app)步骤 1 -设置基础应用
...
### [](#step-2-setting-up-the-docker-image)步骤 2 -设置 docker 图像
...
### [](#step-3-build-the-image-and-deploy)步骤 3 -构建映像并部署
