...
> 原文:[https://dev . to/pen cillr/Jenkins-pipelines-and-they-dirty-secrets-2](https://dev.to/pencillr/jenkins-pipelines-and-their-dirty-secrets-2)

# [](#solving-parameterizing-problems-with-pipelines)用管道解决参数化问题:

在下一节中，我将介绍几个使用管道的 Jenkins 工作流处理示例。咱们不要浪费时间和 ***见码*** ！

* * *

## [](#1-run-parameterized-jobs)1。运行参数化作业

创建管道时，您可以将其设置为参数化:
[![alt text](../Images/144e7bfdb43670bc9c04cce8270e6d9a.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--XvSvfoij--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ryjwgx28gqbbwkxhad7g.png) 
...
## [](#2-initialize-parameterized-job)2。初始化参数化作业:
...
## [](#3-inheriting-job-variables-from-previous-jobs)3。从以前的作业继承作业变量:
...
## [](#4-pipeline-asking-for-input-during-build)4。管道在构建过程中请求输入
