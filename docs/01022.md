...
> 原文:[https://dev . to/restore dev/four-tips-for-a-more-secure-website-52ip](https://dev.to/restoreddev/four-tips-for-a-more-secure-website-52ip)
...
## [](#1-parameters-are-good-for-your-health)1。参数对你的健康有益
...
## [](#2-escaping-isnt-as-hard-as-it-sounds)2。逃跑并不像听起来那么难
...
## [](#3-dont-forget-to-sanitize-when-cooking-text)3。烹饪文本时不要忘记消毒
...
## [](#4-surf-to-safer-waters-with-csrf-tokens)4。使用 CSRF 代币在更安全的水域冲浪
