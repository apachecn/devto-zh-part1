...
> 原文:[https://dev . to/gaijinity/hardening-craft-CMS-permissions-4 mgj](https://dev.to/gaijinity/hardening-craft-cms-permissions-4mgj)

发布: <time>2016.12.05</time> /更新: <time>2019.06.03</time>

# [](#hardening-craft-cms-permissions)硬化飞船 CMS 权限

### 从安全的角度来看，构建 CMS 的一个重要部分是根据权限获取文件

安德鲁·韦尔奇

[![Security](../Images/eb165ec6353e1579d7644e693b26bf25.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zZRrFEl1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_1200x675_crop_center-center_82_line/security.jpg)
...
## [](#unix-file-per%C2%ADmis%C2%ADsions-primer)Unix 文件每个 mission Primer

这是显示 Unix 文件权限的信息图:

[![Unix Permissions](../Images/9cfe67e2f867a2c6deffb60809b67eaf.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jvxhoIIb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://nystudio107-ems2qegf7x6qiqq.netdna-ssl.com/img/blog/_576x191_crop_center-center_100_line/unix_permissions.png)
...
## [](#craft-cms-2x-permissions)Craft CMS 2.x 权限
...
## [](#craft-cms-3x-permissions)Craft CMS 3.x 权限
...
## [](#shell-scripts-to-make-it-simple)外壳脚本化繁为简！
...
## [](#per%C2%ADmis%C2%ADsions-and-git)根据任务和 Git
