...
### [](#phps-collection-type-hierarchy)PHP 的集合类型层次结构

让我们从 PHP 7.1 开始，看看 PHP 集合的类型层次结构。这些是我认为最重要的核心类型:

[![PHP iterable types](../Images/e257e0c9a6dc480689ddc55563eb6d4c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yAZpSIY---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/a7we5d75c5my60r9tsif.png)
...
### [](#iteratoraggregate-generator-lt3)迭代器聚合器+生成器= < 3
