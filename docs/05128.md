...
> 原文:[https://dev . to/mateuszniestroj/every-problem-has-other-solution](https://dev.to/mateuszniestroj/every-problem-has-another-solution)

# [](#many-ways-of-solving-problems)许多解决问题的方法
...
## [](#1-first-problem-double-char)1)第一个问题:双字符
...
## [](#2-second-problem-counting-up)2)第二个问题:向上计数
...
## [](#3-third-problem-name-swapping)3)第三个问题:名字互换
