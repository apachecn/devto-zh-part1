...
> 原文:[https://dev.to/joshghent/bulletproof-node-安全-最佳-实践- 98b](https://dev.to/joshghent/bulletproof-node--security-best-practises--98b)

<figure>[![](../Images/e099613b6d4ace28ff92f7b52aa13807.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eOsodGLB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/691/1%2AwRHUc9Adas906L5Ny5bq6w.jpeg) 
...
#### [](#use-synk-to-monitor-security-vulnerabilities)**利用** [**Synk**](https://snyk.io/) **监控安全漏洞**
 ...
 *#### [](#add-helmet-for-all-requests-run-through-express)**添加** [**头盔**](https://helmetjs.github.io/) **为所有请求运行直通快车**
...
#### [](#keep-nodejs-and-all-dependencies-up-to-date)**保持节点及其所有依赖关系最新**
...
#### [](#monitor-for-multiple-invalid-requests-and-any-other-potentially-malicious-traffic)**监控多个无效请求，以及任何其他潜在的恶意流量**
...
<figure>[![](../Images/a1457839bc8f631d8ffd4c1927eaee9e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nLx05MPx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://cdn-images-1.medium.com/max/501/1%2ATOb464uqspF5k7dG81YyNg.gif) 
