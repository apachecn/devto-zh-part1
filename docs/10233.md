...
[![TDD process image](../Images/2e7d4746f1748aed8659c9ba6c848f43.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iVpJa1jY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/PK1kbSS.png)
...
#### [](#benefits-of-unit-tests)单元测试的好处

测试您的应用程序需要时间，并且手动测试过程效率非常低。使用单元测试有很多好处:回归测试、重构和跨浏览器测试。Â

## [](#tdd-process)TDD 流程

[![TDD process image](../Images/cdb494a150db09192daf2a66fd9112a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bEIzTTqH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://samueleresca.net/wp-content/uploads/2016/02/Test-First-300x232.jpg)
