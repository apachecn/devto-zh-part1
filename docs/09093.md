...
> 原文:[https://dev . to/chinchang/web-maker-preventing-infinite-loops](https://dev.to/chinchang/web-maker-preventing-infinite-loops)
...
### [](#injecting-the-loop-protection-checks)注入回路保护检查
