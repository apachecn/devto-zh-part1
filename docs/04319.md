...
> 原文:[https://dev . to/tylermcginnis/compilating-vs-poly fills-with-babel-JavaScript-bho](https://dev.to/tylermcginnis/compiling-vs-polyfills-with-babel-javascript-bho)
...
#### [](#features-that-need-to-be-compiled)需要编译的特性
...
#### [](#features-that-need-to-be-polyfilled)需要多点填充的特征
