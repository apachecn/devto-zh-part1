...
> 原文:[https://dev . to/monk nomo/turn-your-spaghetti-code-into-functions-part-2](https://dev.to/monknomo/turn-your-spaghetti-code-into-functions-part-2)
...
[![](../Images/ab46f4a873a0c8bb49586065eef1078f.png "An elephant driving a Smart Car")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YNLbFAlJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://i.imgur.com/xfmb1Bs.png)
...
## [](#and-now-with-predicates)和现在，用谓语

在 Java 8 之前，我并不了解函数式编程的世界。我记得上一次听说谓语是在学校，当时我忽略了一节语法课。事实证明，在编程时，谓词确实可以改进您的代码。

[![A grammar school](../Images/cced99a1ce1a4874c18a52f02d669956.png "A grammar school")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8U5l0UVJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/jgs74pKm.jpg)
...
## [](#predicate-chaining)谓词链接

让我们修正前一个例子中“坏”列表上的一些东西。

我们可以去掉`&&`,方法是使用多一点的函数接口，并重构谓词，使它们都采用相同类型的对象，在本例中是一个`WidgetTransfer`对象。目标是让我们的谓词像乐高积木一样——互锁和可互换。

[![lego elephant](../Images/26b44e3b24904fafbcc3876ab075d144.png "lego elephant")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--O6uLK00---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/OfJVe6hm.jpg)
...
[![elephant driving a convertible citroen](../Images/6ff0c6e199e1358efe3f9fdcb2f95ef2.png "elephant driving a convertible citroen")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2PCz-rg2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/N5Xf1IB.png)
