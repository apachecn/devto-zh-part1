# 为什么在 JavaScript 中使用静态类型？(第四部分)

> 原文：<https://dev.to/iampeekay/why-use-static-types-in-javascript-part-4>

## **JavaScript 中到底要不要使用静态类型？**
...
能够在动态和静态类型之间切换是 JavaScript 社区的一个强大工具——令人兴奋:)
