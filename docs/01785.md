...
[![Alt text of image](../Images/328fa7d3b3419231bd63a1456db3d725.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--G69fM25a--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vqnpv5ol2ycl5jcvxf1z.png)

## [](#block-chains)区块链

### [](#initializing-a-chain)初始化一条链

首先，区块链中的第一块被称为创世块。这个块只是链开始的原始块。在我的实现中，当一个区块链被创建时，genesis 块被自动创建。

### [](#adding-a-block)添加一个块
...
[![Alt text of image](../Images/abbf0c803f0dbce8356f145436de6d51.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--VXUK2I2G--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/cizhqepz2ej0jaoeyjic.png)

## [](#testing-the-block-chain-with-anna-coin)用安娜币测试区块链

下面是创建一个名为 annaCoin 的区块链对象并向其添加块的代码。我通过在任何篡改之前以及在我试图篡改一个块之后检查区块链的有效性来证明 annaCoin 的安全性。

[![Alt text of image](../Images/810fd8af452988027f6c9f91855aae49.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--HvKIHkO_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/d1ejhb9c0tzvyjc90o03.png) 
这个函数的输出是这样的:
[![Alt text of image](../Images/f614f87aa0c43885c7a2a28262144b74.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nOJkSaHM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/vaht1povla9y3ink4x2g.png)
