...
> 原文:[https://dev . to/danielw/from-network-response-to-代数数据类型-10co](https://dev.to/danielw/from-network-response-to-algebraic-data-type-10co)
...
## [](#error-handling-for-network-requests)网络请求的错误处理
...
T3![503 status page of the university of oregon. The title says 'Service is unavailable'. The text below it says 'We are working to clear the ducks and get the service available again. Click the 'Service Status' button for more information. Below it there is a picture of a lot of cartoon rubber ducks sitting on and around a server.](../Images/b94ab8e4615a4dbf2eb55d7218587a3d.png)T5】
...
## [](#how-to-integrate-with-the-network-layer)如何与网络层集成
