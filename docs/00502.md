...
> 原文:[https://dev . to/johndashkelly/a-remote-data-request-API-in-elm-3e5e](https://dev.to/johndashkelly/a-remote-data-request-api-in-elm-3e5e)
...
#### [](#elmpostgrest-client-%E2%87%84-postgrest-server-%E2%87%84-postgresql-db)elm-postgrest(客户端)⇄ PostgREST(服务器)⇄ PostgreSQL(数据库)
...
### [](#did-we-meet-our-design-goals)我们达到设计目标了吗？
...
### [](#what-has-this-design-bought-us)这个设计给我们买了什么？
