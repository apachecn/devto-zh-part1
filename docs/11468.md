...
> 原文:[https://dev.to/maxim/linux-permissions-cheatsheet-4o97](https://dev.to/maxim/linux-permissions-cheatsheet-4o97)
...
### [](#sticky-on-dirs)粘在 dirs 上

*   仅在组/每个人可写时使用
*   目录中的文件只能由其所有者编辑/删除(想想`/tmp`)
*   仅当目标在此目录中时，符号链接才有效

### [](#setgid-on-dirs)目录上的 setgid

*   任何人在这个目录中创建的所有文件/子目录都继承它的组
*   所有子目录在创建时都会继承该位

### [](#setuid-on-dirs)目录上的 setuid
