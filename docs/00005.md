...
> 原文:[https://dev.to/danielkun/using-elm-on-a-raspberry-pi-42pi](https://dev.to/danielkun/using-elm-on-a-raspberry-pi-42pi)
...
# [](#the-shortcut-use-a-prebuilt-docker-image)捷径:使用预建的 docker 图像
