...
### [](#embrace-user-experience)拥抱用户体验
...
### [](#your-code-is-not-yours)你的代码不是你的
...
### [](#dont-style-ids-or-elements)不要样式# ids 或元素
...
### [](#lower-your-specificity)降低你的特异性
...
### [](#template-is-not-backend)模板不是后端

业务逻辑和复杂的编码应该在后端。如果你使用的模板引擎提供了 ifs、循环、变量设置等编程方式，千万不要用它们在模板代码中创建算法。

它总是很奇怪，难以理解，而且非常脆弱。

### [](#git-diff-is-our-friend)git diff 是我们的朋友
