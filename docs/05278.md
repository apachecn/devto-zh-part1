...
> 原文:[https://dev . to/paultopia/the-easy-possible-way-to-throw-a-web app-online-flask-heroku-postgres-185 o](https://dev.to/paultopia/the-easiest-possible-way-to-throw-a-webapp-online-flask--heroku--postgres-185o)
...
## [](#step-1-setup-and-install-all-the-things)第一步:设置并安装所有的东西。
...
## [](#step-2-write-some-code)第二步:写一些代码
...
### [](#c-set-up-a-route-to-receive-data)C .设置接收数据的路线
...
### [](#c-set-up-a-route-for-users-to-enter-data)C .为用户输入数据设置路线
...
## [](#step-3-setup-for-heroku)第三步:heroku 的设置
...
## [](#wait-a-minute-what-about-local-dev-testing-etc)等一下，本地开发、测试等呢？？
