...
> 原文:[https://dev . to/Brandon 927/raspberry-pi-zero-w-headless-setup-on-MAC OS-3kb 7](https://dev.to/brandonb927/raspberry-pi-zero-w-headless-setup-on-macos-3kb7)
...
## [](#writing-the-image-to-the-sd-card)将图像写入 SD 卡
...
## [](#first-boot-into-the-os)第一次引导进入 OS
...
<source>
[![macOS Network Adapters](../Images/edd8e91e9b0111f877a3501a95c6af3c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--N6TWFSYM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dc1r9kxqg42ml.cloudfront.net/brandonb.ca/posts/raspberry-pi-zero-w-headless-macos/network-adapters.png)

<source>
[![macOS Network Sharing Configuration](../Images/0c1790c959f0d490e3eead34b51bb211.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--nxXVEDob--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dc1r9kxqg42ml.cloudfront.net/brandonb.ca/posts/raspberry-pi-zero-w-headless-macos/network-configuration.png)
...
## [](#ssh-into-the-raspberrypi)宋承宪进入 RaspberryPi
...
### [](#optional-things-to-do-after-setup)设置后可选要做的事情
