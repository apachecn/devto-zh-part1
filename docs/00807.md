...
> 原文:[https://dev . to/anotherdevblog/help-these-objects-have-same-shape-but-don-share-an-interface-kfl](https://dev.to/anotherdevblog/help-these-objects-have-the-same-shape-but-dont-share-an-interface-kfl)
...
### [](#get-creative-with-raw-dynamic-endraw-)用`dynamic`获得创意
...
### [](#other-dynamic-approaches)其他“动态”方法
