...
> 原文:[https://dev . to/designer 023/creating-a-chrome-extension-an-update-3p7e](https://dev.to/designer023/creating-a-chrome-extension-an-update-3p7e)
...
### [](#add-it-to-chrome)将其添加到 Chrome 中
