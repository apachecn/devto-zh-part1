...
1.  检查您的创意构建号。去**求助** - > **关于** [![About](../Images/f301f2617055b0da8d650f01a2172514.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fSpHIaKG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/java/lombok/about.png)

2.  按照你的内部版本号下载 https://plugins.jetbrains.com/plugin/6317 的 Lombok 插件。

3.  转到**文件**->-**设置** - >在左上角的搜索文本框中键入插件。 [![Plugin Settings](../Images/4837b214fde0e0c9aa9916a5ef180798.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---zAMELH4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blogs.jbisht.com/images/java/lombok/settings.png)
