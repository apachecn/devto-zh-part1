...
> 原文:[https://dev . to/twilio/how-to-receive-and-response-to-text-messages-in-ruby-with-hanami-and-twilio-7il](https://dev.to/twilio/how-to-receive-and-respond-to-text-messages-in-ruby-with-hanami-and-twilio-7il)
...
## [](#creating-a-hanami-application)创建花见应用程序
...
[![A screenshot of the results for running the application tests. 5 runs, 5 assertions, 0 failures, 1 error, 1 skip.](../Images/2512bfb98ce687312d8c500e05fc3a88.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--mXWwqx49--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://twilioinc.wpengine.com/wp-content/uploads/2017/11/VcXK-szZIm-TbDe3eNf9qMs0TYJwhM-7fZRNnOHDVf2Cjcgb90yvdYVa54aq7Aoy2KhD21fR3W2LVlsoIm1wiTxT3ViLIo3auMLW2KPY0F6uP5Fd6P5jE6xdkHNSEvZAY1SYyns.png)

让我们解决这个问题。

## [](#template-driven-views)模板驱动视图
...
## [](#connecting-to-twilio)连接到 Twilio
