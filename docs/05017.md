...
## [](#-raw-v1tasks-endraw-)`/v1/tasks`

我将开始用**任务集合**构建我的 API 端点。

### [](#-raw-get-v1tasks-endraw-)`[GET] /v1/tasks`

我需要做的第一件事是`GET`我的创新 TODO API 中的任务列表，我认为构建它的最佳方式是创建一个**新的隔离快速路由器实例**。

#### [](#-raw-srcv1tasksjs-endraw-)`src/v1/tasks.js`
...
### [](#delete-v1tasks)`[DELETE] /v1/tasks`
...
### [](#get-v1taskstaskid)`[GET] /v1/tasks/:taskId`
...
### [](#post-v1taskstaskid)`[POST] /v1/tasks/:taskId`
...
```
 ...
 `### [](#patch-v1taskstaskid)`[PATCH] /v1/tasks/:taskId`
...
### [](#delete-v1taskstaskid)`[DELETE] /v1/tasks/:taskId`
