...
> 原文:[https://dev . to/kellyjandrews/using-operator-mono-and-FIRA-code-in-atom](https://dev.to/kellyjandrews/using-operator-mono-and-fira-code-in-atom)
