...
## [](#different-languages-different-paradigms)不同的语言，不同的范式
...
## [](#dealing-with-objects-and-methods-in-java)在 Java 中处理对象和方法
...
## [](#dealing-with-objects-and-methods-in-javascript)在 JavaScript 中处理对象和方法
...
## [](#pass-by-value-in-javascript)在 JavaScript 中按值传递
...
## [](#pass-by-reference-javascript)通过引用传递 JavaScript
...
## [](#pass-by-reference-in-java)在 Java 中通过引用传递？
