...
> 原文：<https://dev.to/adamkdean/new-string-format-for-c-strrep2-kkc>

继我之前的 string.format C 函数出现问题之后，我决定今天在 valgrind 的严密观察下重写它。

所以我重新写了一遍，现在从 valgrind 那里得到了所有的许可:
