...
## [](#what-is-a-progressive-web-app)什么是渐进式 Web App？
...
[![](../Images/08f61ca572f0baf9a14404bf1f1b77f2.png)T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--KbYccISX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/1ndt3v1egn4exjfl1x3r.jpg)
...
### [](#1-requirement-https-instead-of-http)1。要求:https 而不是 http
...
#### [](#21-lighthouse-test)2.1 灯塔测试

*   灯塔测试是由谷歌创建和维护的自动化测试，测试网站的三个标准:进步性、性能、可访问性。它给出了每个问题的百分比分数，并建议如何解决每个问题。这是一个很好的学习工具。![Lighthouse test result for didiermotte.be](../Images/19a24f70a5ebd7f2c26dce955fd8273f.png)
...
#### [](#23-service-workers-via-upupjs)2.3 服务人员，via upup.js
...
8.  在你的手机上测试，看看会发生什么。如果有机会的话，在 Android 上你会在底部看到一个弹出窗口，邀请你将网站保存到你的手机主屏幕上！![](../Images/a97defb64982a99bfae049650f86d236.png)

## [](#deeper-into-the-rabbit-hole)深入兔子洞...
...
![](../Images/b80330654087cce5e8b33bc162bc10ba.png)](https://www.amazon.fr/_/dp/1491961651?tag=oreilly20-20) 。
