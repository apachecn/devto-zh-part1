...
*谷歌页面速度洞察:*
[![alt text](../Images/550651c3380a6b955f7f7f91ead6b24f.png "Google Page Speed Insights")](https://res.cloudinary.com/practicaldev/image/fetch/s--sOSZkzws--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3a85zy9iu8puh1k0goap.png)

*gt metrix:*
[![alt text](../Images/44f3bb0620a1a9bcc87b0be36d30f392.png "GTMetrix")](https://res.cloudinary.com/practicaldev/image/fetch/s--5VKevF_m--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/i1w4wun3isfzwyh7k8yn.png)

这样的工具可以帮助你优化所有影响 Magento 网站加载速度的重要方面。然而，如果你想把它推向下一个层次，你需要为你的 Magento 商店建立一个 CDN(内容交付网络)。

## [](#what-is-cdn-and-how-they-work)什么是 CDN，它们是如何工作的？
...
[![alt text](../Images/01c8844fe07ec25b38e088d8924cb7d4.png "Faster Page Load due to CDN")](https://res.cloudinary.com/practicaldev/image/fetch/s--Tp5Yy3Tj--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/h9wc7ymcpu7u0uhafxwe.png)
...
## [](#pros-and-cons-of-using-a-cdn-with-magento-ecommerce-websites)在 Magento 电子商务网站上使用 CDN 的利弊:
