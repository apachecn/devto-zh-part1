...
> 原文:[https://dev . to/sethmlarson/debugging-Travis-ci-without-commits-](https://dev.to/sethmlarson/debugging-travis-ci-without-commits-)
...
[![Pull Request](../Images/8f591daa52b41a19cc888e68a1946a6b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5Uf7B-3I--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o9kva1zsa0godq3c43cd.PNG)
...
# [](#a-solution-to-the-problem)解决问题的方法
...
[![](../Images/25f7eec2ca6d1183d54da57dab6e59e5.png)T2】](https://asciinema.org/a/135389)

[在 GitHub](https://github.com/SethMichaelLarson/trytravis) 上查看`trytravis`的源码。根据`Apache-2.0`获得许可。

## [](#additional-awesome-features)附加牛逼功能
...
# [](#find-me-on-twitter)在 Twitter 上找到我
