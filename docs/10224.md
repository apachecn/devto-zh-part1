...
> 原文:[https://dev.to/gonedark/3-git-commands-i-use-every-day](https://dev.to/gonedark/3-git-commands-i-use-every-day)
...
## [](#2-git-commit-amend-noedit)2: git 提交-修改-不编辑
