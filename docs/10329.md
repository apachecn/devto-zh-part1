...
> 原文:[https://dev . to/preslavrachev/create-executable-kot Lin-jars-using-gradle](https://dev.to/preslavrachev/create-executable-kotlin-jars-using-gradle)
...
### [](#setting-up-kotlin-dependencies)设置 Kotlin 依赖关系
...
### [](#configure-your-gradle-build-to-create-an-executable-jar)配置您的 Gradle build 以创建一个可执行的 JAR
