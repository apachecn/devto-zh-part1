...
[![Classily.js - Toggling classes more classily](../Images/a6ef5b347d5e62c244674df71df5e938.png)T2】](https://www.silvestar.codes/articles/classily-js-toggling-classes-more-classily/)
...
## [](#how-to-install-classilyjs)如何安装 Classily.js？
...
## [](#how-to-initialize-classilyjs)如何初始化 Classily.js？
...
[![Classily.js graphic example](../Images/84da2ffa45e9ff235848d6a30682de9f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b8HSBSku--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k0igzm9mmlggmchmy6pe.png)

当选择器和类的数量不相等时，所有提供的类将在每个选择器指向的每个元素上切换。例如，如果我们传递两个用逗号分隔的选择器和三个用逗号分隔的类，那么这三个类都将在两个选择器指向的每个元素上切换。

足够的理论，让我们看看这个插件的行动。

## [](#how-to-use-classilyjs)如何使用 Classily.js？
...
## [](#how-to-toggle-the-same-class-on-multiple-elements)如何在多个元素上切换同一类？
...
## [](#how-to-toggle-multiple-classes-on-multiple-elements)如何在多个元素上切换多个类？
...
## [](#how-to-use-classilyjs-for-toggling-states)如何使用 Classily.js 进行状态切换？
