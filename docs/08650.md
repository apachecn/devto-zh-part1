...
> 原文:[https://dev.to/aivarsk/using-select2-2h91](https://dev.to/aivarsk/using-select2-2h91)
...
## [](#using-raw-select-endraw-the-correct-way)使用`select`正确的方式
...
## [](#-raw-select-endraw-vs-others)`select` vs 别人
