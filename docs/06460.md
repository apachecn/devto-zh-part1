...
## [](#spreadsheets-can-be-databases-too)电子表格也可以是数据库
...
[![An animation showing a user completing the form in the application we are working with, and successfully posting their data to the spreadsheet.](../Images/c6f04dadd1c6f70c8a7f75758e72f708.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qLnJGUJg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://twilioinc.wpengine.com/wp-content/uploads/2017/06/V0nFfq0H-tlU9rIaofpRtScv8BQUSoXtcZY-D0lndme3R0kVai5HHWbvm1XFe7q8Ro1UgzGFuvnjOCt_e2OG0DgWxy7y1jHMyOfR5xQw8EbpuWIyedJ0VMdmL85BM5P7LWMe7So.png)

首先，应用程序需要一点重构。

## [](#plain-old-ruby-objects)朴素古老的红宝石物件
...
## [](#validation-with-activemodelvalidations)用 ActiveModel::Validations 进行验证
...
### [](#out-of-the-box-validations)开箱验证
