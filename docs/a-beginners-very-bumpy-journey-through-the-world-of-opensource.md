...
> 原文：<https://dev.to/shubheksha/a-beginners-very-bumpy-journey-through-the-world-of-opensource>
...
每次我想投稿的时候，我都会去 Github 或者任何一个 bug 追踪器——尝试搜索带有“简单”、“初学者”、“好的第一个 bug”、“低挂果实”标签的问题。在筛选了数百个之后，我找到了一些不需要任何外部帮助就可以做的琐碎事情。

现在，这有一段时间是有效的，直到我意识到我可以更好地利用我正在积累的技能。我学到了这么多新东西，但我不知道在哪里应用它们。仅仅学习——没有应用——没有什么价值。我被困在一个高原上，根本没有前进。
...
我觉得我在开源的世界里遇到了一个封闭的环境。

一切似乎表明，我只是把自己放在那里，不要害怕。但当时我还没准备好。

#### 发现 Mozilla

在一个晴朗的夜晚，我偶然发现了这个 Mozilla 项目，它帮助你测试 web 扩展，寻找有待解决的问题。我很高兴发现了一些被称为“好的第一个错误”的问题，但是没有一个问题像修复一个小的打字错误那么简单。

伙计，我现在真高兴。

我开始着手其中一个，但很快意识到如果我想结束这个问题，我需要问问题。我浏览了一下代码库。一旦我对正在发生的事情有了一些了解，我就请求更多的指导。瞧！在获得我需要的所有相关细节后，我能够解决这个问题。

现在，我已经打开了三个拉式请求——一个已合并，另外两个正在被合并——我很高兴我冒险尝试了。我很高兴在问相关问题的时候，我没有退缩，即使这意味着有时看起来很傻。
...
社区注意到了我的贡献，我也把它写进了 [Addons 贡献认可](https://wiki.mozilla.org/Add-ons/Contribute/Recognition#August_2016)文档。

总的来说，我在过去几周的经历简直棒极了。我学到了很多大大小小的东西，是任何一本工程教科书都教不了我的。

#### 我对想为 open 做贡献的新手开发者的建议来源:
...
找一个你觉得轻松的话题——最好是用你已经使用了一段时间的语言——试着找出需要做的事情。询问相关信息来填补你的知识空白，然后开始工作。别等了。

### 谢谢各位开源维护者！

这是对所有开源维护者的一个巨大的呼喊，他们对新贡献者的响应和鼓励非常好。你正在帮助新来者浏览庞大的代码库，并以一种微小但有意义的方式做出贡献。你的努力是真正被欣赏和需要的。

作为一名新手和初级开发人员，我只是试图在这个庞大而不可思议的技术行业中找到自己的路。你的几分钟指导——无论是介绍一种简单的调试技术，还是向我展示如何编写适当的测试用例——从长远来看，都将帮助我成为一名更好的开发人员。

你有经验，而我有不断学习的欲望。

特别感谢[圭多](https://twitter.com/gvanrossum)、[库马尔·麦克米兰](https://medium.com/u/e82665c16d4e)和[卢卡](https://github.com/rpl)，他们在整个旅程中都是了不起的导师，每次都跟进，并回答我的各种问题。我真的很感谢你在我身上投入的所有时间和精力。)

如果你是开源领域的新手，我想听听你的经历和故事。如果我能以任何方式帮助你，请不要犹豫伸出手来！

我计划记录我为开源做贡献的旅程，所以如果你有什么特别想让我写的，请留言。

感谢帕万·杜贝和 T2 帮助我完善了这篇文章。

本文原载于[媒体](https://medium.freecodecamp.com/a-beginners-very-bumpy-journey-through-the-world-of-open-source-4d108d540b39)。