...
> 原文:[https://dev . to/sparkpost/a-guide-to-use-sparkpost-with-nodejs](https://dev.to/sparkpost/a-guide-to-using-sparkpost-with-nodejs)
...
### [](#bonus-sending-email-with-nodemailer)奖励:使用节点邮件程序发送电子邮件
...
### [](#double-bonus-sending-email-with-notifme)双重奖励:用 notif.me 发送邮件
...
### [](#theres-no-wrong-way-to-node)节点没有错
