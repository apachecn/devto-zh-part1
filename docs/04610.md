...
[![Create a CSV of Yesterday's Google Calendar Events](../Images/cfe827fdfdf9a0f8bff1330ec86285c9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TvdTph9N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://scriptingwithpython.com/content/images/2017/09/gregorian-calendar.jpg)
...
## [](#solution-to-pulling-google-calendar-events-to-csv)将 Google 日历事件拉至 CSV 的解决方案
...
### [](#step-1-setup-environment)步骤 1 -设置环境
...
### [](#step-2-turn-on-the-google-calendar-api)第二步——打开谷歌日历 API
...
### [](#step-4-create-the-python-file-raw-pullfromgcalpy-endraw-)第四步——创建 Python 文件`pull_from_gcal.py`

创建 Python 文件来运行该脚本。如果您正在使用 PyCharm，您可能需要创建一个新项目。

### [](#step-5-save-the-code)第五步-保存代码

如果您想直接运行代码，可以在这里复制/粘贴完成的代码。然而，您可能会受益于一行一行(主要是)的走查，以确保您知道它在做什么。

### [](#step-6-run-the-script)步骤 6 -运行脚本

右键单击 PyCharm 中的文件并选择`Run 'pull_from_gcal.py'`，运行。

[![Create a CSV of Yesterday's Google Calendar Events](../Images/1eda4754c0558d4106d7e9690742912d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2tBeLTuR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://scriptingwithpython.com/content/images/2017/09/Screen-Shot-2017-09-24-at-6.33.31-PM.png)

如果一切顺利，脚本将打开一个浏览器窗口，提示您批准应用程序。去做这个吧。该脚本将收集必要的凭据，并将它们保存到本地文件中以供将来使用。如果可以的话，你的浏览器应该会显示如下画面。

[![Create a CSV of Yesterday's Google Calendar Events](../Images/d2d263c9b7e4991ebe2acb91757d2033.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--anw4pR2_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://scriptingwithpython.com/content/images/2017/09/Screen-Shot-2017-09-24-at-9.30.13-AM.png)

还将创建包含昨天事件的 CSV。

[![Create a CSV of Yesterday's Google Calendar Events](../Images/344e1743e7870efdf01074831889c3ca.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hJHv4aZ7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://scriptingwithpython.com/content/images/2017/09/Screen-Shot-2017-09-24-at-6.37.31-PM.png)

## [](#wrapup-conclusion-followup)总结、总结、跟进
