...
> 原文:[https://dev . to/ecnepsnai/pragmatically-generating-a-self-signed-certificate-and-private-key-using OpenSSL](https://dev.to/ecnepsnai/pragmatically-generating-a-self-signed-certificate-and-private-key-usingopenssl)
...
# [](#generating-the-private-key)生成私钥

任何 PKI 加密设置都需要一个私钥，通常有两种算法可供选择:RSA 和 ECDSA。

## [](#ecdsa-vs-rsa)ECDSA 诉 S. RSA
...
## [](#generating-an-rsa-private-key)生成 RSA 私钥
...
## [](#generating-a-ecdsa-private-key)生成 ECDSA 私钥
...
# [](#generating-the-server-certificate)生成服务器证书
...
# [](#saving-your-private-key-and-certificate)保存您的私钥和证书
...
## [](#save-using-pkcs12)使用 PKCS12 保存
...
# [](#verifying-our-server-certificate)验证我们的服务器证书
