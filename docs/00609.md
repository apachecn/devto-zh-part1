...
> 原文:[https://dev . to/Kelsey Evans/monitoring-envoy-and-ambassador-on-kubernetes-with-the-Prometheus-operator-j86](https://dev.to/kelseyevans/monitoring-envoy-and-ambassador-on-kubernetes-with-the-prometheus-operator-j86)
...
## [](#envoy-ambassador-and-prometheus)使节、大使和普罗米修斯
...
## [](#deploy-the-prometheus-operator)部署普罗米修斯操作员
