...
> 原文:[https://dev.to/plutov/building-rest-server-with-elixir-4pd](https://dev.to/plutov/building-rest-server-with-elixir-4pd)
...
#### [](#create-new-mix-project)创建新的混音项目
