...
#### [](#do-you-need-redux-with-reactnavigation)需要 redux 带 react-navigation 吗？
...
#### [](#adding-immutablejs-to-the-mix)向 mix 中添加不可变的. js
...
#### [](#leveraging-redux-in-your-navigation)在导航中利用 Redux
