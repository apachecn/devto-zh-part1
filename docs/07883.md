...
> 原文:[https://dev . to/dean/the-problem-with-interfaces-and-how-go-fixed-it](https://dev.to/dean/the-problem-with-interfaces-and-how-go-fixed-it)

# [](#interfaces-are-great)界面很棒
...
# [](#the-problem-with-interfaces)接口的问题
