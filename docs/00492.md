...
> 原文:[https://dev . to/the outlander/build-your-own-react-boilerplate-4b 8l](https://dev.to/theoutlander/build-your-own-react-boilerplate-4b8l)
...
## [](#git-repository-setup)Git 仓库:设置
...
[![React Boilerplate](../Images/8756379c09e2b2c783e372b60184e680.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yWudUUme--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/10/localhost-1.png)

> 你可以通过按下 **< Ctrl > C** 来停止网络服务器

## [](#test-harness-jest)测试线束:Jest
...
[![React Boilerplate](../Images/64e08514d84aa59fe4ebad4246c5bf0d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kJQc7f7P--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/12/test.png)

我们的应用程序被设置为通过 *Express* web 服务器提供静态 *HTML* 文件。我们已经集成了 *Babel* 来启用 ES6 和 *Jest* 进行单元测试。让我们将注意力转移到前端设置上。

## [](#react-setup)React 设置
...
## [](#babel-react)通天塔有什么反应

如果你执行 **npm run build-client** ，你会得到一个错误，因为我们还没有告诉 babel 如何处理 React / JSX。

[![React Boilerplate](../Images/162c9fceae01bd4faa9456e114da54bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OmrYjx96--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/12/jsxerror.png)
...
## [](#load-script-in-html)加载 HTML 中的脚本
...
[![React Boilerplate](../Images/9bc3b02ba6597f9c7719fe7179e1c1f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DdnqXn0e--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/10/require-error.png)
...
## [](#clean-build-wwebpack)使用 Webpack 清理构建
...
[![React Boilerplate](../Images/1349d29043535d799f3a6c4c8b0f85e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--O3I_9Hr8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/12/raf.png)
...
[![React Boilerplate](../Images/0a86213e983dccebc865bf5b0963d4c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fbqgYTDQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/12/testspassing-1.png)
...
[![React Boilerplate](../Images/8e8d52254f3797fb6af12b001d1eff01.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Dzc8atjP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://nick.karnik.io/content/images/2017/10/initial.png)
