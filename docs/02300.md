...
[![azure-deployment-options](../Images/b47c003b26a9ebff37263ba1bdd26080.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--8f1f-bLc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://leruplund.dk/wp-content/uploads/2017/11/azure-deployment-options.png)

接下来的步骤允许您登录到您的源代码提供者(即 Bitbucket)并选择项目和分支(通常是主分支)。这里的美妙之处在于 Azure 支持从各种来源提取代码，如 Dropbox、Onedrive、Github，当然还有 Bitbucket。

[![azure-deployment-options-configure](../Images/3158ed0eadd1028d6d2545d63987c6c4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--_9SXeeKC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://leruplund.dk/wp-content/uploads/2017/11/azure-deployment-options-configure.png)

保存设置后，Azure 将获取您的最后一次提交并开始构建。您可以通过再次单击“部署选项”来查看进度。

[![azure-deployment-progress](../Images/10f36047761ec2026ba21bc4766bbea8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--DFs0IbHh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://leruplund.dk/wp-content/uploads/2017/11/azure-deployment-progress.png)
