...
> 原文:[https://dev . to/captainkrtek/the-walking-dead-but-with-processes](https://dev.to/captainkrtek/the-walking-dead-but-with-processes)

## [](#whats-a-zombie)什么是僵尸？

[![](../Images/70d511ce5bc88db4a4392be52a08aecb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--c-giVExS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://turnoff.us/image/en/zombies.png)
...
## [](#when-init-doesnt-do-its-job)当 init 不工作时...
