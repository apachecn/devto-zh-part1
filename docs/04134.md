...
> 原文:[https://dev . to/Chiang s/theres-no-excuse-not-to-have-SSL-more-76f](https://dev.to/chiangs/theres-no-excuse-not-to-have-ssl-anymore-76f)
...
### [](#first-why-are-we-doing-this)一、我们为什么要这样做？
...
### [](#install-ssl-certificates)安装 SSL 证书
...
### [](#setup-ssl-autorenew)设置 SSL 自动更新
...
### [](#setup-auto-redirect-to-https)设置自动重定向到 HTTPS
