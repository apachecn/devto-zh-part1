...
> 原文:[https://dev.to/michaeljones/django-to-phoenix-part-1-56h](https://dev.to/michaeljones/django-to-phoenix-part-1-56h)
...
## [](#setting-up-django-in-docker)在 Docker 中设置 Django
