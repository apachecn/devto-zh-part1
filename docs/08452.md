...
> 原文:[https://dev . to/jvanbruegge/using-cycle js-to-view-real-time-satellite-test-data](https://dev.to/jvanbruegge/using-cyclejs-to-view-real-time-satellite-test-data)
...
## [](#step-3-first-implementation)第三步:首次实施
...
## [](#step-4-enjoy-or-do-we)第四步:享受！...还是我们？
...
## [](#step-6-enjoy-again-what-still-bad)第六步:再次享受！...什么，还是不好吗？

如果您再次运行代码，只会稍微好一点。它运行大约 5 秒钟，然后开始抖动，最后浏览器将再次过载。肯定还有别的问题。

## [](#step-7-make-it-better-again)第七步:让它变得更好(再次)
...
## [](#step-8-enjoy-finally)第八步:享受！终于！

如果你现在在浏览器中运行它，你会看到最新数据的平滑曲线。

[![Smooth](../Images/290746b805fa06510c52edcd34777e14.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--bu9AXoJB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1m4mtu.jpg)

最终结果看起来是这样的，记住这是随机生成的数据，而不是真实的测试数据:

[![Plot](../Images/f14d7db5b386a9d3c4326ff059cb95d1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lG4F2lGO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5yhbt9mssrp2a3v3izzd.png)

## [](#step-9-still-not-enough)第九步:还不够？
...
### [](#pausing-unused-graphs)暂停未使用的图形
...
## [](#step-10-uiux-goodies)第十步:UI/UX 好东东
