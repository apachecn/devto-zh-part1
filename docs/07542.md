...
> 原文:[https://dev . to/michaeljota/input-set-pattern-for-widgets-in-angular](https://dev.to/michaeljota/input-set-pattern-for-widgets-in-angular)
...
### [](#introducing-raw-input-set-endraw-)介绍`@input set`
...
### [](#introducing-raw-template-get-endraw-)介绍`template get`
