...
> 原文:[https://dev.to/nitishdayal/stages-of-learning-webpack-pt-3-源地图-加载器-插件](https://dev.to/nitishdayal/stages-of-learning-webpack-pt-3---sourcemaps-loaders--plugins)
...
#### [](#changes-to-raw-webpackconfigjs-endraw-)修改为`webpack.config.js`:
...
#### [](#changes-to-raw-packagejson-endraw-)修改为`package.json`:
...
#### [](#webpack-configuration-updates)Webpack 配置更新
