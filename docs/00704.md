...
> 原文:[https://dev . to/tech community/how-to-shape-a-call-to-cobol-from-web methods-integration-server-the-modern-way-3gn 5](https://dev.to/techcommunity/how-to-shape-a-call-to-cobol-from-webmethods-integration-server-the-modern-way-3gn5)
...
| 2018 年第一期 | [![](../Images/a80ab71273994c8d589f4e03e98b42bb.png) 下载 PDFT4】](http://techcommunity.softwareag.com/ecosystem/download/techniques/2018-issue1/SAG_webMethods_EntireX_TECHniques_Jan18_WEB.pdf) |
| --- | --- |
...
[![](../Images/c4798b7e84a8ccdc2884ae508279cec9.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Jj_B1VgZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirex1.jpg/48fb30b3-5347-478f-8666-b3854b92d4de%3Ft%3D1516181293458)
...
## [](#reinvoke-cobol-mapping-editor)重新调用 COBOL 映射编辑器

首先，确保你处于软件 AG 设计者的整体视角。您可以从软件 AG IDL: COBOL >修改接口的上下文菜单中调用 COBOL 映射编辑器(图 2；红色标记)，这需要从先前的快速路径提取中提炼。

[![](../Images/3d177b1bd4a09f80e6759dcf425224c2.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Zz0P9Wju--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirex2.jpg/53eb3eac-b696-4eb8-a976-6a9ee0243eaa%3Ft%3D1516181297471) 

**图 2:** 再调用 COBOL 映射编辑器

您可能还记得 COBOL 服务器 EMPLOYEE 中提供了一个列表和细节函数。操作字段中的值定义了要执行的功能。在 COBOL 实践中，值通常作为 COBOL Level-88 项提供，类似于枚举类型(图 1+2；蓝色标记)。

## [](#extract-getdetailsofemployee-function)提取 getDetailsOfEmployee 函数

在 COBOL 映射编辑器中，您可以从之前的快速路径提取中形成现有的 COBOL 到 IDL 的映射。

[![](../Images/d59289e8a91fa9838dd2c2430f0d3f04.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6LR76e55--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirex3.jpg/6619e0b2-a7a6-4500-84d8-176e0ab01fd7%3Ft%3D1516181302745) 
...
2.  默认情况下，IDL 接口与您的 COBOL 服务器同名:EMPLOYEE。使用 COBOL 映射编辑器工具栏中的*重命名*按钮 [![](../Images/056e5df275ff11c01f0c11077eb1adec.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3o7YWTS---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirexicon.png/e30c5b29-019a-48a2-b5ee-326e68c5198a%3Ft%3D1516182217896) ，将 IDL 接口名称改为*getdetailsofeemployee*(图 3；蓝色标记)。这个名称稍后将被用作 is 服务名称。

[![](../Images/8d41425faecdacdc3b6d1f66f58930cb.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--YAmE8sRH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirex4.jpg/14314499-cc00-442b-baf6-61f89d136e27%3Ft%3D1516181308336) 
...
## [](#extract-getlistofemployees-function)提取 getListOfEmployees 函数

[![](../Images/d0ceb29ca93383d94fc70b04612c39ce.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--IqdZ0kj4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirex5.jpg/262618e1-b029-4399-9baa-90bc725c1863%3Ft%3D1516181320813) 

**图 5:** Shape EMPLOYEE:创建映射到同一个 COBOL 服务器的第二个 IDL 接口。

COBOL 映射编辑器允许您为同一个 COBOL 服务器定义多个 IDL 接口:

1.  使用工具栏按钮 [![](../Images/950ba0f3b3db7159f8035f70805cb0e7.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--TmoDjjXy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirexcopy.png/e6a1d179-b8e6-45ad-8200-8b894c9bd6fd%3Ft%3D1516182683700) *创建附加 IDL 接口，复制当前 IDL 接口*。(图 5；红色标记)。创建了一个新选项卡*getdetailsoemployee 1*。之前提取的*getdetailsofeemployee*接口仍然存在于第一个选项卡中。一旦您重新激活第一个选项卡，您将再次看到*getdetailsofeemployee*的界面。

2.  使用 COBOL 映射编辑器工具栏中的*重命名按钮 [![](../Images/056e5df275ff11c01f0c11077eb1adec.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--3o7YWTS---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirexicon.png/e30c5b29-019a-48a2-b5ee-326e68c5198a%3Ft%3D1516182217896) ，将 IDL 接口名称改为 _ getlistoemployees*(图 5；蓝色标记)。这个名称稍后将被用作 is 服务名称。
...
## [](#shaped-software-ag-idl-is-service-and-is-connection)聚能软件 AG IDL，是服务，是连接

现在，让我们看看这两种方法之间的区别。与快速结果提取相比，具有成形提取和用户定义映射的 IS 服务看起来如何？

[![](../Images/b4627596904ad5cb2e551f19e2bf47ae.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--DkP0Ek4_--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://techcommunity.softwareag.com/documents/10157/9398481/entirex6.jpg/70f72077-8438-4152-8d89-fab0791b44f0%3Ft%3D1516181315696) 
