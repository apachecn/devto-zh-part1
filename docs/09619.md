...
> 原文:[https://dev . to/anotherdevblog/taming-un tracked-files-in-a-large-git-repository](https://dev.to/anotherdevblog/taming-untracked-files-in-a-large-git-repository)
