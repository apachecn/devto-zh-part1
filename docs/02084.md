...
[![copy as curl command](../Images/fcf653fc3712014993e8ded2ecb782b5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--lreKSNQS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/3hprvahmrx5byekp2ggj.png)
...
## [](#measure-response-time-using-raw-curl-endraw-)使用`curl`测量响应时间
...
## [](#measure-the-percentile-of-the-response-times)测量响应时间的百分位数
