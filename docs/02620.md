...
> 原文:[https://dev . to/mutated bread/using-gvreditoremulator-prefab-from-Google VR-package-and-not-sinking-the-camera-down-until-the-parent-center-on-unity-editor-9m](https://dev.to/mutatedbread/using-gvreditoremulator-prefab-from-googlevr-package-and-not-sinking-the-camera-downward-until-the-parent-center-on-unity-editor-9m)
