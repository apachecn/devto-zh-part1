...
> 原文:[https://dev . to/adamkdean/connecting-to-SQL-over-TCP-IP-with-entity-framework-4l7i](https://dev.to/adamkdean/connecting-to-sql-over-tcp-ip-with-entity-framework-4l7i)
