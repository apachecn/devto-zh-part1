...
> 原文:[https://dev . to/ariera/dev-toolbar-a-web-developers-best-friend](https://dev.to/ariera/dev-toolbar-a-web-developers-best-friend)
...
[![developer toolbar](../Images/666d6f9c3d4675623a6da125a43ee13a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---87anmZX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://ariera.github.io/assets/dev-toolbar.png)

数据库中所有用户的简单选择。点击其中一个，你就会以他/她的身份登录。

让我们继续吧！

### [](#1-create-a-dev-app)1。创建开发应用程序
...
### [](#5-show-it-in-the-admin-panel)5。在管理面板中显示它
