...
> 原文:[https://dev . to/caiorcferreira/hosting-an-API-in-firebase-write-with-type script-and-nest](https://dev.to/caiorcferreira/hosting-an-api-in-firebase-writen-with-typescript-and-nest)
...
### [](#building-project-scaffold)建筑工程脚手架
...
*   用空格标记函数和托管功能，然后按 enter 键。![Select the Firebase features we wiil need](../Images/ccdca4692a82308fcea7e673e9759641.png)
*   设置您的 Firebase 项目![Set your Firebase project](../Images/fa2056424f789117276c81918f618288.png)
*   输入`n`不安装 npm 依赖项![Enter n](../Images/22dc3919ab3cfcf2713975da6e22412b.png)
*   按 enter 键使用默认的托管目录作为公共目录。![Press enter](../Images/aa8996dc4f21afdd3975dd1a79f310d4.png)
*   输入`n`禁用单应用配置![Enter n again](../Images/ba4ae42c3544d2adf3cd471e7929b7cf.png)

然后，打开您最喜欢的代码编辑器。我将使用 Visual Studio 代码。你会看到下面的文件夹结构:
[![Initial project folder structure](../Images/a51ded8c1fdcec0c75015c8cc83f270c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--TZUHg_xF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://gdurl.com/JQtv)
...
[![src folder structure](../Images/df8d60d01c2c1f1fccded469a8de908b.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--LPpo8W1K--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://gdurl.com/6nFi)T4】
