...
> 原文:[https://dev . to/aurelkurtula/introduction-to-fire bases-storage-E12](https://dev.to/aurelkurtula/introduction-to-firebases-storage-e12)
...
[![img](../Images/bef977fff87bf1f218c50edfad291867.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MqVTUapB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zrx3ji1lm68heqdki8hv.png)
...
## [](#setting-up-storage-restrictions)设置存储限制
...
[![img](../Images/d4fa5a736c40da557df02b27b3d3f437.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fz88ruGT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o0j15pp6kvhnp3728dgv.png)

## [](#working-with-raw-storage-endraw-)与`storage()`一起工作
...
### [](#uploading-files-to-firebase-storage)上传文件到 firebase 存储器
...
[![](../Images/51b1c666901b346ba98a44b1a200f3f4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ShajxEe7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/65hooqflvqctkoc037uy.png)

### [](#getting-feedback-from-the-process)从流程中获得反馈
...
## [](#reading-files-from-storage)从存储器中读取文件
...
## [](#combining-storage-with-the-database)存储与数据库相结合
