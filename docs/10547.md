...
> 原文:[https://dev . to/swiip/error-comparisons-between-react-and-angular-2md 6](https://dev.to/swiip/wrong-comparisons-between-react-and-angular-2md6)

[![](../Images/33a4b2d3c57432f611e4747dd4e6cd4d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NMwjy1T2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1000/1%2AJ1dPk8j0_2RAlzAT7aGx1A.jpeg)
...
### [](#angular-is-fullstack-react-is-a-tiny-ui-library)Angular 是 Fullstack，React 是一个微型 UI 库
...
### [](#angular-organizes-your-logic-react-doesnt-and-you-have-to-use-flux)Angular 组织你的逻辑，React 不行，你得用 Flux
...
### [](#zonejs-is-the-revolution-of-change-detection)Zone.js 是变化检测的革命
...
### [](#so-are-there-any-difference)那么……有什么区别吗？
