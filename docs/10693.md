...
> 原文:[https://dev.to/betweenthewires/evan-you](https://dev.to/betweenthewires/evan-you)

我是一个流行的渐进式 JavaScript 框架[*【vuejs.org】*](http://vuejs.org/)*的创造者。我全职研究 Vue，资金来自 Patreon 的竞选活动。此前，我在谷歌和流星工作。*
...
<figure>[![](../Images/59631ec32f31d1da53ba17754b13b57e.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ptdu0Gki--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2A4JPr5veRTbx8YOFXX2BPYw.jpeg) 

<figcaption>艾凡与他的第一台计算机，1996 年</figcaption>

</figure>

## [](#what-was-your-first-programming-experience)**你的第一次编程经历是什么？**
...
## [](#okay-when-or-how-did-you-discover-the-current-problem-that-youre-trying-to-solve-with%C2%A0vuejs)**好的，你是什么时候或者如何发现你正在试图用 Vue.js 解决的当前问题的？**
...
## [](#if-you-had-to-list-a-few-core-things-that-defined-vue-compared-to-other-frameworks-what-would-you%C2%A0say)**如果你必须列出几个与其他框架相比定义 Vue 的核心东西，你会说什么？**
...
这是一种交换。你对用户用例的假设越多，那么框架最终能够承受的灵活性就越小。或者将一切交给生态系统，例如 React——React 生态系统非常非常有活力。有很多伟大的想法涌现出来，但也有很多搅动。Vue 试图选择一个中间地带，在那里核心仍然作为一个非常小的特性集暴露出来，但是我们也提供这些可增量采用的部分，比如路由解决方案、状态管理解决方案、构建工具链和 CLI。它们都是官方维护的，有很好的文档记录，旨在协同工作，但您不必全部使用它们。我认为这可能是 Vue 作为一个框架，与众不同的最大原因。

## [](#how-did-you-manage-to-become-financially-sustainable-with%C2%A0vuejs)**你是如何通过 Vue.js 实现财务可持续发展的？**
...
<figure>[![](../Images/84572ecf020d176d36647b19970819f4.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ZrAyuz1O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AwMQeCCJqxyvzDNmmMVnraQ.png) 

<figcaption>埃文的 Patreon 战役</figcaption>
...
## [](#did-it-take-a-long-time-to-convince-them-to-sponsor-you-were-they-skeptical-at-all-like-youre-just-a-young-framework-you-might-not-last-six%C2%A0months)**说服他们赞助你花了很长时间吗？他们会怀疑吗，比如，你只是一个年轻的框架，你可能坚持不了六个月？**
...
## [](#you-mentioned-that-you-were-able-to-get-sponsored-because-it-grew-so-quickly-did-you-have-to-do-any-marketing-or-did-it-grow-organically)**你提到你能够得到赞助是因为它发展得如此之快。你需要做市场营销吗？还是有机生长的？**

我会说营销中没有任何真金白银。我没有买广告什么的。大部分是，只是写一些博文。很多时候我只是在管理 Twitter 账户。我想差不多就是这样了。偶尔我会在媒体上写一篇文章。

## [](#you-ended-up-getting-great-traction-in-international-markets-which-is-probably-pretty-unique-wed-love-to-hear-how-it-happened-and-some-of-the-challenges-and-best-practices-for-engaging-developers-outside-of-the%C2%A0us)**你最终在国际市场获得了巨大的吸引力，这可能是非常独特的。我们很想听听这是如何发生的，以及**吸引美国以外的开发者的一些挑战和最佳实践**。**

<figure>

<figure>[![](../Images/9af88db9a8fe80129e92487ffa207aac.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--yI_HJN5q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AJTnV4p9Y-6f-Yc3h8qYovQ.jpeg) 

<figcaption>JSConf 中国，2015 年</figcaption>
...
## [](#do-you-have-any-suggestions-for-companies-startups-or-open-source-projects-that-arent-easily-able-to-engage-or-communicate-with-international-communities)**对于那些不容易与国际社区接触或沟通的公司、初创公司或开源项目，你有什么建议吗？**
...
## [](#did-you-make-any-mistakes-while-building-vue-that-you-hope-to-never-make%C2%A0again)**在创建 Vue 的过程中，你有没有犯过你希望永远不要再犯的错误？**
...
#### [](#have-there-been-emotional-or-nontechnical-hardships-that-youve-faced-with%C2%A0vue)**你在使用 Vue 时遇到过情感上的或非技术性的困难吗？**
...
## [](#the-next-few-are-just-fun-questions-outside-of-programming-what-are-some-other-hobbies-or-interests-that-you-have-outside-of-programming)**下面几个只是编程之外的好玩的问题。除了编程，你还有什么其他爱好或兴趣？**

动漫，我看了很多漫画。如果你还没有注意到，Vue 的发布是用动漫名字来命名的。它始于. 09，每一个大版本的代码名称都以一个字母递增。2.0 是 G 也就是壳中鬼。f 其实是留给 1.1 的。1.0 是福音战士。

<figure>

<figure>[![](../Images/6f60859c313013f6fa6181561b8299d8.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--zkTdbHjf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AhvV2aJXo9vKsNXjYTzODWQ.png) 

<figcaption>一位日本 Vue 用户为庆祝 1.0 发布(代号 Evangelion)而绘制的插图</figcaption>
...
<figure>[![](../Images/d32e599f86857d365762b13596eeee9d.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--cLWIgax7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AEa4hEK1X64TSYAu7Xlf-Kw.jpeg) 

<figcaption>为 Vue 2.0 的庆典插画(代号为《贝内幽灵》)</figcaption>

</figure>

我确实喜欢卡拉 ok。

## [](#what-are-some-top-technologies-or-trends-that-youre-most-excited%C2%A0about)**你最感兴趣的顶尖技术或趋势是什么？**
...
## [](#who-are-some-of-your-programming-heroes-if-you-have%C2%A0any)**你心目中的编程英雄是谁？如果你有的话。**

显然 [TJ Holowaychuck](https://twitter.com/tjholowaychuk) 和 [Guillermo Rauch](https://twitter.com/rauchg) 。我不是计算机专业的。我基本上只是通过随机的在线资源和书籍来学习编程，但我学习的一个重要方式是通过阅读其他人的代码。看 TJ 的代码，总觉得真的很优雅。我想到了这个词，这个词对我影响很大。TJ 绝对是我的英雄。
...
*本帖最初发表于[betweenthewires.org](https://betweenthewires.org/2016/11/03/evan-you/)T3】*