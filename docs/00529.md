...
## [](#a-case-of-a-largescale-refactoring)一个大规模重构的案例。
...
## [](#enter-branch-by-abstraction)通过抽象进入分支。
...
[![Initial structure](../Images/edb74a48acb5f15bbcd1b50514a99122.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--iZiq5eYb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.droidship.com/images/posts/bba/initial_structure.png)
...
1.  在当前旧的实现上添加一个抽象。
2.  重构，这样所有的客户端都使用上面的抽象，而不是直接使用旧的实现。![Steps 1 & 2](../Images/a1c600dfd03121bce3385b7575b3f718.png)

步骤 1 和 2。

1.  在该抽象下添加新的实现，并根据需要逐渐委托给新的实现。![Step 3](../Images/9b6ef14c01b638dae51f85cf8d1d74ab.png)

第三步。

1.  一旦不再使用旧的实现，就可以将其删除。![Step 4](../Images/2809dde6d02b34967058effecd4f4afd.png)

第四步。

1.  重构结束后，删除抽象层。![Step 5](../Images/1dd6d4e1e4a651a47d760f1937181a4c.png)
...
## [](#excuse-me-where-is-my-kotlin-twist)请问我的科特林麻花在哪里？
