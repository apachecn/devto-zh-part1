...
### [](#1-editcreate-appropriate-folders-and-files-in-jekyll-project)1)在 Jekyll 项目中编辑/创建适当的文件夹和文件
...
### [](#3-reference-relevant-authors-in-the-front-matter-of-individual-blog-posts)3)在个人博文的前面引用相关作者
