...
## [](#dash-application-design-mvc-pattern)Dash 应用程序设计:MVC 模式
...
## [](#historical-matchup-dashboard)历史对决仪表盘
...
### [](#setting-up-environment-and-installing-dependencies)设置环境和安装依赖项
...
### [](#dashboard-layout-view)仪表盘布局(视图)

我们的 app 会是这样的:

[![Dash App Layout](../Images/ad7f5f1c7a326b890fd5281522ae63c5.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--6JtncyEI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alysivji.github.io/images/11-20/11_dash_app_layout.png)
...
### [](#interaction-between-components-controller)部件间的相互作用(控制器)
...
### [](#data-manipulation-model)(模型数据操作)
...
[![Soccer Results Dashboard](../Images/55bf2d0c8a00792085be0760edf784c7.png)T4】](https://res.cloudinary.com/practicaldev/image/fetch/s--I1bDmvRs--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/lpaqrtxoayai0k3fs8xj.gif)
