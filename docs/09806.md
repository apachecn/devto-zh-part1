...
[![When you send a message from the application it arrives on the phone](../Images/7e992c2abe01073c9518216f91f65243.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gUcKG_je--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://twilioinc.wpengine.com/wp-content/uploads/2017/02/working.gif)

如果你试图在没有网络连接的情况下用这个应用程序发送消息，你会得到不一样的体验。

[![When offline and you try to send a message you just get Chrome's offline screen](../Images/9e3aad623471ef5948555c1a2b2b007b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--f_s5DH4C--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://twilioinc.wpengine.com/wp-content/uploads/2017/02/offline-1.gif)
...
## [](#register-a-service-worker)注册一个服务人员
...
## [](#intercept-form-submit-events)拦截表单提交事件
...
## [](#saving-the-message-to-indexeddb)保存消息到 IndexedDB
...
[![Now when you send a message while offline it will be sent when you go back online.](../Images/69d2209dd2c4d443dd1d6ba32bead402.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rY4FKSYa--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://twilioinc.wpengine.com/wp-content/uploads/2017/02/success.gif)

## [](#network-resilient-messages)网络弹性消息
