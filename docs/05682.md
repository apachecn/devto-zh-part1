...
> 原文:[https://dev.to/dmerejkowsky/non-isomorphic-c-refactoring](https://dev.to/dmerejkowsky/non-isomorphic-c-refactoring)
...
# [](#using-raii-for-the-door)用 RAII 为门
...
# [](#remembering-the-combination)回忆组合
