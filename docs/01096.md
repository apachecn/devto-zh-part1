...
## [](#then-there-is-one-bug)然后，有一个 bug🐞
...
## [](#and-then-there-are-two-bugs)然后，有两个 bug🐞🐞
...
## [](#thinking-about-conflicts)思考冲突

你可能已经注意到了，我在更新的主体中设置了`conflicts: :proceed`。这是为了处理几种情况:

### [](#the-post-is-updated)帖子更新
...
### [](#multiple-updates-to-the-same-author)对同一作者的多次更新
