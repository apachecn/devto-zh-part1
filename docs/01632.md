...
# [](#the-problem-running-commands)问题:运行命令
...
### [](#just-use-the-command-line-history-like-everyone-else)就像其他人一样使用命令行历史
...
### [](#you-spoiled-brat-put-these-commands-in-raw-sh-endraw-files-and-get-it-over-with)你这个被宠坏的顽童！将这些命令放在`.sh`文件中，然后完成它！
...
## [](#have-a-single-file-containing-all-these-commands)有一个*单*文件包含了*所有*这些命令
...
# [](#using-omnipytent)使用 Omnipytent
...
## [](#simple-tasks-and-commands)简单的任务和命令

因此，在克隆了存储库之后，假设我想要运行测试。这是一个 Maven 项目，所以我们用`mvn test`运行测试。我要用 Omnipytent 来做:

[![run tests](../Images/b7e1379d3241d7e7a7667adf63684115.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--75hU5fGP--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/oitwbejpnwnnilyqychs.gif)
...
[![Run in terminal emulator](../Images/c2bd815b6e8acf595df1bf161c95f000.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rZSEBrB6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/avjc9prdphp84acfqtuj.gif)

## [](#ok-but-why)好的...但是为什么呢？
...
1.  这是一个 Maven 项目，所以命令是`:!mvn test`。如果这是一个 Gradle 项目，我需要`:!gradle test`。和蚂蚁一起，我需要`:!ant test`。又或许是 [`:!ant junit`](https://www.mkyong.com/ant/ant-and-junit-task-example/) ？蚂蚁就是那样自由奔放，所以它可以是任何东西。
    ...
    [![keymaps](../Images/3c48732755491f2417a6bcd8afd67c97.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--A-YorvF3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dr8h5wpnbo1nk8x45b5b.png)
...
[![Specific test](../Images/cfe6a25317feee9b85df8e1348f1d02a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WpyzCMgl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/babjbvkv13hz3gfutt4d.gif)
...
## [](#task-arguments-and-completion)任务论证和完成情况
...
[![Specific test by argument](../Images/2d07dc4a9891a0dc305686abcb2399e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LMHwLr7l--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nu2pshhdbjj82qjbl78o.gif)
...
[![argument completion](../Images/c0f9d9b65aad75a0eb9ca7b68889e229.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--H8nYVksW--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ncxq5t9uq51is21w3nw0.gif)

## [](#interacting-with-vim)与 Vim 互动

运行测试很好——但是我们也想构建项目，不是吗？“使用`:make`”——一千个 Vim 用户会立刻尖叫(如果...他们同时在读这个)。好，我们用`:make`:

[![make is set to Gradle, not Maven](../Images/1d577d3b2ba294f455ff5b8335d508bc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--0nJ2XG-D--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/6tyb8zlvgze28rqg04lg.gif)
...
[![running compile](../Images/7189f7b2791dc2a1ade02524fcdd08ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2VbVFpdU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/dr0nw6q61x78h4h2uf2t.gif)
...
## [](#combining-tasks-together)将任务结合在一起
...
[![window task](../Images/d739eea3dc034f3f7f165c460361a086.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rKY30AbQ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/bosggtn2y3h4bvthg3p8.gif)
...
[![kill window](../Images/3da11c0faf3191d2356ff9e5f01c07ba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--eIqC9cs2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k0tpxb4udd8ng9puwvdr.gif)
...
[![using terminal as shell command executor](../Images/2546956402f00e1a92aa82e37d414ea1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KCXw7kq2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/gug7udxdcwpmxoxkt3r4.gif)
...
[![options task](../Images/e8169fc7764c6de44031d93bda431296.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--m_HVqlnR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/n1b726tqrhvywmo7s73z.gif)
...
[![idanarye image](../Images/456007709804c1392e9a743b81ebcafc.png)](/idanarye) [## Omnipytent 1.3.0:异步任务和选择 ui
