...
[![l](../Images/e98c65b727404cf6daa368173ac8f6bf.png)](///static/l-05682be5967a236947250ae3504d3929-edc9a.png)T3】

```
ll = log --pretty=format:"%C(yellow)%h%Cred%d\\ %Creset%s%Cblue\\ [%cn]" --decorate --numstat 
```

[![ll](../Images/b1acc53b8e3f65bef43520368faabbad.png)](///static/ll-a1f7c71ae63f755151bb454838e9dc33-edc9a.png)T3】

```
lll = log -u 
```

[![lll](../Images/78ce1e53f396a2859fe09859e69dd2c3.png)T2】](///static/lll-7721aaaeae2a78eafcc5abdcf8f04083-edc9a.png)
