...
> 原文:[https://dev.to/mandarbadve/tuple-a-new-data-structure-in-c](https://dev.to/mandarbadve/tuple-a-new-data-structure-in-c)
...
### [](#you-can-create-tuple-by-using-two-ways)你可以用两种方式创建元组。
...
### [](#create-method-have-different-overloads-as-follows)创建方法有不同的重载如下:
