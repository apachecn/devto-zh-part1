...
> 原文:[https://dev.to/dmerejkowsky/how-i-lint-my-python](https://dev.to/dmerejkowsky/how-i-lint-my-python)
...
# [](#running-pycodestyle)运行 pycodestyle
...
# [](#running-the-linters-from-vimneovim)从 vim/neovim 运行棉绒
