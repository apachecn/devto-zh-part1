...
## [](#rapidoid)[Rapidoid](http://www.rapidoid.org/)
...
### [](#paso-3-creando-mi-aplicaci%C3%B3n-y-rutas)步骤 3。创建我的应用程序和路径
...
### [](#paso-5-creando-un-jar-para-despliegue)步骤 5。建立要建置的 jar。
...
### [](#paso-6-ejecutando-la-aplicaci%C3%B3n)步骤 6。正在运行应用程序
