...
> 原文:[https://dev . to/patrickodacre/reusable-components-and-vue-router-492h](https://dev.to/patrickodacre/reusable-components-and-vue-router-492h)
...
## [](#props-types-required-defaults)道具:类型，必选，默认
...
## [](#use-defaults-where-possible-or)尽可能使用默认值，或者...
