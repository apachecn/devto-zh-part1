...
> 原文:[https://dev . to/datawireio/tutorial-getting-started-with-ambassador-a-kubernetes-native-API-gateway-for-micro services-1849](https://dev.to/datawireio/tutorial-getting-started-with-ambassador---a-kubernetes-native-api-gateway-for-microservices-1849)
...
## [](#1-running-the-demo-configuration)1。运行演示配置
...
## [](#2-ambassadors-diagnostics)2。大使诊断
...
## [](#3-the-quote-of-the-moment-service)3。瞬间服务的报价
