...
> 原文:[https://dev . to/adnanrahic/a-crash-course-on-server less-with nodejs-5jp](https://dev.to/adnanrahic/a-crash-course-on-serverless-with-nodejs-5jp)
...
### [](#functions-as-a-service%C2%A0faas)功能为服务(FaaS)
...
### [](#wading-into-shallow%C2%A0waters)涉入浅水区
...
#### [](#aws-api%C2%A0gateway)AWS API 网关
...
#### [](#the-serverless-framework)无服务器框架
...
#### [](#1-first-of-all-you-need-to-install-serverless-globally)1。首先，你需要安装全球无服务器。
...
#### [](#2-create-an-iam-user-in-your-aws%C2%A0console)2。在 AWS 控制台中创建 IAM 用户

打开 AWS 控制台，点击左上角的服务下拉菜单。你会看到大量的服务出现。继续在搜索框中输入 IAM，然后点击它。

[![](../Images/d443fbc7987f9d572a567bace9acc244.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1PoBgc2i--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A1BKK9Uf_iZg5aQMggHkFAw.png)

您将被重定向到您的帐户的 IAM 主页。继续添加新用户。

[![](../Images/c3e811785f327ccb7b7295562f056d86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YACc4EuX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A2W0uhicsEKt274A-UFQsNQ.png)

为你的新 IAM 用户选择一个时髦的名字，并给用户**编程访问**。继续下一步。

[![](../Images/2293eb0b9546eb598bd87819f9d74c2e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--b-HVsKhz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AHpGc2GUbMlpxngt_ovSQXA.png)

现在，您可以向用户添加一组权限。因为我们将让 Serverless 在我们的 AWS 帐户上创建和删除各种资产，所以继续检查 AdministratorAccess。

[![](../Images/4d910f2b5414a99166482d66b14740c5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kQImqAfy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AiVJjs6_pqyNz-s8KFrZWvg.png)

继续下一步，您将看到用户已创建。现在，也只有现在，您才能访问用户访问密钥 ID 和秘密访问密钥。请务必记下它们或下载。csv 文件。保管好它们，不要给任何人看。尽管这只是一个演示，我还是把它们像素化了，以确保你理解保护它们安全的重要性。

[![](../Images/794023b4c0e69b5c9b3ebd2e98d658b1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--USDha_H0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2Aq4aHTY0FCsHIlAdZP9qPcA.png)
...
#### [](#4-create-your-first%C2%A0service)4。创建您的第一个服务
...
#### [](#5-explore-the-service-directory-with-a-code%C2%A0editor)5。使用代码编辑器浏览服务目录
...
#### [](#6-deploying-to%C2%A0aws)6。部署到 AWS
...
[![](../Images/f7ea5f3745697f7ddb76fd80dd335ae4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--gZLCrCaS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AMZpOqG3asqfwkmuUML7_AA.png)
...
#### [](#1-initialize-npm-in-the-service-directory)1。在服务目录中初始化 npm
...
#### [](#2-install-serverless-offline)2。脱机安装无服务器
...
[![](../Images/2560ab16a9a6c3fdbc2b63ef9b8a1577.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WrxCrvMq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AaSCwxVMlCW03ItQwva8bHA.png)

错误被突出显示，我可以看到我的系统的整体健康状况。真是如释重负。它还跟踪成本。不用担心吹预算。甚至包括实时监控。这很酷。

[![](../Images/a8263ea2abb0a5a62e9671965c50faa0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YdNuRtHD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AVKt0UjXe-8Cuwrr-GgfNOQ.png)
