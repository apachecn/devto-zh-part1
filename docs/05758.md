...
[![fzf-like tab switcher](../Images/be85543543b4789e4828bc4d9b8cbadb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--QlxGl7mE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://store2be.github.io/images/vimium/tab-switcher.jpg)

*T* 给你一个 [fzf](https://github.com/junegunn/fzf) 般的标签切换器。使用 *< Ctrl-j/k >* 可以在结果中上下移动(就像在 fzf 中一样)。同样，o 为你的历史和书签提供了一个类似 fzf 的菜单。

[![fast link opener](../Images/e15bf9946517b968bb3c889df9aa4dbb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hCBx9KrR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://store2be.github.io/images/vimium/link-opener.jpg)
