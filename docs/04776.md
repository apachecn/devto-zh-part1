...
> 原文:[https://dev . to/jvanbruegge/why-I-always-recommend-arch-Linux](https://dev.to/jvanbruegge/why-i-always-recommend-arch-linux)
...
## [](#software-not-in-the-official-repositories)官方资料库中没有的软件
