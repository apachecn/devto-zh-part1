...
### [](#custom-test-data-for-parameterized-tests-141)参数化测试的自定义测试数据 [#141](https://github.com/Microsoft/testfx/issues/141)
...
### [](#assertthat-116)断言。那个 [#116](https://github.com/Microsoft/testfx/issues/116)
