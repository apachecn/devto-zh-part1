...
> 原文:[https://dev.to/edoverflow/operation-fgtny-解决-h1-212-ctf - 5f33](https://dev.to/edoverflow/operation-fgtny----solving-the-h1-212-ctf--5f33)

## [](#preliminary)初步

一个有经验的工程师为世界上最大的公司之一工作。

[![](../Images/cfcae01c5daea77f86d536a4939cd384.png "Photograph by USA Network/NBCU - © 2017 USA Network Media, LLC")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TGpSzdu5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32990101-a8d382e0-cd23-11e7-8b9f-d4fbcf8825c4.png)

这位工程师安装了一台服务器，并声称没有人能够侵入。

进入展品二:一个没有经验的孩子庆祝他们的生日，我(EdOverflow)。

[![](../Images/13dfa4371cc604014bcc4f1b94ba6c40.png)T2】](https://camo.githubusercontent.com/9526164484cd3b590119156eb5ce51852eb735a2/68747470733a2f2f692e67697068792e636f6d2f6d656469612f313044386a3245704e43584441342f3230302e676966)

队列[戏剧性的音乐](https://www.youtube.com/watch?v=pER7P06MNrg)。

## [](#step-1-the-classic-jobert-challenge)第一步——经典的乔伯特挑战
...
[![image](../Images/be0bc28e313fe8fe21c039c1e2a66180.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4kYFAJNH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32788392-6244361c-c959-11e7-8044-ab5323b9bd23.png)

[![](../Images/10aabaa9c945e6c116d4b7dd7e1d84b8.png "Photograph by FXX - © 2017 FX Networks, LLC")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--rQMgzmkm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32788339-402f41a2-c959-11e7-8ecc-c374401caccc.png)

我从其他参与者的评论中注意到，他们正在努力迈出第一步。问题似乎是他们过于关注页面的“Apache”方面。这也是 HackerOne 不得不提醒人们不要强行进入下一步的原因。这个挑战与目录暴力毫无关系。_(ツ)_/

## [](#step-2-teapot)第二步-茶壶🍵
...
[![](../Images/c6d01794cf599910df32df037fc34cd1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vr-3m9Nf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32990226-15a65864-cd26-11e7-86e4-58ae264d870d.png)
...
[![](../Images/0a440483b41f71333b9a732827e06711.png "© 2017 Lipton/Disney")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--55-OoAk7--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32786849-548f213e-c955-11e7-9ea0-020afcf24c44.png)

也许现在读者能理解本为什么取笑我们了。

[![](../Images/8f0613d141bcb978d280d32438760c72.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--FAuNeBOe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32835727-8a00a4c0-ca07-11e7-892a-4914dc9067e6.png)

## [](#step-3-serverside-request-forgery)步骤 3 -服务器端请求伪造

提交上一节中的 POST 请求返回了一个 domain missing 错误，这表明请求体必须包含一些带有域属性和值(`{"domain":"hackerone.com"}`)的 JSON。

[![image](../Images/28dceaf5204f50ec441758bb936016af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sZ3jUA7J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32963072-12275c7c-cbcf-11e7-9631-ba656c6266e0.png)

这意味着当前我们试图利用的问题是服务器端请求伪造(SSRF)；我们的目标是检索内部文件，标志可能位于内部网络上。

## [](#step-4-part-1-initial-ideas)第 4 步-第 1 部分-初步想法💡
...
## [](#intermission-bedtime-%F0%9F%9B%8F)中场休息——睡前🛏
...
## [](#step-4-part-2-the-bypass)步骤 4 -零件 2 -旁路
...
[![image](../Images/cd3d25dd9d8b4c254af3202fcd3e9186.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--85uUpn-m--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32836550-76a462a6-ca0a-11e7-8a1e-53df538c4966.png)

## [](#step-6-massive-frustration-and-crlf)第六步——大规模挫败和 CRLF
...
[![image](../Images/19e37e415796432094d88f079a9d653b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hrqcnFeB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32990289-43304302-cd27-11e7-996d-da59b5f796ab.png)

这部分花了我很长时间，我不愿意承认。这种挫败感让我像这样盯着屏幕:

[![](../Images/385f282f74afcb54521f4c28b9a4119d.png "© 2017 Disney")T2】](https://camo.githubusercontent.com/ddc64da52be127f0c0abb710ff92eb1acbb971a4/68747470733a2f2f6d65646961312e74656e6f722e636f6d2f696d616765732f66303562336663373031373464356531326163643131663635653132303063612f74656e6f722e676966)
...
[![](../Images/88bfec6cf7a3315d10f8d3bdd387bb74.png "© 2017 HackerOne, Inc.")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--L8omKSJ0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32785635-4d429576-c952-11e7-8f3d-4a849cdac9b9.png)

那个画面一直留在我的脑海里。"乔伯特在这里做了什么让事情变得对我越来越难？"，我在问自己。我一次又一次失败了。直到那时已经解决了 CTF 的亚帕雷给了我一个微妙的暗示，让我回到了正轨。他们说“CR”。“CR？”，我心想“CR 是什么？”。

[![image](../Images/c20d900f99c18a523daab4288b992837.png)T2】](https://camo.githubusercontent.com/2de8830b806737d783559bc16e113e05fc6c5e64/68747470733a2f2f692e67697068792e636f6d2f6d656469612f3178594b55485250364e7664432f67697068792e676966)

# [](#disc-scratch-crlf)*圆盘划伤*...CRLF！

[![image](../Images/ded60dd4508feffac8a169fb0de241a6.png)T2】](https://camo.githubusercontent.com/75a104fc473eb371d4f7201870fd78f7aee93855/687474703a2f2f6769662d66696e6465722e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031342f30382f4b65726d69742d7468652d46726f672d54616b65732d7468652d414c532d4963652d4275636b65742d4368616c6c656e67652e676966)
...
[![](../Images/e22bfc260800a61be6937835f131e98b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---QCU5bal--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32990532-124af5a8-cd2b-11e7-8e43-0971327649ae.png)

[![](../Images/9b43844c41a57fe89504f61d59dee2ea.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wRx0pDeq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://user-images.githubusercontent.com/18099289/32784209-7efdf820-c94e-11e7-8baf-c524bdf79ff4.png)
...
[![image](../Images/328751c8ca74c840765069789524ea2e.png)T2】](https://camo.githubusercontent.com/27ac0e868cb26c3d24dc34fadb19fa9bf5c8f2ed/687474703a2f2f33312e6d656469612e74756d626c722e636f6d2f63326635396664386335623162373865623932613939393636353830393638322f74756d626c725f6e69746377675451636731746a326c6a386f315f3430302e676966)

## [](#comparing-my-solution-to-those-of-other-competitors)将我的解决方案与其他竞争对手的进行比较
...
## [](#conclusion-what-did-i-learn)结论——我学到了什么？
