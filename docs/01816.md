...
> 原文:[https://dev . to/bobbypriambodo/getting-your-foot-wet-with-ocaml-dp8](https://dev.to/bobbypriambodo/getting-your-feet-wet-with-ocaml-dp8)
...
## [](#switching-ocaml-versions)切换 OCaml 版本
...
## [](#writing-compiling-and-running-programs)编写、编译和运行程序
...
## [](#installing-libraries-and-programs-with-opam)使用 opam 安装库和程序
