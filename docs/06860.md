...
# [](#automatic-code-formatter-prettier)自动代码格式化程序:更漂亮

是一个固执己见的 JavaScript 代码格式化程序。您不需要考虑缩进代码和在正确的位置添加新行——pretty 会自动为您完成。
[![Before prettier to the left, and after to the right](../Images/b67232ac304319a7c968beb6605ed1cc.png) ](https://res.cloudinary.com/practicaldev/image/fetch/s--wlQA5_om--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.jakoblind.no/wp-content/uploads/2017/06/Screenshot-from-2017-06-09-08-03-53.png) *前靠左，后靠右*
...
# [](#errors-and-warnings-in-the-editor-eslint)编辑器中的错误和警告:eslint
...
[![Eslint in Emacs: warnings in yellow underline and errors with red.](../Images/5dcc690eaa2827b81e35ad93f0df8fff.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--Hq6U4izf--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.jakoblind.no/wp-content/uploads/2017/06/Screenshot-from-2017-06-09-07-59-31.png)*Emacs 中的 Eslint:警告用黄色下划线，错误用红色。*

Eslint 和 prettier 配合得非常好，而且大多数流行的编辑器都有编辑器插件。

# [](#devtools-for-reactredux-as-browser-plugins)DevTools for React/Redux 作为浏览器插件
...
[![React devtools](../Images/1affd412a03830aa6e80d59091477cd1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--js8v-5Ja--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.jakoblind.no/wp-content/uploads/2017/06/Screenshot-from-2017-06-07-12-49-13.png)
...
## [](#how-to-debug-with-devtools)如何用 Devtools 调试
...
[![Inspect data with React devtools](../Images/30644df0a8ec347cb67edd175d4da43c.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--f0eNOWPH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.jakoblind.no/wp-content/uploads/2017/06/Screenshot-from-2017-06-09-07-58-12.png) 
我们可以看到它也有我们可以利用的城市和职业！

# [](#react-hot-loader)反应热装载机
