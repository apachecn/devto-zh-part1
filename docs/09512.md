...
## [](#0-stripe-and-mashape-setup)0。条纹和 Mashape 设置
...
[![](../Images/4c676310f0baba250db0b3b7950055de.png)T2】](https://market.mashape.com/noodlio/noodlio-pay-smooth-payments-with-stripe)
...
## [](#1-obtain-the-stripe-token-raw-source-endraw-)1。获取条纹令牌(`source`)
...
### [](#option-1-use-the-stripe-payments-api-noodlio-pay)选项 1:使用条纹支付 API (Noodlio Pay)
...
### [](#option-2-use-stripes-native-checkout-form)选项 2:使用 Stripe 的原生结账形式
...
# [](#templates-amp-source-code)模板&源代码
