...
[![](../Images/381853f85499895e0876c65c8c5d3e1f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3BW-GWmm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/04/build-users-status-app-animated-1.gif)
...
[![](../Images/1ab59b73a3b9b2c407e62b9cf2726df7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--IUuCu5wY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/04/build-users-status-update-create_app-1.png)

对于这篇博文，我们将选择 **Vanilla JS** 作为前端，选择 **NodeJS** 作为后端，如上图所示。这只会向您显示这些选择的一组入门示例代码，但是您可以在以后使用任何集成工具包来使用这个应用程序。
[![](../Images/50031190a47d676b5000e72ac8374a72.png)](https://res.cloudinary.com/practicaldev/image/fetch/s---jap4ASV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/04/build-users-status-update-getting_started_view-1.png)
...
## [](#user-system-auth-api)用户系统认证 API
...
## [](#isloggedin-and-logout-api)是登录和注销 API
...
# [](#front-end-app-using-vanilla-js)前端 App 使用 Vanilla JS

我们现在将开发前端应用程序，以注册一个初始状态的新用户，查看在线成员及其状态。我们还将为登录的用户构建更新他们的用户的功能，所有其他用户将实时看到更新的状态。

## [](#step-1-create-a-folder-named-public-and-create-an-indexhtml)第一步:创建一个名为 public 的文件夹，创建一个 index.html
...
[![](../Images/6ad4efcb33c2be1a86d8ad8575a7227b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K9_QIeb6--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/04/build-users-status-signup-form2-1.png)

### [](#step-4-add-appjs-basic-code)第四步:添加 app.js 基本代码
...
## [](#step-5-add-code-to-render-the-members-list-and-bindchannelevents)步骤 5:添加代码以呈现成员列表和 bindChannelEvents
