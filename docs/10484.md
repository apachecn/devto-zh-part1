# 我是如何进入 Mozilla 的开放源码实习项目的

> 原文：<https://dev.to/shubheksha/how-i-got-into-mozillas-outreachy-open-source-internship-program-2ni5>

[![](img/551eccd88b140195c121f626d7c79657.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--fRchKXn9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2A4p3xb9__LY2feOIZWfKHxg.jpeg) 

<figcaption>Mozilla 的硅谷总部。照片[伯纳德·安德烈](https://officesnapshots.com/2014/09/29/mozilla-corporation-mountain-view-headquarters/)</figcaption>

我最近以实习生的身份加入了 Mozilla 的外联项目。如果你以前没听说过这个节目，让我先回答一些基本问题。

[![](img/57e4d4edd914fce18402a0526fd5e93d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TWNUMgtd--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/702/1%2AKJLOHBefMUduHQ2SRK4Acw.png)

### 什么是 Outreachy？

Outreachy 是一个为来自未被充分代表的群体的人们设计的项目。它旨在通过远程实习让他们更多地参与开源。

像 [Mozilla](https://medium.com/u/95f4ec6ae6f6) 、 [Wikimedia](https://www.mediawiki.org/wiki/Outreachy) 、 [Gnome](https://wiki.gnome.org/Outreach/Outreachy) 和 [Linux 内核](http://kernelnewbies.org/OutreachyIntro)这样的组织都参与了这个项目。他们雇佣实习生来完成他们的项目。
...
[初学者穿越开源世界的坎坷旅程](https://medium.freecodecamp.com/a-beginners-very-bumpy-journey-through-the-world-of-open-source-4d108d540b39)
...
过去，实习生会被邀请参加 Mozilla 公司的工作周，这种活动每年在世界各地举行两次。
...
*本帖最初发表于[medium.com](https://medium.freecodecamp.org/outreachy-what-how-why-4fb60d10a228)T3】*