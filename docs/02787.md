...
> 原文:[https://dev . to/mutated bread/lazy-approach-to-display-YouTube-videos-in-a-react-native-app-bfc](https://dev.to/mutatedbread/lazy-approach-to-display-youtube-videos-in-a-react-native-app-bfc)

前一段时间，我为了一份实习工作，做了一个半生不熟的 RN app。我需要从他们的 YouTube 帐户显示公司的视频。我去 npm 上找插件。因为当时我没有碰到一个可用的插件，所以我决定用我想到的最懒的方法。

# [](#webview-ftw-)WEBVIEW FTW！！！
