...
> 原文:[https://dev . to/SQL super hero/communicating-intent-the-perpetually-undershed-ruby-bang](https://dev.to/sqlsuperhero/communicating-intent-the-perpetually-misunderstood-ruby-bang)
