...
### [](#actual-performance-values)实际性能值
...
[![Visual Query Plan](../Images/5094ce87cd558f383d051bdcbd00b3af.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TIxfsujb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://www.rubyletter.com/images/2016/12/explain.png)

## [](#examples)例子

让我们把它们放在一起，做几个简单的例子。您知道有几种常见的 Rails 习惯用法会产生伸缩性很差的数据库查询吗？

### [](#the-counting-conundrum)计数难题
