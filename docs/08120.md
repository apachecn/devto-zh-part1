...
> 原文:[https://dev.to/pauljlucas/getting-the-terminal-width-in-c](https://dev.to/pauljlucas/getting-the-terminal-width-in-c)
...
## [](#solution-1-raw-ioctl-endraw-)方案一:`ioctl()`
...
## [](#solution-2-raw-getmaxyx-endraw-)方案二:`getmaxyx()`
...
## [](#solution-3-raw-tgetnum-endraw-)方案三:`tgetnum()`
...
## [](#solution-4-raw-tigetnum-endraw-)方案四:`tigetnum()`
