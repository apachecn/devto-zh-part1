...
> 原文:[https://dev.to/scastiel/writing-modern-javascript-code](https://dev.to/scastiel/writing-modern-javascript-code)
...
## [](#use-es2015-new-features)使用 ES2015+新功能
...
## [](#use-functional-programming)使用功能编程
...
## [](#some-other-advices-to-finish)其他一些建议完成
