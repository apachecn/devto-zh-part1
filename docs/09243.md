...
### [](#make-the-partition-for-linux)为 Linux 制作分区
...
[![Macbook Air Linux partitions](../Images/81b4d9f3b2f05c922d173e650640fe15.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--JiS9M1cZ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alex.dzyoba.com/img/macbook-disk-partitions.png)

### [](#create-usb-stick)创建 u 盘
...
## [](#fedora-installation)Fedora 安装

### [](#boot-into-usb-stick)开机插入 u 盘

将 USB 插入 Macbook，按住“alt”键并按住电源按钮，直到您看到带有 Fedora 的引导选择菜单。

### [](#most-important-linux-partitions-and-installation-destination)最重要！Linux 分区和安装目标

从 USB 启动后，你会看到通常的 Anaconda 安装程序。首先也是最重要的，我们必须配置安装目的地。

[![Macbook Air Fedora installer enter](../Images/b9f5b8bc0f10df4e124d6f50c7df56c3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--CSm1zgWM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alex.dzyoba.com/img/macbook-air-installer-enter.png)

进入此菜单，选择“ATA APPLE SSD”，然后选择“我将配置分区”，并单击窗口顶部的“完成”。

[![Macbook Air Fedora installation destination](../Images/b7c7cb26aa9401908adfb434dbd2368a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--WYxpbbHO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alex.dzyoba.com/img/macbook-air-installation-destination.png)

展开“未知”小部件，找到“hfs+”类型的 80 GBs 或 74 GiBs 分区，并删除它。现在，您将在底部的粉色矩形中看到 74 GiBs 的可用空间。

[![Macbook Air empty partitions](../Images/e36c291090fe5ae47ba575a1c46f9c86.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tEhB-oi4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alex.dzyoba.com/img/macbook-air-fedora-partitions-empty.png)

现在从“新 Fedora 25 安装”窗口小部件的下拉菜单中选择“标准分区”方案，然后单击链接“单击此处自动创建它们”。

[![Macbook Air auto partitioning](../Images/9301aec53d8e174204a715883ccddcd0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j1apDI_W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alex.dzyoba.com/img/macbook-air-fedora-partitions-auto.png)
...
[![Macbook Air my partitioning](../Images/dc948adf519f0c41165cfab4d4c6436e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hB0VMlDu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://alex.dzyoba.com/img/macbook-air-fedora-partitions-my.png)
...
### [](#wait-until-the-installation-is-done)等到安装完成

然后通过按住“alt”键重新启动你的新 Fedora。

## [](#install-wifi-drivers)安装 WiFi 驱动程序
...
## [](#making-things-nice-for-me)(为我)把事情变好

现在是调整的时候了。我的最爱！

### [](#enable-fnlock)启用 fnlock
...
### [](#installing-i3-for-mate)为 MATE 安装 i3
