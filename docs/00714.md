...
> 原文:[https://dev . to/yk yuen/manage-go-dependencies-using-glide-2d7k](https://dev.to/ykyuen/manage-go-dependencies-using-glide-2d7k)
...
## [](#a-hello-world-go-program)一个 hello world 围棋程序
...
## [](#add-a-go-dependency)添加一个 Go 依赖项
...
### [](#create-the-glideyaml)创建 glide.yaml
...
### [](#download-the-go-dependencies-to-the-vendor-folder)将 Go 依赖项下载到供应商文件夹
...
### [](#check-in-the-vendor-folder)查看厂商文件夹？
