...
> 原文:[https://dev.to/michaeljones/django-to-phoenix-第三部分-初始-凤凰-设置-4ma](https://dev.to/michaeljones/django-to-phoenix---part-3-initial-phoenix-setup-4ma)
...
## [](#install-elixir-amp-phoenix)安装仙丹&凤凰
...
## [](#create-a-phoenix-project)创建凤凰计划
...
## [](#add-elixir-amp-phoenix-to-our-docker-image)给我们的 Docker 图像添加仙丹&凤凰
...
## [](#get-our-phoenix-app-running-in-the-container)让我们的 Phoenix 应用程序在容器中运行
