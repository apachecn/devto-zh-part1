...
> 原文:[https://dev . to/samueleresca/reactive-programming-damn-it-is-not-about-react js](https://dev.to/samueleresca/reactive-programming-damn-it-is-not-about-reactjs)
...
[![](../Images/800ac0025be9c341744572aa8500b697.png)T2】](https://i.giphy.com/media/3o7btTV6kjvYgEaUqA/giphy.gif)
...
#### [](#start-to-think-functional)开始思考功能
...
### [](#reactivex%C3%A2-in-practice-on-data-events-and-promises)实践中的反应*(关于数据、事件和承诺)*
...
#### [](#case-of-studies-netflix)案例研究@网飞
