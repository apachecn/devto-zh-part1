...
### [](#il-of-delegates-andor-lambdas)IL 代表和/或 lambdas
...
## [](#how-the-runtime-creates-delegates)运行时如何创建委托

### [](#inlining-of-delegate-ctors)委托构造器的内联
...
[![](../Images/424b2901995aa550a1813f6a4df6479e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ZtK_tLeD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://mattwarren.org/images/2017/01/Figure%25203%2520The%2520most%2520complex%2520case%2520of%2520Precode%2C%2520Stub%2520and%2520Native%2520Code.png)

### [](#how-%C3%A2%E2%82%AC%CB%9Cshuffle-thunks-are-setup)如何设置“随机思维”
...
### [](#other-functions-that-call-raw-setupshufflethunk-endraw-)调用`SetupShuffleThunk(..)`的其他功能
...
## [](#different-types-of-delegates)不同类型的代表
