...
## [](#spring-the-magic-is-happening)春天——神奇的事情正在发生
...
### [](#spring-web-mvc-gimme-some-rest)Spring Web MVC -让我休息一下
...
### [](#spring-integration-tests)春季综合测试
...
## [](#lombok-no-more-getters)龙目岛——没有更多的吸杂者
