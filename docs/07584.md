...
### [](#why-should-you-use-mvp)为什么要用 MVP？
...
[![App Screenshot](../Images/f036f9d15250be6a2d25d8ac04213bca.png "Login Screenshot")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OkFVMT3W--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://s3-us-west-2.amazonaws.com/my-blogresources/r2d22.3.8subbu05262017002156.png)

最简单的实现需要大约 100 行代码，因为实现可以使用任何 UI 视图组件。

### [](#designing-the-presenter)设计演示者
