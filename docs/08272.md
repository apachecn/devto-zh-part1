...
> 原文:[https://dev . to/rob 117/server less-back ends-with-AWS-cloud-Twitter-complete](https://dev.to/rob117/serverless-backends-with-aws-cloud-twitter-complete)
...
# [](#lets-send-some-tweets-with-lambda)我们用 Lambda 发几条推吧
