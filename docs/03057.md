...
> 原文:[https://dev . to/tech ediaries/building-websites-with-PHP-7-and-angular js-16-6 F6](https://dev.to/techiediaries/building-websites-with-php-7-and-angularjs-16-6f6)

[![AngularJS 1.6 + PHP 7](../Images/6b97747132ea73d987eac328f48dcb17.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ALaWoXZH--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.techiediaries.com/images/content/building-websites-php-angularjs.jpg)
...
## [](#introduction-to-angularjs)安古拉吉斯简介
...
## [](#tutorial-and-projects-requirements)教程和项目需求
...
## [](#the-first-project-building-a-single-page-application-spa-portfolio-website-with-php-7-and-angularjs-16)第一个项目:用 PHP 7 和 AngularJS 1.6+搭建单页面应用(SPA)作品集网站

### [](#the-project-anatomy-files-and-folders)项目剖析(文件和文件夹)
...
[![PHP 7 + AngularJS 1.6](../Images/009db5f1caffb5e391c45e06b4b83438.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--zz64bdXe--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.techiediaries.com/images/content/php7-angularjs16-project-structure.png)
...
### [](#integrating-bootstrap-4-and-jquery)集成 Bootstrap 4 和 jQuery
...
### [](#integrating-angularjs-16-and-angularjs-ui-router)集成 AngularJS 1.6 和 AngularJS UI 路由器
...
### [](#creating-the-angularjs-application-module-portfolioapp)创建 AngularJS 应用模块(portfolioApp)
...
### [](#adding-routing-states-and-navigation-using-angular-ui-router)使用 Angular UI 路由器添加路由(状态)和导航
...
### [](#creating-the-html-templates-or-partials)创建 HTML 模板或片段
...
[![PHP 7 AngularJS basic navigation](../Images/0d647101147da65e2591ec0af7c0a696.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Ma6CB91q--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.techiediaries.com/images/content/angularjs-php7-basic-nav.gif)
...
### [](#creating-angularjs-15-components)创建 AngularJS 1.5+组件
...
### [](#linking-states-directly-to-components)将状态直接链接到组件
...
[![PHP 7 AngularJS basic navigation](../Images/90046c536119505918735e33fc38e560.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--AbOO-mEF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://www.techiediaries.com/images/content/angularjs-php7-basic-nav2.gif)
