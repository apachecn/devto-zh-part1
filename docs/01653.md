...
> 原文:[https://dev . to/kayis/tag-your-unions-before-you-wreck-your-unions-oep](https://dev.to/kayis/tag-your-unions-before-you-wreck-your-unions-oep)

Paul Gorbould 在 Flickr 上的封面图片。T3】

标记并集、区分并集、分离并集、变量、变量记录或总和类型。不同的名字，相似的概念，但是它到底是什么，标记的联合和普通的有什么不同？

## [](#untagged-unions)未标记的工会
