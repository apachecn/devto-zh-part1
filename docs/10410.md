...
> 原文:[https://dev . to/lepo virta/enforcing-invariants-in-Scala-data types-248 o](https://dev.to/lepovirta/enforcing-invariants-in-scala-datatypes-248o)
...
## [](#invariant-validation-using-runtime-assertions)使用运行时断言进行不变验证
...
## [](#enforcing-invariants-in-a-typesafe-style)以类型安全的方式实施不变量
...
## [](#escaping-invariant-validation-in-case-class-datatypes)在 case 类数据类型中逃避不变验证
...
## [](#regaining-the-case-class-features)恢复案例类特征
