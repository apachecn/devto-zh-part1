...
> 原文:[https://dev . to/tommym 9/integrating-Google-calendar-with-a-laravel-site-2bd](https://dev.to/tommym9/integrating-google-calendar-with-a-laravel-site-2bd)
...
[![alt text](../Images/2eeba662a6dd9d28d98d8a001189b600.png "Google OAuth2 flow diagram")](https://res.cloudinary.com/practicaldev/image/fetch/s--YcFesmbq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/j9dia7pp02w6e6tpcuoh.png) 
...
[![alt text](../Images/4ec52675257e97025719aafaad761573.png "Google credentials prompt")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ypRP-D59--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4zh6jnakbpekiwp8rkds.png)

# [](#adding-credentials)添加凭证

有一个创建凭据的向导。这不是令人惊讶的清晰，所以这里是我们设置的截图。注意:我使用了虚拟内容，而不是客户端数据。

第一步询问将使用哪个 API 以及如何访问它
[![alt text](../Images/f8cf81b4e04a32be0dcd773aac010c48.png "Google credentials wizard first step")](https://res.cloudinary.com/practicaldev/image/fetch/s--ZnTMBVCu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9t0wrsrbvojo0aoact44.png)

第二步是将 URL 列入白名单，并设置 oAuth 回调路径。
[![alt text](../Images/2e18fedff1935150bf1aa46f5bfb4bdf.png "Google credentials wizard second step")T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--IBoeIH7E--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/02mb7rz7cveanlgs2tey.png)

第三步是设置场馆将收到的同意书。
[![alt text](../Images/37e564cf9dc47e50664f34741ca2e001.png "Google credentials wizard third step")T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--oY3U9JpL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nw5ukwaud821m5py55t9.png)

第四步为您提供客户端 ID 和凭证。
[![alt text](../Images/86adf9985291560df50933ec80917fdd.png "Google credentials wizard fourth step")T3】](https://res.cloudinary.com/practicaldev/image/fetch/s--p03uPRrD--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zu1tjdxycpxco3fqxkqw.png)
...
# [](#require-the-google-api-client)需要 Google API 客户端
...
[![alt text](../Images/688652bd79f62beda45461b3a5fd4c3a.png "Google consent form")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5UYEvLb8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/arawr1f1nixqng5qbbbj.png)
...
## [](#refreshing-the-access-token)刷新访问令牌
...
# [](#pulling-bookings-from-google-calendar)从谷歌日历中提取预订
...
# [](#pushing-bookings-to-google-calendar)将预订推送到谷歌日历
