...
> 原文:[https://dev . to/danieljsummers/generating-a-Jekyll-site-on-mercurial-Hg-push](https://dev.to/danieljsummers/generating-a-jekyll-site-on-mercurial-hg-push)
