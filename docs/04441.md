...
> 原文:[https://dev . to/mushketyk/getting-started-with-batch-processing-using-Apache-flink-bnh](https://dev.to/mushketyk/getting-started-with-batch-processing-using-apache-flink-bnh)
...
# [](#processing-data-with-apache-flink)用 Apache Flink 处理数据
