...
> 原文:[https://dev . to/lpas qualis/best-languages-to-learn-how-to-code-35d](https://dev.to/lpasqualis/best-languages-to-learn-how-to-code-35d)
...
[![](../Images/0a61e322b3aedc3d26865f3c98736a8d.png)T2】](https://www.coderhood.com/best-languages-to-learn-coding/)

## [](#english-chianti-c-and-the-old-days)英国、基安蒂酒、C 国和旧社会
...
## [](#today-you-have-many-choices)今天你有很多选择
...
## [](#start-learning-the-fundamentals-of-java)开始学习 Java 基础知识
...
## [](#java-development-tools)Java 开发工具

首先，请前往 www.jetbrains.com 下载 IntelliJ 社区版。它是最好的 Java 开发环境之一，而且是免费的。

## [](#learn-a-scripting-language)学习一门脚本语言
...
## [](#python-development-tools)Python 开发工具

有很多方法可以创作 Python，但是我知道的最好的工具是 PyCharm。免费社区版是一个很好的起点。去 www.jetbrains.com 免费下载。

## [](#play-with-microcontrollers-and-the-iot)玩微控制器和物联网

过去几年最激动人心的创新之一是开发廉价的微控制器板。这种板的一个流行的例子是 Arduino。

[![](../Images/5522287e72f663982dfb7fc1dd1983e2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--fDnW0xBv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/z1fcusz2qhyspzkux4m8.jpg)
...
## [](#hello-world-with-arduino)用 Arduino Hello world
...
Â Â Â Â Serial.print("Hello World!");
}
...
## [](#the-iot-is-fun-and-at-arms-reach)物联网充满乐趣，触手可及
