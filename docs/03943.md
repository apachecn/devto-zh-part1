...
> 原文:[https://dev.to/psnebc/sudo-v-wget-NV-o-https download calibre-ebookcomlinux-installerpy-573](https://dev.to/psnebc/sudo--v--wget--nv--o--httpsdownloadcalibre-ebookcomlinux-installerpy-573)

### [](#update-calibre-17102017)更新口径 17.10.2017

### [](#linux-mint-lts-rosa-173-kde)Linux 造币厂 LTS 罗莎 17.3 KDE
