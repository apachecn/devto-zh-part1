...
> 原文:[https://dev . to/mortoray/debugging-a-defect-a-a-shared-argument-4 EMG](https://dev.to/mortoray/debugging-a-defect-with-a-shared-argument-4emg)
...
## [](#its-a-problem-of-ownership)这是所有权的问题
...
## [](#logically-avoiding-the-issue)逻辑上回避问题
