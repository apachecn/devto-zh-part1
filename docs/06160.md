...
## [](#building-a-dom-game-with-html-custom-elements)用 HTML 自定义元素构建 DOM 游戏

这是一个小实验，展示了如何在 DOM 中创建自己的 HTML 元素来构建游戏。

### [](#what-are-these-custom-elements)这些自定义元素是什么？
...
### [](#extending-other-elements)扩展其他元素
...
### [](#for-of-loop-in-nodelist)为 NodeList 中的循环
