...
> 原文:[https://dev . to/mapp mechanic/how-to-build-a-live-comment-feature-using-JavaScript-pusher-5akl](https://dev.to/mappmechanic/how-to-build-a-live-comment-feature-using-javascript--pusher--5akl)
...
[![](../Images/1843688900f6275736b675189a1751e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Mh_Q58ee--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/03/build-live-commenting-feature-javascript-app-video-1.gif)
...
# [](#brief-introduction-to-pusher)推杆简介
...
[![](../Images/4acdab8ff3d218ebc52e1ed05feac253.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--i_k-ZUTn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/03/build-live-commenting-feature-javascript-img2.png)

对于这篇博文，我们将选择 **Vanilla JS** 作为前端，选择 **NodeJS** 作为后端，如上图所示。这只会向您显示这些选择的一组入门示例代码，但是您可以在以后使用任何集成工具包来使用这个应用程序。

[![](../Images/0c31593768b985c703a15f1fc9c07451.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5QzPtcvA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/03/build-live-commenting-feature-javascript-img3.png)

# [](#nodejs-app)NodeJS App

## [](#initialising-node-project)初始化节点项目
...
## [](#important-pusher-concepts)重要推手概念
...
## [](#step-1-create-a-folder-named-public-amp-create-an-indexhtml)步骤 1:创建一个名为 public 的文件夹【index.html】创建一个 T2

我们已经在`server.js`中编写了代码来提供来自`public`文件夹的静态内容，所以我们将在这个文件夹中编写所有的前端代码。

请创建一个新文件夹`public`并暂时创建一个空文件夹`index.html`。

## [](#step-2-add-boilerplate-code-to-our-indexhtml)步骤 2:向我们的 index.html 添加样本代码
...
### [](#step-3-create-stylecss-file)第三步:创建 style.css 文件
...
### [](#step-4-add-the-pusher-js-library-amp-create-appjs)第四步:添加 Pusher JS 库&创建 app.js
...
### [](#step-5-creating-form-for-adding-new-comment)第五步:创建添加新评论的表单
...
[![](../Images/a11bbe5205fdd334d1bb96a6e0a609f3.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sGzODv-L--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://blog.pusher.com/wp-content/uploads/2017/03/build-live-commenting-feature-javascript-debug_console.png)

### [](#step-6-display-list-of-comments-received-for-this-channel)第六步:显示该频道收到的评论列表
