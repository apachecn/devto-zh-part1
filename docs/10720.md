...
> 原文:[https://dev . to/tryexceppass/how-to-write-your-own-python-documentation-generator-4f 97](https://dev.to/tryexceptpass/how-to-write-your-own-python-documentation-generator-4f97)

### [](#introspection-with-the-inspect-module)用 inspect 模块进行自检
