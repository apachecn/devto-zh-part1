...
## [](#provide-the-configuration-in-the-module)提供模块中的配置
...
## [](#use-the-config-object-in-the-service)使用服务中的配置对象
...
## [](#pass-in-the-config-on-import)导入时传入配置
