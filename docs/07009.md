...
> 原文:[https://dev . to/sethmlarson/林挺-as-轻量级缺陷检测-for-python](https://dev.to/sethmlarson/linting-as-lightweight-defect-detection-for-python)
...
### [](#configuring-flake8-to-catch-defects)配置 Flake8 捕捉缺陷
...
### [](#configuring-flake8-to-work-for-you)配置 Flake8 为您工作
...
### [](#you-didnt-ignore-all-whitespace-violations-arent-those-style)你没有忽略所有的空格违规？那不是很时髦吗？
...
### 
 [](#if-the-project-supports-2x-and-3x-run-flake8-using-both-versions) 
