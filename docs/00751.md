...
> 原文:[https://dev.to/brightdevs/database-timeouts-4l4p](https://dev.to/brightdevs/database-timeouts-4l4p)
...
[![Database](../Images/740dd71f0a602e9adf53aabefc23b77a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vKVlPL3B--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/k64c2la5ocsrsfp0yppa.jpg)

## [](#different-kinds-of-timeouts)不同种类的超时
...
### [](#establish-database-connections-in-pool)
...
### [](#send-statements-to-database-and-read-query-results)
...
### [](#keep-all-timeouts-short)保持所有超时时间短
