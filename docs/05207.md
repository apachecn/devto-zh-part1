...
> 原文:[https://dev.to/rob__race/13-more-gems-i-use-allthetime](https://dev.to/rob__race/13-more-gems-i-use-allthetime)

[![](../Images/3492a163ef77024e9dea4828f074efb5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Da2J-K-0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/b7fomj3nzpejsyjj2ptc.png)

## …我的意思是，当这些宝石有用或者需要的时候，我会去拿很多。

几个月前，我发布了一篇关于我在几乎每个 SaaS 项目中使用的 27 种宝石的文章/故事。这收到了大量的赞扬，以及围绕使用*这么多*宝石的一点点负面意见。

### [](#gems-ymmv)宝石。你的经历可能不一样
