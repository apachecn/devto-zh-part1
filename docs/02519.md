...
> 原文:[https://dev.to/kbariotis/asyncawait——一个彻底的例子——4o9p](https://dev.to/kbariotis/asyncawait---a-thorough-example-4o9p)
...
## [](#a-promisebased-example)一个基于承诺的例子
...
### [](#start-the-promise-chain-with-a-promise)以承诺开始承诺链
