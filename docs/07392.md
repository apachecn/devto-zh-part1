...
> 原文:[https://dev . to/moxio/on-type-safety-without-generics-and-the-role-of-package-design](https://dev.to/moxio/on-type-safety-without-generics-and-the-role-of-package-design)
...
## [](#extension-and-return-type-hints)扩展和返回类型提示
...
[![Covariance of return types](../Images/631de3e1a556b91c652f37c2b0e51c9f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4jlqlhbR--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wa3h3nhx2lt57eqo0hme.png)
...
## [](#extension-and-parameter-type-hints)扩展和参数类型提示
...
[![Contravariance of parameter types](../Images/5370c7dc235323b7231bea1bf05aec8b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HjNATC9O--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4rm5pmx6ye4xnwo9izab.png)
...
## [](#package-dependency-principles)包依赖原则
...
[![Package dependency cycle introduced by explicitly declaring `FileReader` a subtype of `PhpFileReader`](../Images/e8dbe660593b642c9f5a4f23396b6602.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---F1k63MI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/p3823sakeyjb1ptcymg3.png)
...
## [](#adapter-pattern-to-the-rescue)适配模式救驾！
...
[![Adapting a `FileRule` to a `PhpFileRule`](../Images/e13d9921a4bb6d388b8b0df2eb8a6312.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--GVMsCH7U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/hxr76guv7aacoe6nokur.png)T3】
...
[![Adapting a `PhpFileReader` to a `FileReader`](../Images/f0b36dd7cb40c3624dbf7b1a8258fd36.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--yh5bXOgc--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/9v2ezdhs3qsyrcoqlpxk.png)T3】
...
[![Acyclic package dependencies achieved by introducing adapters](../Images/8b83e09dd23d265ccc8983817b039cd2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--e83R0nDE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/ea7mdsiw8riqser736pi.png)
