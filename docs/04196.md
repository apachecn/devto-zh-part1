...
## [](#gmail-account)Gmail 账户

**不要**使用您的日常 Gmail 帐户。创建一个*扔掉*，因为我们将需要启用**不太安全的应用**。

#### [](#create-a-new-gmail-account)[创建新的 Gmail 帐户](https://www.weckmann.me/posts/node-gmail-api/%22https://accounts.google.com/SignUp%22)。
