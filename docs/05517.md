...
## [](#for-distros-that-use-raw-apt-endraw-)对于使用`apt`的发行版
...
## [](#for-distros-that-use-raw-yum-endraw-)对于使用`yum`的发行版
...
## [](#making-your-own-bootstrap-template)制作自己的引导模板
...
### [](#version-controlling-your-bootstrap-files)版本控制你的引导文件
