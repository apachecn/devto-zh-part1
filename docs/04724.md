...
> 原文:[https://dev . to/ariera/如何使用电子邮件作为用户标识符-in-django-111](https://dev.to/ariera/how-to-use-email-as-user-identifier-in-django-111)
...
#### [](#first-create-your-new-app)首先创建你的新应用
