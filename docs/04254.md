...
> 原文:[https://dev.to/createdd/rate-questions-with-react-and-redux-一个婴儿-例子- 92j](https://dev.to/createdd/rate-questions-with-react-and-redux---a-baby-example--92j)

# [](#rate-questions-with-react-and-redux-a-baby-example-%C3%B0%C3%BF)用 React 和 Redux 评价问题——以ðÿ'为例

[![](../Images/e214873c66f24ed68ab309e80f5e0e7d.png)](https://unsplash.com/photos/s0XDLfhyN34)
...
> ## [](#everything-is-practice-pele)"Everything is practice." -Bailey

## [](#motivation-for-this-article)本文动机
...
#### [](#actions-and-action-creators)动作和动作创建者
...
#### [](#create-the-redux-store)创建 Redux 商店

在 index.js 中创建一个存储，将其传递给主 reducer，并将其包装在记分板组件周围，以便为整个应用程序提供存储。

#### [](#connect-the-container-to-the-store)将容器连接到商店
...
## [](#add-another-component-in-the-redux-app)在 Redux App 中添加另一个组件
...
[![](../Images/7f6d0b9e41a32c8fda75b9bf042e51e4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--X5N7PSnY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/../assets/REDSCORE/Screenshot2.png)
...
[![](../Images/7111185a880ae6ea962a10bdc0aad89b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RdclCf8A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/v1/../assets/REDSCORE/Screenshot1.png)
