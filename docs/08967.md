...
> 原文:[https://dev . to/philnash/always-install-bundler-side-ruby-with-rbenv](https://dev.to/philnash/always-install-bundler-alongside-ruby-with-rbenv)
