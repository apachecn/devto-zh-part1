...
> 原文:[https://dev . to/ggar nier/increasing-productivity-in-tmux-with-single-prefix-key-CIB](https://dev.to/ggarnier/increasing-productivity-in-tmux-with-a-single-prefix-key-cib)
