...
## [](#step-by-step-look-into-raw-gitlabciyml-endraw-)一步步看向`.gitlab-ci.yml`
...
## [](#a-brief-look-into-raw-envgitlabci-endraw-)一探究竟`.env.gitlab-ci`
...
## [](#a-brief-note-on-raw-phpunitgitlabcixml-endraw-)简述`phpunit-gitlabci.xml`
