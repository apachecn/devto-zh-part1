...
> 原文:[https://dev . to/gon sie/converting-from-sublime-text-to-emacs-1 ajj](https://dev.to/gonsie/converting-from-sublime-text-to-emacs-1ajj)
...
## [](#syncing-between-machines)机器间同步
...
## [](#closing-parenthesis-insertion)右括号插入
...
# [](#the-best-from-sublime-text)最精彩的来自崇高的文字
...
# [](#things-that-never-really-worked-in-st)在圣
...
## [](#basics-syntax-amp-outlining)基础语法&概述
...
#### [](#example-1-shell-command)例 1: Shell 命令
...
#### [](#example-2-generate-and-embed-an-image)例 2:生成并嵌入图像
...
[![](../Images/93c0d6f174c8dc030c86712743f0b2f5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---50O0DeL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/http://www.gonsie.com/blorg/images/example_dot.png)
