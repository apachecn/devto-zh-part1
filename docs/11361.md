...
# [](#percolation-and-the-threshold)逾渗和阈值
...
[![percolate.png](../Images/1a7d33e405c9a0ade073a055d41a6584.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--l6bZoOtg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.nilbot.net/img/percolation.png)

我们观察到，在某个`p`以上，系统最有可能渗透。这个临界阈值`p`叫做逾渗阈值。它似乎是一个常数，依赖于晶格结构。

[![percolate_threshold.png](../Images/98c82a315137157da9dc4b0c5a11dfe2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--OfzQU6Bt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://blog.nilbot.net/img/percolation-probability.png)
...
## [](#construction-and-union-find)构造和联合查找
...
# [](#result-and-benchmarks)结果和基准

## [](#run-test-and-benchmark)运行测试和基准测试
