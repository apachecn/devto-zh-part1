...
## [](#working-with-asynchronous-code)处理异步代码
...
## [](#pattern-2-from-components)模式二。从组件
...
## [](#pattern-3-from-vuex-actions)花样三。来自 Vuex 操作
...
## [](#pattern-4-from-route-navigation-guards)模式四。来自路线导航警卫
...
## [](#pattern-5-from-a-service-module)花样五。从服务模块
...
## [](#pattern-6-serverrender-initial-page-state-instead-of-using-ajax)模式六。服务器呈现初始页面状态，而不是使用 AJAX
