...
> 原文:[https://dev . to/borisschapira/optimize-images-to-reduce-page-weight-file-formats-tools-and-rwd-8 G2](https://dev.to/borisschapira/optimize-images-to-reduce-page-weight-file-formats-tools-and-rwd-8g2)
...
## [](#for-each-image-its-format)为每幅图像设定其格式

找到最合适的图像格式并不容易。以我们的标志为例。我们可以把它存成 PNG，JPEG，WebP 或者 SVG。图像的权重会非常不同。一个经验测试让我们可以将它形象化:

[![PNG 6 Ko ; JPEG 38KB ; WebP 9KB ; SVG 2.5KB (1.4KB gzipped)](../Images/4b114dfc06bb55dbde44695f728dc44c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--n7V0ssIu--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/smqpwgo11d868cd6xjgv.png)
...
[![PNG: 171 KB; JPEG: 33 KB; WebP: 13KB](../Images/694efa99dabe86cad6b0bcedd42cc5f7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--oJm0_saS--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/4jf9l923qh8ieyyeyam9.jpg)
...
[![Original JPEG: 33BP. Optimized JPEG: 16KB. Not much differences.](../Images/728a79983c228ee67af657813a95e549.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--MX8PcunY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/zz196ix3pzvzrxg79uo6.jpg)

如上所示，选择一种格式并不简单，也不是所有的格式都适合所有的图像。再解释一点吧…

## [](#how-to-choose-the-right-image-format)如何选择合适的图像格式？

最终，所有的图像都以同样的方式出现在屏幕上:一个由几个不同颜色的点组成的矩形。但是图像不一定像那样记录在磁盘上。每种图像文件格式都依赖于不同的视觉信息编码技术。为了选择正确的文件格式，您需要问自己几个问题:

### [](#what-does-my-image-represent)我的形象代表什么？
...
### [](#reduce-the-weight-of-images-by-sacrificing-information)通过牺牲信息来降低图像的权重
...
### [](#why-dont-you-talk-about-gif)为什么不谈 GIF？
...
## [](#serve-the-right-file-size-regarding-to-the-context)根据上下文提供合适的文件大小
...
[![Capture of Chrome Dev Tools](../Images/68e9303289bcdbd14376f3594840e1cc.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--eUDgflVM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/wy4a28lom4cvih3xnrvr.png) 
...
## [](#lazyload-what-you-can-with-or-without-visual-effect)【懒人加载】能加载什么就加载什么(有没有视觉效果)
...
[![Progressive image loading: while images are loading, a fuzzy silhouette occupies the space](../Images/29179247510650c7f564227f0db1f64c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--YrDZhhGB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/nd3xmj6up4n5gjnk5gxk.gif)

## [](#reduce-the-number-of-images-with-an-image-stack)用图像堆栈减少图像数量
