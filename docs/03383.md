...
> 原文:[https://dev . to/idoko/building-for-Android-super users-let-extract-wifi-passwords-3hp](https://dev.to/idoko/building-for-android-superusers-lets-extract-wifi-passwords-3hp)
...
#### [](#what-is-libsuperuser)什么是 lib 超级用户？
