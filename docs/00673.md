...
> 原文:[https://dev . to/ivanosipov/kot Lin-DSL-从理论到实践-6h7](https://dev.to/ivanosipov/kotlin-dsl-from-theory-to-practice-6h7)
...
### [](#getset-method-conventions)获取/设置方法约定
...
### [](#destructuring-declarations)析构声明
