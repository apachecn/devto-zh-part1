...
> 原文:[https://dev . to/damcosset/setting-up-a-replica-set-in-MongoDB](https://dev.to/damcosset/setting-up-a-replica-set-in-mongodb)
...
## [](#setting-up-a-replica-set)设置副本集
