...
> 原文:[https://dev . to/Victoria/iterating-over-objects-and-arrays-frequency-errors](https://dev.to/victoria/iterating-over-objects-and-arrays-frequent-errors)
...
或者像这样:
[![Breakfast object.](../Images/5d0e982601fc5180384cbe4ace5b9020.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--CfMeHaCG--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/yo2at457s4ctf8spy6wo.jpg)

## [](#iterate-over-object-properties)迭代对象属性
...
## [](#get-object-property-value)获取对象属性值
...
## [](#get-object-property-from-the-value)从值中获取对象属性
...
## [](#alter-nested-property-values)改变嵌套属性值
...
或者像这样:
[![Waffle array.](../Images/1a99ff0aa8984ca113e8598ec5bb0b06.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--ylNB8Dhg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/xrezq0xpzvn4t1bk3x3o.jpg)
...
## [](#access-array-item-by-index)按索引项访问数组
...
## [](#ways-to-get-mixed-up-over-arrays)混合数组的方法
