...
# [](#aws-and-naip-content)AWS 和 NAIP 内容
...
# [](#step-1-build-docker-image)第一步:构建 Docker 映像
...
# [](#step-2-configure-aws-batch)第二步:配置 AWS 批量

现在我有了一个工作脚本来构建在 Docker 容器中运行的缩略图，并将 Docker 图像推送到图像存储库，让我们配置 AWS Batch 来运行批处理作业。

第一步是配置计算环境。这将配置实例类型、安全组、网络、扩展策略和配置模型。

[![Create Compute Environment](../Images/159f0019b5ad81694c58a946e8ba3ceb.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--NVbPw8vo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047632619/o-21Km2Gg.png)

[![Configure Compute Environment](../Images/f2ae55e9dbbeda76aa713b1baf133ec8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--BvKW60Je--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047664749/mV-L8e25T.png)
...
[![Create Job Queue](../Images/9b133e4caba78ffb56a810a166762337.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--4lgvql7N--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047730037/PTIUFQwzt.png)

最后，是时候创建一个作业定义来使用步骤 1 中构建的 Docker 映像构建缩略图了。

[![Create Job Definition](../Images/6611b039599578895438e26e38522fb0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--5BywM1Mt--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047768635/pWR043Iae.png)
...
[![Jobs](../Images/3dec42ca9dedc21c710398b824e8ecdc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--qPp8H1Tg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047886155/nf1rA4Zh1.png)

我可以监视这些作业在挂起、可运行、可启动、运行和最终成功状态之间的移动。

# [](#step-4-index-naip)第四步:索引 NAIP

最后一步是配置 Voyager 来索引 NAIP，并适当地设置缩略图。要索引 NAIP 数据，请创建一个新的云存储位置，并将缩略图策略设置为不构建图像。因为我在外部构建缩略图，所以我不想让航海家构建缩略图。

[![Configure Thumbnails](../Images/15fb2b7d78de544da13517efab2fce52.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--yw7kZ6ML--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047923809/KjGCsOkGP.png)

现在，我可以使用管道步骤来设置 NAIP 拇指的外部 URL。Voyager 的索引管道提供了在将数据记录添加到索引时转换和操作数据记录属性(元数据)的功能。使用 Python 可以轻松开发管道步骤。

[![Pipeline Configuration](../Images/1fe2f6dbb7baa99ff0230a98d426b7c8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Di63sOj5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654047949662/SnwFxXg-d.png)
...
[![Search Results](../Images/0c01bc5a406f005ba9819aa0cfee2423.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9qJrblXn--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn.hashnode.com/res/hashnode/image/upload/v1654048038992/-C8pNtnYu.png)
