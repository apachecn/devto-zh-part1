...
> 原文:[https://dev . to/KMA schta/configurable-artifacts-how-to-deploy-like-a-pro-4 fhk](https://dev.to/kmaschta/configurable-artifacts-how-to-deploy-like-a-pro-4fhk)
...
## [](#what-is-a-deployment-artifact)什么是部署神器
...
## [](#the-example-project-a-basic-proxy)示例项目:基本代理
...
### [](#deploying-to-several-environments)部署到多个环境
...
## [](#when-you-should-use-artifactbased-deployment)什么时候应该使用基于工件的部署
...
[![xkcd: Is it worth the time?](../Images/09bb69c0bfcd8f3864aea07de038c826.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--a2YLrk7w--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://imgs.xkcd.com/comics/is_it_worth_the_time.png)
