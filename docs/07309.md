...
> 原文:[https://dev.to/horia141/raynor-5500](https://dev.to/horia141/raynor-5500)
...
# [](#building-marshallers-for-classes)为类构建编组器
...
# [](#more-from-the-annotations-toolkit)更多来自注解工具包
...
# [](#extending-annotation-marshallers)扩展注释编组器
...
# [](#advanced-raisebuildfilter-marshallers)高级:RaiseBuildFilter 编组器
...
## [](#background-inspiration-etc)背景、灵感等。
