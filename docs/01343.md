...
> 原文:[https://dev.to/chrisvasqm/e2e-testing-with-testcafe-17jl](https://dev.to/chrisvasqm/e2e-testing-with-testcafe-17jl)
...
#### [](#great-job-we-are-almost-ready-to-start-)干得好！我们差不多准备好出发了👨‍💻 /👩‍💻。

## [](#choose-your-weapon-ideeditor)选择你的武器(IDE/editor)
...
### [](#why-do-we-use-raw-async-endraw-)我们为什么要用`async`？

这将允许我们在*并行*中运行我们的测试(这太棒了！)后来。但是现在，我们将在一个浏览器中运行我们的测试。

#### [](#where-is-the-real-magic-at)真正的魔力在哪里？

#### [](#why-did-we-raw-import-endraw-the-raw-selector-endraw-class)我们为什么要上`import``Selector`班？
...
### [](#we-can-continue-on-the-next-part)我们可以继续下一部分:

[![chrisvasqm](../Images/e4a5dffbeebdbe975aabe7903c567401.png)](/chrisvasqm) [## 使用 TestCafe | Pararell 执行的 E2E 测试
