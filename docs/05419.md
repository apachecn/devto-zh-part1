...
> 原文:[https://dev . to/ravenous _ baboon/checking-if-the-column-was-updated-inside-SQL server-update-trigger](https://dev.to/ravenous_baboon/checking-if-the-column-was-updated-inside-sqlserver-update-trigger)
