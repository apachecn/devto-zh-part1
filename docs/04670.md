...
> 原文:[https://dev . to/Amit _ merchant/essential-vanilla-JavaScript-functions](https://dev.to/amit_merchant/essential-vanilla-javascript-functions)

# [](#essential-vanilla-javascript-functions)基本的普通 JavaScript 函数

> 一些普通形式的 JavaScript 中缺失的函数(灵感来自 [PHP](https://en.wikipedia.org/wiki/PHP) )。你可以把它当作编程练习来尝试。

# [](#array-functions)数组函数

## [](#-raw-arrayunique-endraw-)`array_unique()`
...
## [](#-raw-arraymerge-endraw-)`array_merge()`
...
## [](#-raw-arraychunk-endraw-)`array_chunk()`
...
## [](#-raw-arraycollapse-endraw-)`array_collapse()`
...
## [](#-raw-arraydiff-endraw-)`array_diff()`
...
## [](#-raw-arrayintersect-endraw-)`array_intersect()`
...
## [](#-raw-arrayreject-endraw-)`array_reject()`
...
## [](#-raw-arraysplit-endraw-)`array_split()`
...
## [](#-raw-arraytake-endraw-)`array_take()`
...
## [](#-raw-chunksplit-endraw-)`chunk_split()`
...
## [](#-raw-similartext-endraw-)`similar_text()`
