# 专注于一个你完全理解的问题，即使是一个小小的利基问题——独立黑客上的 Bugfender

> 原文：<https://dev.to/bugfenderapp/focus-on-a-problem-you-fully-understand-even-if-it-is-a-tiny-niche---bugfender-featured-on-indie-hackers>

[![](img/2349840e5d63e3b087cba6202899e581.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wAC9PpKJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://mobilejazz.com/blog/wp-content/uploads/2017/07/indie-hackers-1.jpg)

Bugfender 的联合创始人 Stefan Klumpp 解释了他的开发团队如何将他们自己的内部工具转变为面向开发人员的 SaaS 产品。现在它每个月的收入是 6500 美元。

这个帖子最初出现在[独立黑客](https://www.indiehackers.com/businesses/bugfender)上。
...
在内部，我们做了很多[开源产品](https://mobilejazz.com/products/opensource)并构建内部工具，其中一些变成了[实际产品](https://mobilejazz.com/products)。其中一个产品是 [Bugfender](http://bugfender.com/) ，这就是我今天要讲的。
...
[![](img/0ea69e1b773cb22936a279b552fec70f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pc1vCysI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.indiehackers.cimg/content/bugfender__website.png)
...
[![Bugfender Timeline](img/42871e51042188aa4c231a136e39415f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ywb8tCqo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.indiehackers.cimg/content/bugfender__timeline.jpg)
...
我们投入了自己的时间和金钱(3 位创始人)，并获得了 9 万欧元(略高于 10 万美元)的欧盟拨款:
...
我们的数据主要存储在[亚马逊极光](https://aws.amazon.com/rds/aurora/)和[弹性搜索](https://www.elastic.co/products/elasticsearch)中。我们还使用 [Redis](https://redis.io/) 进行缓存。我们使用 [Baremetrics](https://baremetrics.com/) 作为业务指标，使用 [Stripe](https://stripe.com/) 作为支付处理，使用 [Intercom](https://www.intercom.com/) 作为支持。这些产品为我们节省了几十个小时的开发时间。

我们的软件目前托管在[亚马逊网络服务](https://aws.amazon.com/)上，尽管我们正在研究[谷歌云平台](https://cloud.google.com/)。
...
*   我们不会简单地赞助会议和播客，我们会做会议和播客。我们有很多有价值的知识要分享，也有很多有趣的故事要讲。
...
有趣的是，开发者是我们的用户和推广者，但是真正的客户(为 Bugfender 付费的人)是他们的老板或公司。所以他们可能会自己使用 Bugfender 的免费版本(业余爱好项目)，但会为他们工作的公司推荐付费版本。
...
[![Bugfender Illustration](img/73e5c113e338ce9f6f7939882f0f011b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1HNIZ-0z--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.indiehackers.cimg/content/bugfender__cartoon-demo.jpg)
...
然而，作为一家总是有超过其处理能力的工作的公司，很难决定将我们的资源分配到哪里现有的盈利业务？还是投入到新的实验中，比如 [Bugfender](http://bugfender.com/) ？如果我们知道 Bugfender 会如此成功，我们会更早投入更多资源。另一方面，我们并不匆忙，我们更喜欢以正确的方式做事，即使这会慢很多。
...
不仅仅基于直觉，而是基于我们自己的实际需求来构建产品，这无疑是有帮助的。我们用 [Bugfender](http://bugfender.com/) 服务的是一个小众市场，但我们 100%理解这个问题，并以合理的价格提供一个完美的解决方案。
...
资源:加布里埃尔·温伯格(Gabriel Weinberg)和贾斯汀·马雷斯(Justin Mares)写的《牵引力》(T1)是一本很好的概述营销渠道的书。除此之外，我只是阅读和参与黑客新闻和独立黑客的评论，并在 Twitter 上关注正确的人(例如尼尔·帕特尔、帕特·弗林)。
