...
> 原文:[https://dev . to/hoss ain/Travis-ci-script-for-your-swagger-open API-specification-6kf](https://dev.to/hossain/travis-ci-script-for-your-swagger-openapi-specification-6kf)
...
### [](#adding-travis-ci-build-support-for-openapi-specification)增加对 OpenAPI 规范的 Travis CI 构建支持
