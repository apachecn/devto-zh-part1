...
## [](#1-why-i-implemented-it-in-ruby)1。为什么我用 Ruby 实现它
...
## [](#2-implement-blockchain-in-ruby)2。在 Ruby 中实现区块链
...
### [](#31-preparation-for-run)3.1 运行准备
...
### [](#32-blockchains-state)3.2 区块链的状态
...
### [](#34-add-new-transaction)3.4 添加新交易
...
### [](#35-check-the-blockchains-state)3.5 检查区块链的状态
