...
## [](#setup-windows-subsystem-for-linux)为 Linux 设置 Windows 子系统
...
## [](#setup-terminal-hyper)设置终端- Hyper
...
## [](#setup-ruby-environment)设置 Ruby 环境
