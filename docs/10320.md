...
> 原文:[https://dev . to/raula vila/multi threading-in-Java-for-dummies-part-2](https://dev.to/raulavila/multithreading-in-java-for-dummies-part-2)
...
### [](#version-3-intrinsic-locking)版本 3:固有锁定
...
### [](#version-4-explicit-locks-and-conditions)版本 4:显式锁和条件
...
### [](#bonus-scaling-to-n-players)奖励，缩放至 N 名玩家
