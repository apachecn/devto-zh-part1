...
[![](../Images/5a9f7f9cbc1edd709c4490ab656d1bb4.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--HU5-PXAq--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1000/1%2A1JtGxwOhPIsdkMLgwK7W-g.jpeg)
...
> ![](../Images/04df80ae26041ef073b67f5d31f11251.png)![](../Images/15bdd4e8346d2a40732d0965dbf135e9.png)Addy Osmani@ addyosmani![](../Images/4d9c44713c216584b3d48ff3455cbb68.png)提示:JavaScript 的 Array.from()接受第二个参数，这是一个“map”函数。对于调用您创建的数组的每个元素非常有用。2018 年 1 月 19 日上午 07:30[![Twitter reply action](../Images/269095962147c28351274afdd5486a48.png)](https://twitter.com/intent/tweet?in_reply_to=954254600193769473)[![Twitter retweet action](../Images/771160ecf06ae3d4d7a7815c29c819c2.png)](https://twitter.com/intent/retweet?tweet_id=954254600193769473)468[![Twitter like action](../Images/c077611ab2a5e0b4cd0c826ee7ae1e48.png)](https://twitter.com/intent/like?tweet_id=954254600193769473)1496

从 JavaScript 数组中过滤出重复的值总是一件麻烦的事，你需要遍历数组并自己找出答案，所以 Set 让这变得容易多了。😁

### [](#add-data-to%C2%A0set)向集合添加数据

有几种方法可以将数据添加到集合中。

### [](#pass-as-parameter)作为参数传递
...
### [](#add-data-by-the-add%C2%A0method)通过 Add 方法添加数据
...
### [](#check-values-inside-set-with-has%C2%A0method)用 has 方法检查集合内的值
...
### [](#remove-data-from-the%C2%A0set)从集合中删除数据

向集合中添加数据非常简单，但是从集合中删除数据也同样简单。

### [](#remove-data-with-delete%C2%A0method)用删除的方法删除数据
...
### [](#remove-all-data-with-clear%C2%A0method)用清除的方法清除所有数据
...
### [](#check-the-number-of-items-with-the-size%C2%A0property)用 size 属性检查项目的数量
...
### [](#filter-duplicate-primitive-values)过滤重复的原始值
...
### [](#filter-duplicate-nonprimitive-values)过滤重复的非原始值
...
### [](#loop-with-foreach%C2%A0method)用 forEach 方法循环
...
### [](#loop-with-forof-loop%C2%A0method)循环采用 for-of 循环法
...
### [](#difference-between-set-and%C2%A0map)集合与地图的区别
