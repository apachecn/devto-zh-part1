...
> 原文:[https://dev.to/kayis/crawling-websites-in-react-native-38b](https://dev.to/kayis/crawling-websites-in-react-native-38b)
...
### [](#1-get-the-html-from-the-server)1 从服务器获取 HTML
...
### [](#2-extract-the-needed-data-from-the-html)2 从 HTML 中提取需要的数据
...
### [](#3-reshape-the-data-for-further-use)3 重塑数据以备后用
