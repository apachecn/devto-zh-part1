...
> 原文:[https://dev . to/michaeljota/widgets-and-components-for-angular-2-and-up](https://dev.to/michaeljota/widgets-and-components-for-angular-2-and-up)
...
[![I reject nature](../Images/fac0719b4caaa5252237f8a1f749985b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Six_2jxO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgflip.com/1l5mqr.jpg)
...
### [](#what-widgets-should-be)应该是什么 widgets
...
##### [](#why-another-name-then)那为什么另起一个名字呢？

正如我所说，Angular community 中的*组件*已经被用于开发由*管理*信息的网页。

##### [](#why-called-them-widgets)为什么叫它们 *widgets* ？
