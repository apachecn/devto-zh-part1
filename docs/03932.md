...
> 原文:[https://dev.to/psnebc/sudo-apt-get-install-vim-gtk-7c7](https://dev.to/psnebc/sudo-apt-get-install-vim-gtk-7c7)

```
patrick@patrick-vbox ~ $ sudo apt-get install vim-gtk
...
After this operation, 3.048 kB of additional disk space will be used.
Get:1 http://ppa.launchpad.net/jonathonf/vim/ubuntu xenial/main amd64 vim-gtk amd64 2:8.0.0627-0york1~16.04 [1.266 kB]
Fetched 1.266 kB in 9s (140 kB/s)                                                                                  
Selecting previously unselected package vim-gtk.
(Reading database ... 220613 files and directories currently installed.)
Preparing to unpack .../vim-gtk_2%3a8.0.0627-0york1~16.04_amd64.deb ...
Unpacking vim-gtk (2:8.0.0627-0york1~16.04) ...
Setting up vim-gtk (2:8.0.0627-0york1~16.04) ...
