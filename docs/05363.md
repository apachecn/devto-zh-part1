...
> 原文:[https://dev.to/samueleresca/web-assembly-in-aspnet-core](https://dev.to/samueleresca/web-assembly-in-aspnet-core)
...
## [](#deepdive-into-web-assembly)深入 web 组装

WebAssembly 是一种获取用 JavaScript 之外的编程语言编写的代码并在浏览器中运行这些代码的方法。

#### [](#about-interpreters-and-compilers)关于解释器和编译器
...
#### [](#finally-web-assembly)最后，Web 组装
...
### [](#web-assembly-vs-javascript)Web 组装 vs Javascript
...
## [](#web-assembly-in-aspnet)在 ASP.NET 组装网页
...
好吧，说真的？你是否在你的网页上发布了一个完整的. net 核心库？！[![Web assembly in ASP.NET Core](../Images/18921394aa893da6518c55cd1fb33b0e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--plnyAq44--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://samueleresca.net/wp-content/uploads/2017/08/Capture.png)
