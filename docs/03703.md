...
> 原文:[https://dev . to/simple steph/how-to-use-Apache-Kafka-to-transform-a-batch-pipeline-to-a-real-time-one-a3p](https://dev.to/simplesteph/how-to-use-apache-kafka-to-transform-a-batch-pipeline-into-a-real-time-one-a3p)
...
# [](#the-challenge-well-solve)我们将解决的挑战
...
[![A review prompt on Udemy](../Images/55cfe796053bc7381269641efa76d2ec.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jGAhL5hh--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1200/1%2Aeeonz3zalxwpyHQEX1A9ow.png)

课程页面可能需要再过**几个小时**才能更新为新的点评数和平均评分。听起来好像某个地方正在运行一个每日计划的批处理作业！

[![Screenshot of the statistics for the Apache Kafka for Beginners course](../Images/b0f374698b86a53f29399649b5af8f96.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--XftBMQS5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A-htAkNXa78Aj1_4CUltwkQ.png)
...
[![A typical representation of a Pub/Sub system](../Images/e8561c90a8e4868c3fd3978fbd252341.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TzVbbeLg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A2qLyGs46KHEd2gMLYy4i6A.png)
...
# [](#the-reviews-processing-batch-pipeline)审核处理批处理流水线
...
[![Personal assumptions of current pipeline. Looks familiar?](../Images/5bd5b7285d074ea05d535052d5376bcd.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aipVnlF3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2Af0G_rU6ITJj_GYRD-1y0jg.png)
...
[![Gentle Reminder](../Images/e8561c90a8e4868c3fd3978fbd252341.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--TzVbbeLg--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2A2qLyGs46KHEd2gMLYy4i6A.png)
...
[![target Architecture for our Real-Time Pipeline. Every color is a micro service](../Images/91658877f411e045a9e5a4087ad66180.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j4nzdbZE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AA3he5ns9XnjY_qJs_ZxkZA.png)

现在，我们对端到端实时管道有了清晰的了解，看起来我们还有很多工作要做。我们开始吧！

# [](#1-reviews-kafka-producer)1)评论卡夫卡的制片人

为了获得评论数据，我将使用提供的 [![external REST API Udemy](../Images/b312b51909bd3598be2b67f40e7205e9.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--H1Ri2Fgv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://www.udemy.com/developers/methods/get-coursereviews-list/) 来获取一个课程的现有和已发布的评论列表。
...
](../Images/ed3b76d8973d58d066c768e1f6ff6b17.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--1OsquWd2--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AuIqgh-Lt5xSio9nDIcfnHA.png)
...
## [](#fetching-udemy-reviews)抓取 Udemy 评论
