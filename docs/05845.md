...
> 原文:[https://dev.to/sergiodxa/introducing-grial](https://dev.to/sergiodxa/introducing-grial)

## [](#creating-a-graphql-api-with-nodejs-easily)用 Node.js 轻松创建 GraphQL API
...
## [](#lets-code-an-api)我们来编码一个 API 吧！
