...
> 原文:[https://dev . to/nrobinson 2000/how-to-develop-particle-locally-using-po-util](https://dev.to/nrobinson2000/how-to-develop-particle-locally-using-po-util)

> Particle Web IDE、Particle Dev 和 particle-cli 并不是编程粒子设备的唯一方式。

[![](../Images/ff31a1311071510cd6815674eeef0235.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--6U86s6cr--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cehs.github.io/images/po-util-updated.svg)

## [](#what-is-poutil)什么是 po-util？
...
#### [](#poutil-offers-many-features-including)Po-util 提供了许多功能，包括:
...
## [](#creating-a-project-with-poutil)用 po-util 创建项目
...
## [](#poutil-project-structure)Po-util 项目结构
...
## [](#using-poutil-with-atom)使用 po-util 与 Atom
...
## [](#configuring-your-devices-to-work-with-poutil)配置您的设备以使用 po-util
...
## [](#using-particle-libraries-with-poutil)使用带有 po-util 的粒子库
...
## [](#sharing-a-poutil-project)共享一个公共工程
...
## [](#more-poutil-information)更多实用信息
