...
> 原文:[https://dev . to/borisschapira/defer-scripts-to-speed-up-rendering-3pml](https://dev.to/borisschapira/defer-scripts-to-speed-up-rendering-3pml)
...
## [](#distinguish-critical-and-noncritical-js)区分关键和非关键 JS
...
## [](#move-noncritical-scripts-at-the-bottom-of-the-page)将非关键脚本移动到页面底部
...
## [](#how-about-injecting-a-dynamic-raw-ltscriptgt-endraw-tag)注入一个动态`<script>`标签怎么样？
...
[![Capture of the Chrome DevTools Performance tab. A loading timeline displays the different steps in different colors. The entire range of blue is before the yellow one. A first image appears very early in the loading process.](../Images/3442afa6f345d1216fb8294d7447767e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--KJF7OyCL--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qwjoqlpln53pd3eyuqh8.png)
...
## [](#loading-javascript-files-get-the-control-back-even-on-thirdparty-scripts)加载 JavaScript 文件:取回控制权，即使在第三方脚本上
