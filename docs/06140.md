...
> 原文:[https://dev . to/Oliver cole/terra forming-AWS-a-server less-website-back end-part-3](https://dev.to/olivercole/terraforming-aws-a-serverless-website-backend-part-3)
...
#### [](#manually-setup-mailgun-dns-records)手动设置邮箱 DNS 记录
...
#### [](#setup-mailgun-dns-records-using-terraform)使用 Terraform 设置 Mailgun DNS 记录
