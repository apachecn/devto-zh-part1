...
> 原文:[https://dev.to/mandarbadve/html5-web-storage 网络离线存储解决方案](https://dev.to/mandarbadve/html5-web-storage--offline-storage-solution-for-the-web)
...
### [](#how-to-checkdebug-web-storage-is-working-or-not)如何检查/调试 web 存储器是否工作？

浏览器的开发工具将显示存储在网络存储器中的数据。下图来自 w3schools.com，描述了网络存储的位置。

[![HTML5 web storage – offline storage solution for the web](../Images/75fc17b7b41fcc5f4cfc306ac5792bed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--vXP0JtrB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/jhrmyjsb7kdx505iilkt.png)
