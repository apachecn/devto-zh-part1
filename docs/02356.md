...
> 原文:[https://dev . to/5 chdn/the-ether eum-区块链-size-将不超过-1tb-anytime-soon-58a](https://dev.to/5chdn/the-ethereum-blockchain-size-will-not-exceed-1tb-anytime-soon-58a)
...
[![Some chart](../Images/4fa59a0f8c4b54031f620bc3a41869e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SHFjkIkC--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/A5tl3oY.png)
...
### [](#on-blocks-blockhistory-states-and-statehistory)关于块、块历史、状态和状态历史
...
### [](#understanding-pruningmodes-and-syncmodes)了解修剪模式和同步模式
...
[![Pen and paper.](../Images/02d1d0427d62ccaea5e0eeb0177047ed.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--sKqnhWld--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/xRfwjsM.png)
...
### [](#so-whats-the-minimum-size-of-a-fullverified-node)那么，一个全验证节点的最小尺寸是多少？
...
### [](#the-full-picture-9-parity-configurations-compared)全图:9 种奇偶校验配置对比

下面是我的彩色电子表格的截图，试图区分不同奇偶校验操作模式的节点安全性。

[![The full picture.](../Images/22d8acb6e5d14510731986fc64999d4b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--olSg-8JO--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.stack.imgur.com/2cPjk.png)
