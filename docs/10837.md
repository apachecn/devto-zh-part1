...
[![](../Images/52cd50748717df9aa0211746ba717853.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--xpUUZ-pU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/811/0%2AwHh61Ifp5OlcT_-p.png)
...
### [](#http-headers-for%C2%A0svgzfiles)HTTP 头为。svgz 文件
...
### [](#contentencoding-vs-transferencoding)内容编码与传输编码
...
### [](#serving-compressed-files-for%C2%A0download)提供压缩文件供下载
