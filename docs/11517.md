...
> 原文:[https://dev.to/ladvien/metallurgy-101-avr-uart-3ml6](https://dev.to/ladvien/metallurgy-101-avr-uart-3ml6)
...
*   **第 10 行:**这为 UART 波特率寄存器(UBBR)创建了一个宏。该数值可以使用[数据表](http://www.atmel.comhttps://ladvien.com/images/Atmel-8303-8-bit-AVR-Microcontroller-tinyAVR-ATtiny1634_Datasheet.pdf)第 148 页的公式计算。应该是:UBBR =((CPU _ SPEED)/16 * DESIRED _ BAUD)-1。对我来说，我想把我的速率设为 9600，因此:UBBR = (8，000，000/16 * 9600)-1；或者:UBBR = (8，000，000/153，600)-1 = **51.083。* *它可能有微小的误差，因为我们不能使用浮点数，所以我四舍五入到 51。 [![](../Images/5bf370ebcbf677beec1595b30d8a6301.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--R1yP715U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/BAUD_CALC.png)
...
*   仍在初始化中，**线 19** 使能 RX0 和 TX0 引脚(分别为 PA7 和 PB0)。我还没有使用 TX0 引脚，但我想我也可以启用它，因为我以后会用到它。【T2![](../Images/6497acdaa4f18ee78c491ce22da023f8.png)

*   第 21 行设置这些位来告诉 Tiny1634 我们想要什么样的通信。我们需要 8 位，非奇偶校验，1 个停止位。使能 USBS0、UCSZ00 和 UCSZ01 可以得到这些值。 [![](../Images/91cb6c308ed2375437e49199b1f45c15.png)](https://res.cloudinary.com/practicaldev/image/fetch/s--2WvOUQK---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/UCSR2.png) 。
...
[![](../Images/0e0ef05fb661f60931fe8e7a4ebf9ded.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--wqI4Qzu0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/ATtiny1634_A_0.png)
...
[![](../Images/81bdfa37886d3d6e2cf7dea73941547b.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--UOvpg5ts--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/ATtiny1634_ALABTU_NO_CRLF_0.png)
...
[![](../Images/cb53a613e0c249704c1919f73e4ea011.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--C5oZuaKz--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/ATtiny1634_ALABTU_WITH_CRLF.png)
...
因此，我查阅了 ATtiny1634 的[数据表](http://www.atmel.comhttps://ladvien.com/images/Atmel-8303-8-bit-AVR-Microcontroller-tinyAVR-ATtiny1634_Datasheet.pdf)(第 168 页)，发现 ATtiny1634 有一个中断，每当 RX 数据缓冲区满时就会触发。要激活该中断，我们必须做两件事，启用全局中断并设置 UCSR0B 寄存器的 RXCIE0 位。这看起来很直接，但我找到了一个 [AVR 怪胎教程](http://www.avrfreaks.net/?name=PNphpBB2&file=viewtopic&t=48188)帮助解释它。
...
[![](../Images/92ce45893334023dae336b1120550646.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--le0v76LT--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/ATtiny1634_ALABTU_WITH_RXI.png)
...
[![](../Images/eb9dc85304037a72fb47261772fe4e9f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--kuMLt-i5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/UART0_TO_UART1_ATTINY1634.png)
