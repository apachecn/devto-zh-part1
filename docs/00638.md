...
> 原文:[https://dev . to/Apium _ hub/Scala-generics-ii-co 协方差-and-contra variance-in-generics-5 DIB](https://dev.to/apium_hub/scala-generics-ii-covariance-and-contravariance-in-generics-5dib)
...
## [](#gt-invariance-class-parkinga)>不变性:类停车[A]
...
## [](#gt-covariance-class-parkinga)>协方差:类停车[+A]
...
## [](#covariant-and-contravariant-positions)共变和逆变位置
