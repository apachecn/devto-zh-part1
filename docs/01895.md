...
> 原文:[https://dev.to/ykyuen/a-simple-gitlab-ci-example-doe](https://dev.to/ykyuen/a-simple-gitlab-ci-example-doe)

最初发布在[水手长博客](https://blog.boatswain.io/post/a-simple-gitlab-ci-example/)上。

* * *

[![A Simple GitLab CI Example](../Images/14d7b38cce13df924d977290b17d478f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--jAKZHMIl--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/qwwlp4a5dpas0083qrp1.png)
...
#### [](#more-details-on-the-stage-definition)关于阶段定义的更多细节
...
### [](#trigger-the-pipeline)触发管道

只需在主分支上做一些更改，就可以在 **CI / CD - >管道页面**上找到正在运行的管道。

[![The pipeline history](../Images/1151a2f592acd9df3d67c55ff01fd8dc.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s---2xSkBuo--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/o8m5x67wzkra899h42gx.jpg)

#### [](#view-the-stage-in-detail)查看详细阶段

单击管道，您可以读取每个阶段的控制台输出。阶段/作业失败时有用。

[![The stage output](../Images/5f92e442c319826273f171f5fb107de5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t8TKDjE0--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/5k52m2sry9j2kgmgcutp.jpg)

## [](#the-benefits-of-using-gitlab-ci-with-docker)配合 Docker 使用 GitLab CI 的好处
...
## [](#pick-the-suitable-one-but-not-the-perfect-one)挑合适的不挑完美的
