...
> 原文:[https://dev . to/chinchang/how-to-write-better-CSS-in-teams-with-acss-a-dynamic-atomic-CSS-library-1k5j](https://dev.to/chinchang/how-to-write-better-css-in-teams-with-acss--a-dynamic-atomic-css-library-1k5j)
...
#### [](#a-few-conditions-this-article-assumes)本文假设的几个条件:
...
## [](#problem-1-naming-classes-is-difficult)问题#1:命名类很困难
...
## [](#problem-2-selector-strengths)问题 2:选择器的优势
...
## [](#problem-3-what-about-unused-css)问题#3:未使用的 CSS 怎么办？
...
## [](#the-allinone-solution-acss-atomizer)一体化解决方案— ACSS(雾化器)
...
[![Atomic CSS in Web Maker](../Images/dfb783ee6d781703bb224b0b4993ab0c.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--pnOdiFl1--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/800/1%2AP4u1jolSGaNxD_LN7ykQjw.png)
...
### [](#super-easy-updates-and-refactoring)超级简单的更新和重构

转到 HTML 并更改类来更新一些样式。从任何地方移除任何类，而不用担心破坏其他地方的任何东西。

### [](#not-a-byte-of-unused-css)没有一个字节未使用的 CSS😱
...
### [](#no-guidelines-for-new-developers)没有针对新开发者的指南😎
...
### [](#its-same-as-inline-styling-its-bad)和内联造型一样。很糟糕！
