...
> 原文:[https://dev . to/Jeet MP3/spring-session-grails-plugin-part-1-2g C4](https://dev.to/jeetmp3/spring-session-grails-plugin-part-1-2gc4)

[![Fork me on GitHub](../Images/8407139a163848650cee3c86b3c9e5ab.png)T2】](https://github.com/jeetmp3/spring-session)
...
###### [](#redis-store-specific-properties)Redis 存储具体属性
...
###### [](#json-serialization-specific-properties)JSON 序列化的特定属性
...
###### [](#1-create-mixin-for-user)1。为用户创建混音
...
###### [](#2-create-module-class-to-register-mixin)2。创建模块类来注册 mixin
...
###### [](#3-register-my-module-class-with-springsession-plugin)3。用 spring-session 插件注册我的模块类
