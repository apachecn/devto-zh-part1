...
> 原文:[https://dev . to/mostly Jason/top-10-JavaScript-errors-from-1000-projects-and-how-to-avoid-them-3bkh](https://dev.to/mostlyjason/top-10-javascript-errors-from-1000-projects-and-how-to-avoid-them-3bkh)
...
[![Screenshot of javascript error graph](../Images/5aabb0c96603ea71ffa806a6c7d7fe7a.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--9mE8olQM--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/javascript-error-graph.png)

为了便于阅读，每个错误都被缩短了。让我们更深入地研究每一个问题，以确定是什么导致了它，以及如何避免它的发生。

## [](#1-uncaught-typeerror-cannot-read-property)1。未捕获的类型错误:无法读取属性

如果您是一名 JavaScript 开发人员，您可能已经看到过比您愿意承认的更多的错误。当你在一个未定义的对象上读取一个属性或者调用一个方法时，Chrome 就会出现这种情况。你可以在 Chrome 开发者控制台中很容易地测试这一点。

[![Screenshot of Uncaught TypeError: Cannot read property](../Images/47c46a2254b7fa5778447871b3d657b8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--2mUXkfIV--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/cannot-read-property.png)
...
## [](#2-typeerror-undefined-is-not-an-object-evaluating)2。类型错误:“undefined”不是对象(正在计算

这是在 Safari 中读取属性或对未定义的对象调用方法时出现的错误。您可以在 Safari 开发人员控制台中非常容易地测试这一点。这与 Chrome 的上述错误基本相同，但 Safari 使用了不同的错误信息。

[![Screenshot of TypeError: ‘undefined’ is not an object (evaluating](../Images/65b0b99b49295107f6ee5e802649dac0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--w-wgB9C3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/undefined-is-not-an-object.png)

## [](#3-typeerror-null-is-not-an-object-evaluating)3。类型错误:null 不是对象(正在计算

这是在 Safari 中读取属性或对空对象调用方法时出现的错误。您可以在 Safari 开发人员控制台中非常容易地测试这一点。

[![Screenshot of TypeError: null is not an object (evaluating](../Images/0ce926d5bd5c2496572b12b1d62d3d7f.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--ikzeTvDE--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/null-is-not-an-object.png)
...
[![Screenshot of TypeError: null is not an object (evaluating](../Images/4df8088c0d8cb5a4413668fc460b679e.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--RSLB81gA--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/null-is-not-an-object1.png)
...
## [](#4-unknown-script-error)4。(未知):脚本错误
...
## [](#5-typeerror-object-doesnt-support-property)5。类型错误:对象不支持属性

这是在 IE 中调用未定义的方法时出现的错误。您可以在 IE 开发者控制台中测试这一点。

[![Screenshot of TypeError: Object doesn’t support property](../Images/188907c0970e8399d3599a63c4c7529d.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--x4N0TXpU--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/Object-doesnot-support-property.png)
...
## [](#6-typeerror-undefined-is-not-a-function)6。类型错误:“undefined”不是函数

这是在 Chrome 中调用未定义的函数时出现的错误。你可以在 Chrome 开发者控制台和 Mozilla Firefox 开发者控制台中测试这一点。

[![Screenshot of undefined is not a function](../Images/eb14ac2e08ebaf2fdcc66b8550962760.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--t3kW5VOI--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/undefined-is-nota-function.png)
...
## [](#7-uncaught-rangeerror-maximum-call-stack)7。未捕获的范围错误:最大调用堆栈

这是 Chrome 在几种情况下出现的错误。一种是当你调用一个没有终止的递归函数时。你可以在 Chrome 开发者控制台中测试这一点。

[![Screenshot of Uncaught RangeError: Maximum call stack](../Images/7626d8dfa030b8b1f392149c030babf5.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--Pgn0nxUb--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/maximum-call-stack.png)
...
# [](#8-typeerror-cannot-read-property-length)8。TypeError:无法读取属性“length”

这是 Chrome 中出现的一个错误，原因是读取未定义变量的长度属性。你可以在 Chrome 开发者控制台中测试这一点。

[![Screenshot of TypeError: Cannot read property ‘length’](../Images/a7e69b1749b61226317cb8bac73127f0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aewBkr1A--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/cannot-read-property-length.png)
...
## [](#9-uncaught-typeerror-cannot-set-property)9。未捕获的类型错误:无法设置属性

当我们试图访问一个未定义的变量时，它总是返回`undefined`并且我们不能获取或设置`undefined`的任何属性。在这种情况下，应用程序将抛出“未捕获的类型错误无法设置未定义的属性”

例如，在 Chrome 浏览器中:

[![Screenshot of Uncaught TypeError: Cannot set property](../Images/9ebd9d6c2e86f6e31da1ebb8f357ddb7.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--aTGwZA0J--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/cannot-set-property.png)

如果`test`对象不存在，错误将抛出“未捕获类型错误无法设置未定义的属性”

## [](#10-referenceerror-event-is-not-defined)10。ReferenceError:事件未定义

当您试图访问未定义或超出当前范围的变量时，会引发此错误。你可以在 Chrome 浏览器中非常容易地测试它。

[![Screenshot of ReferenceError: event is not defined](../Images/96f00705000143e8d298e298d7e85dba.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--3-VcgieJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://rollbar.com/assets/blog/images/top-10-javascript-errors/event-is-not-defined.png)
