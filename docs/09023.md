...
> 原文:[https://dev . to/Amit _ merchant/building-a-simple-offline-capable-notepad-app-using-service worker](https://dev.to/amit_merchant/building-a-simple-offline-capable-notepad-app-using-serviceworker)
...
## [](#what-is-a-serviceworker)什么是现役军人？
...
## [](#now-lets-talk-about-what-is-a-progressive-web-app)现在，我们来谈谈什么是渐进式 Web App？
