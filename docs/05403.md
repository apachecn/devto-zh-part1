...
## [](#error-codes-that-we%C3%A2-use)我们使用的错误代码

以下错误代码列表满足最常见的现场级错误。

[![alt text](../Images/c99d36585f69da204d2276340eec1754.png "Error codes that we use")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--K0PbkkDm--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/q7hn1zn1rjcqog0ph2iw.png)
