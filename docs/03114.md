...
> 原文:[https://dev . to/arg herna/bash-functions-and-aliases-for-the-beginning-docker-developer-D4](https://dev.to/argherna/bash-functions-and-aliases-for-the-beginning-docker-developer-d4)
...
### [](#above-all-else-be-aware-of-inconsistency)高于一切，要意识到不一致性
...
### [](#naming-functions-and-aliases)命名函数和别名
...
### [](#function-parameter-checking)功能参数检查
...
## [](#how-i-use-functions)我如何使用函数

### [](#shell-into-a-container)外壳装入容器
...
### [](#a-few-more-of-my-favorite-sthingsaliases)几个(更多)我喜欢的 s/东西/别名/
...
## [](#docker-amp-bash-hows)码头工人&狂欢如何
