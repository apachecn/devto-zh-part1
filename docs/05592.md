...
[![](../Images/14463edde35eea49b2a3896bd21b67a2.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--A-N6DRno--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://ladvien.com/images/toothpaste-decision.svg)
...
#### [](#using-and-with-case-when)用和用格当
...
#### [](#using-sum-with-case-when)使用求和时用的格
...
## [](#dynamic-sql-with-paste)带粘贴的动态 SQL()
