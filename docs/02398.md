...
> 原文:[https://dev . to/aurelkurtula/unit-testing-with-jasmine-the-very-basics-74k](https://dev.to/aurelkurtula/unit-testing-with-jasmine-the-very-basics-74k)
...
## [](#the-checklist-of-things-we-need-our-app-to-do)我们需要应用程序做的事情清单
...
## [](#the-basics-of-jasmine-structure)茉莉结构的基本知识
...
### [](#should-add-an-item-test-and-implementation)应增加一项测试和实现
...
### [](#should-delete-an-item-test-and-implementation)应该删除一个测试项并实现
...
### [](#should-mark-item-as-complete-test-and-implementation)应该将项目标记为完成测试和实现
...
## [](#testing-dom-manipulation)测试 DOM 操作
...
### [](#should-initialise-html)应该初始化 HTML
...
### [](#should-trigger-form-and-add-item-to-todo-array)应触发窗体并向 todo 数组添加项
