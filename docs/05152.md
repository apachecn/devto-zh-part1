...
> 原文:[https://dev . to/checkroth/property-testing-why-you-should-generate-test-data](https://dev.to/checkroth/property-testing-why-you-should-generate-test-data)
...
# [](#whats-so-special-about-property-testing)属性测试有什么特别的？
...
# [](#when-shouldnt-i-use-property-testing)当*的时候*我不应该用属性测试吗？
