...
> 原文:[https://dev.to/seizans/mysqlinnodb-字符集- utf8mb4 - 1451](https://dev.to/seizans/mysqlinnodb--charset--utf8mb4--1451)

出于想支持图画文字等理由而使用 utf8mb4。
但是，以前存在只设定为 utf8mb4 的问题。
MySQL 5.7.9 以后已经解决，所以总结其内容。

## [](#charset-%E3%82%92-utf8mb4-%E3%81%AB%E3%81%99%E3%82%8B)字符集を utf8mb4 にする
