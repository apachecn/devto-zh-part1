...
> 原文：<https://dev.to/edoverflow/github-for-bug-bounty-hunters--gmn>
...
像往常一样，当涉及到臭虫赏金猎人，通读该计划的政策。很少有程序通过 GitHub 接受报告。联系安全团队，或者如果可能的话使用一个 bug bounty 平台，比如 [HackerOne](https://www.hackerone.com/) 或者 [Bugcrowd](https://www.bugcrowd.com/) 。
