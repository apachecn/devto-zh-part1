...
## [](#step-1-one-in-a-row)第一步:连续一个

让我们简化我们的要求。对于第一步，我们只做一个圆，随机选择它的颜色，并且在所有的点都在鼠标的位置上。

[![One randomly colored circle](../Images/ea716e0a338135121474b7d4249d06f1.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--LbtyY0eB--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://assertnotmagic.com/img/rainbow-example1.gif)
...
[![Pallette for this project](../Images/ae1cd1a147466b09f34f89d9a3ba32e0.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--j-LorDfy--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://assertnotmagic.com/img/rainbow-pallete.png)

(有趣的事实是，如果你像我一样不擅长将颜色组合在一起，你可以使用 Coolors 应用程序创建一些很棒的调色板)。

## [](#step-2-keeping-track)第二步:跟踪
...
## [](#step-3-keeping-track-with-objects)第三步:跟踪物体
...
[![Final product](../Images/0c98b5a44e467a0035dceee2f0fa23a8.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--tDzPdIc9--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://assertnotmagic.com/img/rainbow-final.gif)
