...
## [](#creating-your-own-nodejs-modules)创建自己的 Nodejs 模块
...
# [](#moduleexports-vs-exports)模块导出与导出
...
## [](#troubleshooting-raw-import-endraw-and-raw-require-endraw-issues)故障排除`import`和`require`问题

### [](#experimental-flag)实验旗
...
### [](#file-extension-mjs-vs-js-or-cjs)文件扩展名。mjs vs .js(或者。cjs)
