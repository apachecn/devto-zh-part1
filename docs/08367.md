...
[![alt text](../Images/510488e904d3849b5cca9aeea3b5b549.png "Service Categories")](https://res.cloudinary.com/practicaldev/image/fetch/s--43g1EV8U--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AkpFPprKFjIMYgXUOeg0K9g.png)
[![alt text](../Images/0c404225470fa2c8fbe4e52a92e10fd6.png "Breakup of 874 domains acrossÂ services")T6】](https://res.cloudinary.com/practicaldev/image/fetch/s--CwSz2GOJ--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2ABTMikNH-OgX5ENwtKPJkoA.png)

虽然一些服务在政策更新等方面更加以信息为中心，但也有一些网站每天都在处理用户信息，例如:、、收入和税收服务、公民身份和签证、等。

从服务列表中，我们分析了 874 个采用 HTTPS 协议的有效域。我们的发现是:

#### [](#a-31-have-a-valid%C3%A2-https)答:31%的人有有效的 HTTPS

#### b . HTTPS 只有 7.4%违约

#### [](#c-less-then-15-have-hsts%C3%A2-enabled)c .小于 1.5%启用了 

#### d .

[![alt text](../Images/69e47563ec755de9ee3f4d851a5b7def.png "HTTPS adoption across service categories")T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--SNcWdLO5--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1600/1%2AW3P-IpdP5nch4hPOMDrpbA.png)
...
## [](#prologue-on-https-or-why-is-it-important%C3%A2-)关于 HTTPS 的开场白或者说它为什么重要？
...
## [](#resources-and-tips-for-deploying-https-by-default)默认情况下部署 HTTPS 的资源和提示
...
## [](#next-steps-and-todos)后续步骤和待办事项
