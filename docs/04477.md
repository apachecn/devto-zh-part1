...
> 原文:[https://dev.to/mushketyk/python-data-structures-idioms-6ae](https://dev.to/mushketyk/python-data-structures-idioms-6ae)

作为开发人员，我们大部分时间都花在编写操纵基本数据结构的代码上:遍历列表、创建地图、过滤集合中的元素。因此，了解如何在 Python 中有效地做到这一点并使您的代码更具可读性和效率是非常重要的。

# [](#using-lists)使用列表

## [](#iterate-over-a-list)遍历一个列表
...
这是可行的，但是 Python 提供了一种更方便的方法来使用[](https://docs.python.org/2/library/functions.html#range)**函数。**范围**功能可用于生成从 0 到 N 的数字，这可用作 C:
中循环的**模拟****
...
## [](#iterate-over-a-list-in-reverse-order)以相反的顺序遍历列表
...
## [](#access-the-last-element)访问最后一个元素
...
## [](#use-lists-comprehensions)使用列表理解
...
## [](#use-allany-functions)使用全部/任意功能
...
# [](#do-not-create-unnecessary-objects)不要创建不必要的对象

## [](#use-xrange)使用 xrange
...
# [](#use-dictionaries-idiomatically)习惯性使用字典

## [](#avoid-using-keys-function)避免使用按键()功能
...
## [](#iterate-over-keys-and-values)迭代键和值
...
## [](#use-dictionaries-comprehension)用字典理解
...
# [](#use-collections-module)使用收款模块

## [](#use-namedtuple)使用命名元组
...
## [](#use-defaultdict)使用 defaultdict
