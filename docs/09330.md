...
> 原文:[https://dev . to/qlikbranch/from-custom-blogs-to-medium-our-transition-part-2-3d EJ](https://dev.to/qlikbranch/from-custom-blogs-to-medium-our-transition-part-2-3dej)

[![](../Images/5b81cce6ccc96f879ffdbb2dcdec0e24.png)T2】](https://res.cloudinary.com/practicaldev/image/fetch/s--hzWtY2xv--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/1024/1%2AIDHG41ZqotgLUpwMj6gqpA.jpeg)

没多久我就意识到不仅仅是 API 的问题，RSS 提要本身也有局限性。在我们的出版物上发表了一些故事后，我们意识到这些故事已经被从意义搜索中删除了。你想猜猜为什么吗？RSS 源只提供最新的 10 个故事！！！负载测试给你上了一课。

我现在陷入了两个问题:

### [](#problem-1-how-to-properly-keep-the-app-up-to-date)**问题一:如何正确保持 app 最新**
...
### [](#problem-2-how-to-get-the-missing-stories-back)问题二:如何把缺失的故事找回来
