...
# [](#meet-sparrowform)遇见雀形目

[![asciicast](../Images/ec428c4440c88ddbf1524b22a82435be.png)T2】](https://asciinema.org/a/158919)
...
# [](#bootstrap-infrastructure-with-terraform)使用 Terraform 的引导基础设施
...
# [](#create-some-sparrowdo-scenarios)创建一些 Sparrowdo 场景:
...
# [](#run-provision-by-sparrowformsparrowdo)按 Sparrowform/Sparrowdo 运行供应
